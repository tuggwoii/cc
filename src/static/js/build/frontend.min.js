...
this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.6",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return c>e&&"top";if("bottom"==this.affixed)return null!=c?!(e+this.unpin<=f.top)&&"bottom":!(a-d>=e+g)&&"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&c>=e?"top":null!=d&&i+j>=a-d&&"bottom"},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery),function(R,y){"use strict";function Ea(a,b,c){if(!a)throw Oa("areq",b||"?",c||"required");return a}function Fa(a,b){return a||b?a?b?(W(a)&&(a=a.join(" ")),W(b)&&(b=b.join(" ")),a+" "+b):a:b:""}function Pa(a){var b={};return a&&(a.to||a.from)&&(b.to=a.to,b.from=a.from),b}function X(a,b,c){var d="";return a=W(a)?a:a&&F(a)&&a.length?a.split(/\s+/):[],s(a,function(a,e){a&&0<a.length&&(d+=0<e?" ":"",d+=c?b+a:a+b)}),d}function Ga(a){if(a instanceof E)switch(a.length){case 0:return a;case 1:if(1===a[0].nodeType)return a;break;default:return E(ua(a))}if(1===a.nodeType)return E(a)}function ua(a){if(!a[0])return a;for(var b=0;b<a.length;b++){var c=a[b];if(1===c.nodeType)return c}}function Qa(a,b,c){s(b,function(b){a.addClass(b,c)})}function Ra(a,b,c){s(b,function(b){a.removeClass(b,c)})}function Y(a){return function(b,c){c.addClass&&(Qa(a,b,c.addClass),c.addClass=null),c.removeClass&&(Ra(a,b,c.removeClass),c.removeClass=null)}}function na(a){if(a=a||{},!a.$$prepared){var b=a.domOperation||P;a.domOperation=function(){a.$$domOperationFired=!0,b(),b=P},a.$$prepared=!0}return a}function ha(a,b){Ha(a,b),Ia(a,b)}function Ha(a,b){b.from&&(a.css(b.from),b.from=null)}function Ia(a,b){b.to&&(a.css(b.to),b.to=null)}function U(a,b,c){var d=b.options||{};c=c.options||{};var f=(d.addClass||"")+" "+(c.addClass||""),e=(d.removeClass||"")+" "+(c.removeClass||"");return a=Sa(a.attr("class"),f,e),c.preparationClasses&&(d.preparationClasses=Z(c.preparationClasses,d.preparationClasses),delete c.preparationClasses),f=d.domOperation!==P?d.domOperation:null,va(d,c),f&&(d.domOperation=f),d.addClass=a.addClass?a.addClass:null,d.removeClass=a.removeClass?a.removeClass:null,b.addClass=d.addClass,b.removeClass=d.removeClass,d}function Sa(a,b,c){function d(a){F(a)&&(a=a.split(" "));var b={};return s(a,function(a){a.length&&(b[a]=!0)}),b}var f={};a=d(a),b=d(b),s(b,function(a,b){f[b]=1}),c=d(c),s(c,function(a,b){f[b]=1===f[b]?null:-1});var e={addClass:"",removeClass:""};return s(f,function(b,c){var d,f;1===b?(d="addClass",f=!a[c]||a[c+"-remove"]):-1===b&&(d="removeClass",f=a[c]||a[c+"-add"]),f&&(e[d].length&&(e[d]+=" "),e[d]+=c)}),e}function Q(a){return a instanceof E?a[0]:a}function Ta(a,b,c){var d="";b&&(d=X(b,"ng-",!0)),c.addClass&&(d=Z(d,X(c.addClass,"-add"))),c.removeClass&&(d=Z(d,X(c.removeClass,"-remove"))),d.length&&(c.preparationClasses=d,a.addClass(d))}function oa(a,b){var c=b?"-"+b+"s":"";return ka(a,[la,c]),[la,c]}function wa(a,b){var c=b?"paused":"",d=$+"PlayState";return ka(a,[d,c]),[d,c]}function ka(a,b){a.style[b[0]]=b[1]}function Z(a,b){return a?b?a+" "+b:a:b}function Ja(a,b,c){var d=Object.create(null),f=a.getComputedStyle(b)||{};return s(c,function(a,b){var c=f[a];if(c){var G=c.charAt(0);("-"===G||"+"===G||0<=G)&&(c=Ua(c)),0===c&&(c=null),d[b]=c}}),d}function Ua(a){var b=0;return a=a.split(/\s*,\s*/),s(a,function(a){"s"===a.charAt(a.length-1)&&(a=a.substring(0,a.length-1)),a=parseFloat(a)||0,b=b?Math.max(a,b):a}),b}function xa(a){return 0===a||null!=a}function Ka(a,b){var c=S,d=a+"s";return b?c+="Duration":d+=" linear all",[c,d]}function La(){var a=Object.create(null);return{flush:function(){a=Object.create(null)},count:function(b){return(b=a[b])?b.total:0},get:function(b){return(b=a[b])&&b.value},put:function(b,c){a[b]?a[b].total++:a[b]={total:1,value:c}}}}function Ma(a,b,c){s(c,function(c){a[c]=ya(a[c])?a[c]:b.style.getPropertyValue(c)})}var S,za,$,Aa;void 0===R.ontransitionend&&void 0!==R.onwebkittransitionend?(S="WebkitTransition",za="webkitTransitionEnd transitionend"):(S="transition",za="transitionend"),void 0===R.onanimationend&&void 0!==R.onwebkitanimationend?($="WebkitAnimation",Aa="webkitAnimationEnd animationend"):($="animation",Aa="animationend");var Ca,va,s,W,ya,da,Da,aa,F,N,E,P,pa=$+"Delay",Ba=$+"Duration",la=S+"Delay",Na=S+"Duration",Oa=y.$$minErr("ng"),Va={transitionDuration:Na,transitionDelay:la,transitionProperty:S+"Property",animationDuration:Ba,animationDelay:pa,animationIterationCount:$+"IterationCount"},Wa={transitionDuration:Na,transitionDelay:la,animationDuration:Ba,animationDelay:pa};y.module("ngAnimate",[],function(){P=y.noop,Ca=y.copy,va=y.extend,E=y.element,s=y.forEach,W=y.isArray,F=y.isString,aa=y.isObject,N=y.isUndefined,ya=y.isDefined,Da=y.isFunction,da=y.isElement}).info({angularVersion:"1.6.4"}).directive("ngAnimateSwap",["$animate","$rootScope",function(a,b){return{restrict:"A",transclude:"element",terminal:!0,priority:600,link:function(b,d,f,e,p){var K,G;b.$watchCollection(f.ngAnimateSwap||f.for,function(f){K&&a.leave(K),G&&(G.$destroy(),G=null),(f||0===f)&&(G=b.$new(),p(G,function(b){K=b,a.enter(b,null,d)}))})}}}]).directive("ngAnimateChildren",["$interpolate",function(a){return{link:function(b,c,d){function f(a){c.data("$$ngAnimateChildren","on"===a||"true"===a)}var e=d.ngAnimateChildren;F(e)&&0===e.length?c.data("$$ngAnimateChildren",!0):(f(a(e)(b)),d.$observe("ngAnimateChildren",f))}}}]).factory("$$rAFScheduler",["$$rAF",function(a){function b(a){d=d.concat(a),c()}function c(){if(d.length){for(var b=d.shift(),p=0;p<b.length;p++)b[p]();f||a(function(){f||c()})}}var d,f;return d=b.queue=[],b.waitUntilQuiet=function(b){f&&f(),f=a(function(){f=null,b(),c()})},b}]).provider("$$animateQueue",["$animateProvider",function(a){function b(a){if(!a)return null;a=a.split(" ");var b=Object.create(null);return s(a,function(a){b[a]=!0}),b}function c(a,c){if(a&&c){var d=b(c);return a.split(" ").some(function(a){return d[a]})}}function d(a,b,c){return e[a].some(function(a){return a(b,c)})}function f(a,b){var c=0<(a.addClass||"").length,d=0<(a.removeClass||"").length;return b?c&&d:c||d}var e=this.rules={skip:[],cancel:[],join:[]};e.join.push(function(a,b){return!a.structural&&f(a)}),e.skip.push(function(a,b){return!a.structural&&!f(a)}),e.skip.push(function(a,b){return"leave"===b.event&&a.structural}),e.skip.push(function(a,b){return b.structural&&2===b.state&&!a.structural}),e.cancel.push(function(a,b){return b.structural&&a.structural}),e.cancel.push(function(a,b){return 2===b.state&&a.structural}),e.cancel.push(function(a,b){if(b.structural)return!1;var d=a.addClass,f=a.removeClass,e=b.addClass,qa=b.removeClass;return!(N(d)&&N(f)||N(e)&&N(qa))&&(c(d,qa)||c(f,e))}),this.$get=["$$rAF","$rootScope","$rootElement","$document","$$Map","$$animation","$$AnimateRunner","$templateRequest","$$jqLite","$$forceReflow","$$isDocumentHidden",function(b,c,e,n,z,qa,J,u,H,k,O){function L(){var a=!1;return function(b){a?b():c.$$postDigest(function(){a=!0,b()})}}function A(a,b,c){var g=[],d=h[c];return d&&s(d,function(d){w.call(d.node,b)?g.push(d.callback):"leave"===c&&w.call(d.node,a)&&g.push(d.callback)}),g}function B(a,b,c){var g=ua(b);return a.filter(function(a){return!(a.node===g&&(!c||a.callback===c))})}function q(a,h,v){function q(a,c,g,d){G(function(){var a=A(ta,k,c);a.length?b(function(){s(a,function(a){a(e,g,d)}),"close"!==g||k.parentNode||ra.off(k)}):"close"!==g||k.parentNode||ra.off(k)}),a.progress(c,g,d)}function B(a){var b=e,c=m;c.preparationClasses&&(b.removeClass(c.preparationClasses),c.preparationClasses=null),c.activeClasses&&(b.removeClass(c.activeClasses),c.activeClasses=null),D(e,m),ha(e,m),m.domOperation(),t.complete(!a)}var m=Ca(v),e=Ga(a),k=Q(e),ta=k&&k.parentNode,m=na(m),t=new J,G=L();if(W(m.addClass)&&(m.addClass=m.addClass.join(" ")),m.addClass&&!F(m.addClass)&&(m.addClass=null),W(m.removeClass)&&(m.removeClass=m.removeClass.join(" ")),m.removeClass&&!F(m.removeClass)&&(m.removeClass=null),m.from&&!aa(m.from)&&(m.from=null),m.to&&!aa(m.to)&&(m.to=null),!k)return B(),t;if(v=[k.getAttribute("class"),m.addClass,m.removeClass].join(" "),!Xa(v))return B(),t;var n=0<=["enter","move","leave"].indexOf(h),w=O(),u=!g||w||ga.get(k);v=!u&&x.get(k)||{};var H=!!v.state;if(u||H&&1===v.state||(u=!M(k,ta,h)),u)return w&&q(t,h,"start"),B(),w&&q(t,h,"close"),t;if(n&&sa(k),w={structural:n,element:e,event:h,addClass:m.addClass,removeClass:m.removeClass,close:B,options:m,runner:t},H){if(d("skip",w,v))return 2===v.state?(B(),t):(U(e,v,w),v.runner);if(d("cancel",w,v))if(2===v.state)v.runner.end();else{if(!v.structural)return U(e,v,w),v.runner;v.close()}else if(d("join",w,v)){if(2!==v.state)return Ta(e,n?h:null,m),h=w.event=v.event,m=U(e,v,w),v.runner;U(e,w,{})}}else U(e,w,{});if((H=w.structural)||(H="animate"===w.event&&0<Object.keys(w.options.to||{}).length||f(w)),!H)return B(),l(k),t;var z=(v.counter||0)+1;return w.counter=z,I(k,1,w),c.$$postDigest(function(){e=Ga(a);var b=x.get(k),c=!b,b=b||{},g=0<(e.parent()||[]).length&&("animate"===b.event||b.structural||f(b));c||b.counter!==z||!g?(c&&(D(e,m),ha(e,m)),(c||n&&b.event!==h)&&(m.domOperation(),t.end()),g||l(k)):(h=!b.structural&&f(b,!0)?"setClass":b.event,I(k,2),b=qa(e,h,b.options),t.setHost(b),q(t,h,"start",{}),b.done(function(a){B(!a),(a=x.get(k))&&a.counter===z&&l(k),q(t,h,"close",{})}))}),t}function sa(a){a=a.querySelectorAll("[data-ng-animate]"),s(a,function(a){var b=parseInt(a.getAttribute("data-ng-animate"),10),c=x.get(a);if(c)switch(b){case 2:c.runner.end();case 1:x.delete(a)}})}function l(a){a.removeAttribute("data-ng-animate"),x.delete(a)}function M(a,b,c){c=n[0].body;var A,g=Q(e),d=a===c||"HTML"===a.nodeName,h=a===g,f=!1,k=ga.get(a);for((a=E.data(a,"$ngAnimatePin"))&&(b=Q(a));b&&(h||(h=b===g),1===b.nodeType);){if(a=x.get(b)||{},!f){var q=ga.get(b);if(!0===q&&!1!==k){k=!0;break}!1===q&&(k=!1),f=a.structural}if((N(A)||!0===A)&&(a=E.data(b,"$$ngAnimateChildren"),ya(a)&&(A=a)),f&&!1===A)break;if(d||(d=b===c),d&&h)break;b=h||!(a=E.data(b,"$ngAnimatePin"))?b.parentNode:Q(a)}return(!f||A)&&!0!==k&&h&&d}function I(a,b,c){c=c||{},c.state=b,a.setAttribute("data-ng-animate",b),c=(b=x.get(a))?va(b,c):c,x.set(a,c)}var x=new z,ga=new z,g=null,ta=c.$watch(function(){return 0===u.totalPendingRequests},function(a){a&&(ta(),c.$$postDigest(function(){c.$$postDigest(function(){null===g&&(g=!0)})}))}),h=Object.create(null),t=a.classNameFilter(),Xa=t?function(a){return t.test(a)}:function(){return!0},D=Y(H),w=R.Node.prototype.contains||function(a){return this===a||!!(16&this.compareDocumentPosition(a))},ra={on:function(a,b,c){var g=ua(b);h[a]=h[a]||[],h[a].push({node:g,callback:c}),E(b).on("$destroy",function(){x.get(g)||ra.off(a,b,c)})},off:function(a,b,c){if(1!==arguments.length||F(arguments[0])){var g=h[a];g&&(h[a]=1===arguments.length?null:B(g,b,c))}else for(g in b=arguments[0],h)h[g]=B(h[g],b)},pin:function(a,b){Ea(da(a),"element","not an element"),Ea(da(b),"parentElement","not an element"),a.data("$ngAnimatePin",b)},push:function(a,b,c,g){return c=c||{},c.domOperation=g,q(a,b,c)},enabled:function(a,b){var c=arguments.length;if(0===c)b=!!g;else if(da(a)){var d=Q(a);1===c?b=!ga.get(d):ga.set(d,!b)}else b=g=!!a;return b}};return ra}]}]).provider("$$animation",["$animateProvider",function(a){var b=this.drivers=[];this.$get=["$$jqLite","$rootScope","$injector","$$AnimateRunner","$$Map","$$rAFScheduler",function(a,d,f,e,p,K){function G(a){function b(a){if(a.processed)return a;a.processed=!0;var d=a.domNode,e=d.parentNode;f.set(d,a);for(var q;e;){if(q=f.get(e)){q.processed||(q=b(q));break}e=e.parentNode}return(q||c).children.push(a),a}var d,c={children:[]},f=new p;for(d=0;d<a.length;d++){var e=a[d];f.set(e.domNode,a[d]={domNode:e.domNode,fn:e.fn,children:[]})}for(d=0;d<a.length;d++)b(a[d]);return function(a){var d,b=[],c=[];for(d=0;d<a.children.length;d++)c.push(a.children[d]);a=c.length;var f=0,e=[];for(d=0;d<c.length;d++){var k=c[d];0>=a&&(a=f,f=0,b.push(e),e=[]),e.push(k.fn),k.children.forEach(function(a){f++,c.push(a)}),a--}return e.length&&b.push(e),b}(c)}var n=[],z=Y(a);return function(p,J,u){function H(a){a=a.hasAttribute("ng-animate-ref")?[a]:a.querySelectorAll("[ng-animate-ref]");var b=[];return s(a,function(a){var c=a.getAttribute("ng-animate-ref");c&&c.length&&b.push(a)}),b}function k(a){var b=[],c={};s(a,function(a,d){var h=Q(a.element),f=0<=["enter","move"].indexOf(a.event),h=a.structural?H(h):[];if(h.length){var e=f?"to":"from";s(h,function(a){var b=a.getAttribute("ng-animate-ref");c[b]=c[b]||{},c[b][e]={animationID:d,element:E(a)}})}else b.push(a)});var d={},f={};return s(c,function(c,e){var k=c.from,A=c.to;if(k&&A){var q=a[k.animationID],x=a[A.animationID],l=k.animationID.toString();if(!f[l]){var B=f[l]={structural:!0,beforeStart:function(){q.beforeStart(),x.beforeStart()},close:function(){q.close(),x.close()},classes:O(q.classes,x.classes),from:q,to:x,anchors:[]};B.classes.length?b.push(B):(b.push(q),b.push(x))}f[l].anchors.push({out:k.element,in:A.element})}else k=k?k.animationID:A.animationID,A=k.toString(),d[A]||(d[A]=!0,b.push(a[k]))}),b}function O(a,b){a=a.split(" "),b=b.split(" ");for(var c=[],d=0;d<a.length;d++){var f=a[d];if("ng-"!==f.substring(0,3))for(var e=0;e<b.length;e++)if(f===b[e]){c.push(f);break}}return c.join(" ")}function L(a){for(var c=b.length-1;0<=c;c--){var d=f.get(b[c])(a);if(d)return d}}function A(a,b){function c(a){(a=a.data("$$animationRunner"))&&a.setHost(b)}a.from&&a.to?(c(a.from.element),c(a.to.element)):c(a.element)}function B(){var a=p.data("$$animationRunner");!a||"leave"===J&&u.$$domOperationFired||a.end()}function q(b){p.off("$destroy",B),p.removeData("$$animationRunner"),z(p,u),ha(p,u),u.domOperation(),I&&a.removeClass(p,I),p.removeClass("ng-animate"),l.complete(!b)}u=na(u);var sa=0<=["enter","move","leave"].indexOf(J),l=new e({end:function(){q()},cancel:function(){q(!0)}});if(!b.length)return q(),l;p.data("$$animationRunner",l);var M=Fa(p.attr("class"),Fa(u.addClass,u.removeClass)),I=u.tempClasses;I&&(M+=" "+I,u.tempClasses=null);var x;return sa&&(x="ng-"+J+"-prepare",a.addClass(p,x)),n.push({element:p,classes:M,event:J,structural:sa,options:u,beforeStart:function(){p.addClass("ng-animate"),I&&a.addClass(p,I),x&&(a.removeClass(p,x),x=null)},close:q}),p.on("$destroy",B),1<n.length?l:(d.$$postDigest(function(){var a=[];s(n,function(b){b.element.data("$$animationRunner")?a.push(b):b.close()}),n.length=0;var b=k(a),c=[];s(b,function(a){c.push({domNode:Q(a.from?a.from.element:a.element),fn:function(){a.beforeStart();var b,c=a.close;if((a.anchors?a.from.element||a.to.element:a.element).data("$$animationRunner")){var d=L(a);d&&(b=d.start)}b?(b=b(),b.done(function(a){c(!a)}),A(a,b)):c()}})}),K(G(c))}),l)}}]}]).provider("$animateCss",["$animateProvider",function(a){var b=La(),c=La();this.$get=["$window","$$jqLite","$$AnimateRunner","$timeout","$$forceReflow","$sniffer","$$rAFScheduler","$$animateQueue",function(a,f,e,p,K,G,n,z){function y(a,b){var c=a.parentNode;return(c.$$ngAnimateParentKey||(c.$$ngAnimateParentKey=++O))+"-"+a.getAttribute("class")+"-"+b}function J(e,k,q,p){var l;return 0<b.count(q)&&((l=c.get(q))||(k=X(k,"-stagger"),f.addClass(e,k),l=Ja(a,e,p),l.animationDuration=Math.max(l.animationDuration,0),l.transitionDuration=Math.max(l.transitionDuration,0),f.removeClass(e,k),c.put(q,l))),l||{}}function u(a){L.push(a),n.waitUntilQuiet(function(){b.flush(),c.flush();for(var a=K(),d=0;d<L.length;d++)L[d](a);L.length=0})}function H(c,f,e){return f=b.get(e),f||(f=Ja(a,c,Va),"infinite"===f.animationIterationCount&&(f.animationIterationCount=1)),b.put(e,f),c=f,e=c.animationDelay,f=c.transitionDelay,c.maxDelay=e&&f?Math.max(e,f):e||f,c.maxDuration=Math.max(c.animationDuration*c.animationIterationCount,c.transitionDuration),c}var k=Y(f),O=0,L=[];return function(a,c){function d(){l()}function n(){l(!0)}function l(b){if(!(w||E&&O)){w=!0,O=!1,g.$$skipPreparationClasses||f.removeClass(a,fa),f.removeClass(a,da),wa(h,!1),oa(h,!1),s(t,function(a){h.style[a[0]]=""}),k(a,g),ha(a,g),Object.keys(L).length&&s(L,function(a,b){a?h.style.setProperty(b,a):h.style.removeProperty(b)}),g.onDone&&g.onDone(),ea&&ea.length&&a.off(ea.join(" "),x);var c=a.data("$$animateCss");c&&(p.cancel(c[0].timer),a.removeData("$$animateCss")),F&&F.complete(!b)}}function M(a){r.blockTransition&&oa(h,a),r.blockKeyframeAnimation&&wa(h,!!a)}function I(){return F=new e({end:d,cancel:n}),u(P),l(),{$$willAnimate:!1,start:function(){return F},end:d}}function x(a){a.stopPropagation();var b=a.originalEvent||a;a=b.$manualTimeStamp||Date.now(),b=parseFloat(b.elapsedTime.toFixed(3)),Math.max(a-Y,0)>=R&&b>=m&&(E=!0,l())}function ga(){function b(){if(!w){if(M(!1),s(t,function(a){h.style[a[0]]=a[1]}),k(a,g),f.addClass(a,da),r.recalculateTimingStyles){if(ma=h.getAttribute("class")+" "+fa,ja=y(h,ma),C=H(h,ma,ja),ba=C.maxDelay,N=Math.max(ba,0),0===(m=C.maxDuration))return void l();r.hasTransitions=0<C.transitionDuration,r.hasAnimations=0<C.animationDuration}if(r.applyAnimationDelay&&(ba="boolean"!=typeof g.delay&&xa(g.delay)?parseFloat(g.delay):ba,N=Math.max(ba,0),C.animationDelay=ba,ca=[pa,ba+"s"],t.push(ca),h.style[ca[0]]=ca[1]),R=1e3*N,U=1e3*m,g.easing){var d,e=g.easing;r.hasTransitions&&(d=S+"TimingFunction",t.push([d,e]),h.style[d]=e),r.hasAnimations&&(d=$+"TimingFunction",t.push([d,e]),h.style[d]=e)}C.transitionDuration&&ea.push(za),C.animationDuration&&ea.push(Aa),Y=Date.now();var n=R+1.5*U;d=Y+n;var e=a.data("$$animateCss")||[],q=!0;if(e.length){var I=e[0];(q=d>I.expectedEndTime)?p.cancel(I.timer):e.push(l)}q&&(n=p(c,n,!1),e[0]={timer:n,expectedEndTime:d},e.push(l),a.data("$$animateCss",e)),ea.length&&a.on(ea.join(" "),x),g.to&&(g.cleanupStyles&&Ma(L,h,Object.keys(g.to)),Ia(a,g))}}function c(){var b=a.data("$$animateCss");if(b){for(var d=1;d<b.length;d++)b[d]();a.removeData("$$animateCss")}}if(!w)if(h.parentNode){var d=function(a){if(E)O&&a&&(O=!1,l());else if(O=!a,C.animationDuration)if(a=wa(h,O),O)t.push(a);else{var b=t,c=b.indexOf(a);0<=a&&b.splice(c,1)}},e=0<aa&&(C.transitionDuration&&0===V.transitionDuration||C.animationDuration&&0===V.animationDuration)&&Math.max(V.animationDelay,V.transitionDelay);e?p(b,Math.floor(e*aa*1e3),!1):b(),v.resume=function(){d(!0)},v.pause=function(){d(!1)}}else l()}var g=c||{};g.$$prepared||(g=na(Ca(g)));var L={},h=Q(a);if(!h||!h.parentNode||!z.enabled())return I();var w,O,E,F,v,N,R,m,U,Y,t=[],K=a.attr("class"),D=Pa(g),ea=[];if(0===g.duration||!G.animations&&!G.transitions)return I();var ia=g.event&&W(g.event)?g.event.join(" "):g.event,Z="",T="";ia&&g.structural?Z=X(ia,"ng-",!0):ia&&(Z=ia),g.addClass&&(T+=X(g.addClass,"-add")),g.removeClass&&(T.length&&(T+=" "),T+=X(g.removeClass,"-remove")),g.applyClassesEarly&&T.length&&k(a,g);var fa=[Z,T].join(" ").trim(),ma=K+" "+fa,da=X(fa,"-active"),K=D.to&&0<Object.keys(D.to).length;if(!(0<(g.keyframeStyle||"").length||K||fa))return I();var ja,V;0<g.stagger?(D=parseFloat(g.stagger),V={transitionDelay:D,animationDelay:D,transitionDuration:0,animationDuration:0}):(ja=y(h,ma),V=J(h,fa,ja,Wa)),g.$$skipPreparationClasses||f.addClass(a,fa),g.transitionStyle&&(D=[S,g.transitionStyle],ka(h,D),t.push(D)),0<=g.duration&&(D=0<h.style[S].length,D=Ka(g.duration,D),ka(h,D),t.push(D)),g.keyframeStyle&&(D=[$,g.keyframeStyle],ka(h,D),t.push(D));var aa=V?0<=g.staggerIndex?g.staggerIndex:b.count(ja):0;(ia=0===aa)&&!g.skipBlocking&&oa(h,9999);var C=H(h,ma,ja),ba=C.maxDelay;N=Math.max(ba,0),m=C.maxDuration;var r={};if(r.hasTransitions=0<C.transitionDuration,r.hasAnimations=0<C.animationDuration,r.hasTransitionAll=r.hasTransitions&&"all"===C.transitionProperty,r.applyTransitionDuration=K&&(r.hasTransitions&&!r.hasTransitionAll||r.hasAnimations&&!r.hasTransitions),r.applyAnimationDuration=g.duration&&r.hasAnimations,r.applyTransitionDelay=xa(g.delay)&&(r.applyTransitionDuration||r.hasTransitions),r.applyAnimationDelay=xa(g.delay)&&r.hasAnimations,r.recalculateTimingStyles=0<T.length,(r.applyTransitionDuration||r.applyAnimationDuration)&&(m=g.duration?parseFloat(g.duration):m,r.applyTransitionDuration&&(r.hasTransitions=!0,C.transitionDuration=m,D=0<h.style[S+"Property"].length,t.push(Ka(m,D))),r.applyAnimationDuration&&(r.hasAnimations=!0,C.animationDuration=m,t.push([Ba,m+"s"]))),0===m&&!r.recalculateTimingStyles)return I();if(null!=g.delay){var ca;"boolean"!=typeof g.delay&&(ca=parseFloat(g.delay),N=Math.max(ca,0)),r.applyTransitionDelay&&t.push([la,ca+"s"]),r.applyAnimationDelay&&t.push([pa,ca+"s"])}return null==g.duration&&0<C.transitionDuration&&(r.recalculateTimingStyles=r.recalculateTimingStyles||ia),R=1e3*N,U=1e3*m,g.skipBlocking||(r.blockTransition=0<C.transitionDuration,r.blockKeyframeAnimation=0<C.animationDuration&&0<V.animationDelay&&0===V.animationDuration),g.from&&(g.cleanupStyles&&Ma(L,h,Object.keys(g.from)),Ha(a,g)),r.blockTransition||r.blockKeyframeAnimation?M(m):g.skipBlocking||oa(h,!1),{$$willAnimate:!0,end:d,start:function(){if(!w)return v={end:d,cancel:n,resume:null,pause:null},F=new e(v),u(ga),F}}}}]}]).provider("$$animateCssDriver",["$$animationProvider",function(a){a.drivers.push("$$animateCssDriver"),this.$get=["$animateCss","$rootScope","$$AnimateRunner","$rootElement","$sniffer","$$jqLite","$document",function(a,c,d,f,e,p,K){function G(a){return a.replace(/\bng-\S+\b/g,"")}function n(a,b){return F(a)&&(a=a.split(" ")),F(b)&&(b=b.split(" ")),a.filter(function(a){return-1===b.indexOf(a)}).join(" ")}function z(c,e,f){function p(a){var b={},c=Q(a).getBoundingClientRect();return s(["width","height","top","left"],function(a){var d=c[a];switch(a){case"top":d+=u.scrollTop;break;case"left":d+=u.scrollLeft}b[a]=Math.floor(d)+"px"}),b}function K(){var c=G(f.attr("class")||""),d=n(c,l),c=n(l,c),d=a(z,{to:p(f),addClass:"ng-anchor-in "+d,removeClass:"ng-anchor-out "+c,delay:!0});return d.$$willAnimate?d:null}function q(){z.remove(),e.removeClass("ng-animate-shim"),f.removeClass("ng-animate-shim")}var z=E(Q(e).cloneNode(!0)),l=G(z.attr("class")||"");e.addClass("ng-animate-shim"),f.addClass("ng-animate-shim"),z.addClass("ng-anchor"),H.append(z);var M;if(!(c=function(){var c=a(z,{addClass:"ng-anchor-out",delay:!0,from:p(e)});return c.$$willAnimate?c:null}())&&!(M=K()))return q();var I=c||M;return{start:function(){function a(){c&&c.end()}var b,c=I.start();return c.done(function(){if(c=null,!M&&(M=K()))return c=M.start(),c.done(function(){c=null,q(),b.complete()}),c;q(),b.complete()}),b=new d({end:a,cancel:a})}}}function y(a,b,c,e){var f=J(a),p=J(b),n=[];if(s(e,function(a){(a=z(c,a.out,a.in))&&n.push(a)}),f||p||0!==n.length)return{start:function(){function a(){s(b,function(a){a.end()})}var b=[];f&&b.push(f.start()),p&&b.push(p.start()),s(n,function(a){b.push(a.start())});var c=new d({end:a,cancel:a});return d.all(b,function(a){c.complete(a)}),c}}}function J(c){var d=c.element,e=c.options||{};return c.structural&&(e.event=c.event,e.structural=!0,e.applyClassesEarly=!0,"leave"===c.event&&(e.onDone=e.domOperation)),e.preparationClasses&&(e.event=Z(e.event,e.preparationClasses)),c=a(d,e),c.$$willAnimate?c:null}if(!e.animations&&!e.transitions)return P;var u=K[0].body;c=Q(f);var H=E(c.parentNode&&11===c.parentNode.nodeType||u.contains(c)?c:u);return function(a){return a.from&&a.to?y(a.from,a.to,a.classes,a.anchors):J(a)}}]}]).provider("$$animateJs",["$animateProvider",function(a){this.$get=["$injector","$$AnimateRunner","$$jqLite",function(b,c,d){function f(c){c=W(c)?c:c.split(" ");for(var d=[],e={},f=0;f<c.length;f++){var s=c[f],y=a.$$registeredAnimations[s];y&&!e[s]&&(d.push(b.get(y)),e[s]=!0)}return d}var e=Y(d);return function(a,b,d,n){function z(){n.domOperation(),e(a,n)}function y(a,b,d,e,f){switch(d){case"animate":b=[b,e.from,e.to,f];break;case"setClass":b=[b,k,F,f];break;case"addClass":b=[b,k,f];break;case"removeClass":b=[b,F,f];break;default:b=[b,f]}if(b.push(e),a=a.apply(a,b))if(Da(a.start)&&(a=a.start()),a instanceof c)a.done(f);else if(Da(a))return a;return P}function J(a,b,d,e,f){var k=[];return s(e,function(e){var l=e[f];l&&k.push(function(){var e,f,g=!1,h=function(a){g||(g=!0,(f||P)(a),e.complete(!a))};return e=new c({end:function(){h()},cancel:function(){h(!0)}}),f=y(l,a,b,d,function(a){h(!1===a)}),e})}),k}function u(a,b,d,e,f){var k=J(a,b,d,e,f);if(0===k.length){var h,l;"beforeSetClass"===f?(h=J(a,"removeClass",d,e,"beforeRemoveClass"),l=J(a,"addClass",d,e,"beforeAddClass")):"setClass"===f&&(h=J(a,"removeClass",d,e,"removeClass"),l=J(a,"addClass",d,e,"addClass")),h&&(k=k.concat(h)),l&&(k=k.concat(l))}if(0!==k.length)return function(a){var b=[];return k.length&&s(k,function(a){b.push(a())}),b.length?c.all(b,a):a(),function(a){s(b,function(b){a?b.cancel():b.end()})}}}var H=!1;3===arguments.length&&aa(d)&&(n=d,d=null),n=na(n),d||(d=a.attr("class")||"",n.addClass&&(d+=" "+n.addClass),n.removeClass&&(d+=" "+n.removeClass));var A,B,k=n.addClass,F=n.removeClass,L=f(d);if(L.length){var q,E;"leave"===b?(E="leave",q="afterLeave"):(E="before"+b.charAt(0).toUpperCase()+b.substr(1),q=b),"enter"!==b&&"move"!==b&&(A=u(a,b,n,L,E)),B=u(a,b,n,L,q)}if(A||B){var l;return{$$willAnimate:!0,end:function(){return l?l.end():(H=!0,z(),ha(a,n),l=new c,l.complete(!0)),l},start:function(){function b(c){H=!0,z(),ha(a,n),l.complete(c)}if(l)return l;l=new c;var d,e=[];return A&&e.push(function(a){d=A(a)}),e.length?e.push(function(a){z(),a(!0)}):z(),B&&e.push(function(a){d=B(a)}),l.setHost({end:function(){H||((d||P)(void 0),b(void 0))},cancel:function(){H||((d||P)(!0),b(!0))}}),c.chain(e,b),l}}}}}]}]).provider("$$animateJsDriver",["$$animationProvider",function(a){a.drivers.push("$$animateJsDriver"),this.$get=["$$animateJs","$$AnimateRunner",function(a,c){function d(c){return a(c.element,c.event,c.classes,c.options)}return function(a){if(!a.from||!a.to)return d(a);var b=d(a.from),p=d(a.to);return b||p?{start:function(){function a(){return function(){s(d,function(a){a.end()})}}var d=[];b&&d.push(b.start()),p&&d.push(p.start()),c.all(d,function(a){f.complete(a)});var f=new c({end:a(),cancel:a()});return f}}:void 0}}]}])}(window,window.angular),function(n,c){"use strict";function l(b,a,g){var d=g.baseHref(),k=b[0];return function(b,e,f){var g,h;f=f||{},h=f.expires,g=c.isDefined(f.path)?f.path:d,c.isUndefined(e)&&(h="Thu, 01 Jan 1970 00:00:00 GMT",e=""),c.isString(h)&&(h=new Date(h)),e=encodeURIComponent(b)+"="+encodeURIComponent(e),e=e+(g?";path="+g:"")+(f.domain?";domain="+f.domain:""),e+=h?";expires="+h.toUTCString():"",e+=f.secure?";secure":"",f=e.length+1,4096<f&&a.warn("Cookie '"+b+"' possibly not set or overflowed because it was too large ("+f+" > 4096 bytes)!"),k.cookie=e}}c.module("ngCookies",["ng"]).info({angularVersion:"1.6.4"}).provider("$cookies",[function(){var b=this.defaults={};this.$get=["$$cookieReader","$$cookieWriter",function(a,g){return{get:function(d){return a()[d]},getObject:function(d){return(d=this.get(d))?c.fromJson(d):d},getAll:function(){return a()},put:function(d,a,m){g(d,a,m?c.extend({},b,m):b)},putObject:function(d,b,a){this.put(d,c.toJson(b),a)},remove:function(a,k){g(a,void 0,k?c.extend({},b,k):b)}}}]}]),c.module("ngCookies").factory("$cookieStore",["$cookies",function(b){return{get:function(a){return b.getObject(a)},put:function(a,c){b.putObject(a,c)},remove:function(a){b.remove(a)}}}]),l.$inject=["$document","$log","$browser"],c.module("ngCookies").provider("$$cookieWriter",function(){this.$get=l})}(window,window.angular),void 0!==module&&"undefined"!=typeof exports&&module.exports===exports&&(module.exports="ui.router"),function(a,b,c){"use strict";function d(a,b){return T(new(T(function(){},{prototype:a})),b)}function e(a){return S(arguments,function(b){b!==a&&S(b,function(b,c){a.hasOwnProperty(c)||(a[c]=b)})}),a}function f(a,b){var c=[];for(var d in a.path){if(a.path[d]!==b.path[d])break;c.push(a.path[d])}return c}function g(a){if(Object.keys)return Object.keys(a);var b=[];return S(a,function(a,c){b.push(c)}),b}function h(a,b){if(Array.prototype.indexOf)return a.indexOf(b,Number(arguments[2])||0);var c=a.length>>>0,d=Number(arguments[2])||0;for((d=d<0?Math.ceil(d):Math.floor(d))<0&&(d+=c);d<c;d++)if(d in a&&a[d]===b)return d;return-1}function i(a,b,c,d){var e,i=f(c,d),j={},k=[];for(var l in i)if(i[l]&&i[l].params&&(e=g(i[l].params),e.length))for(var m in e)h(k,e[m])>=0||(k.push(e[m]),j[e[m]]=a[e[m]]);return T({},j,b)}function j(a,b,c){if(!c){c=[];for(var d in a)c.push(d)}for(var e=0;e<c.length;e++){var f=c[e];if(a[f]!=b[f])return!1}return!0}function k(a,b){var c={};return S(a,function(a){c[a]=b[a]}),c}function l(a){var b={},c=Array.prototype.concat.apply(Array.prototype,Array.prototype.slice.call(arguments,1));return S(c,function(c){c in a&&(b[c]=a[c])}),b}function m(a){var b={},c=Array.prototype.concat.apply(Array.prototype,Array.prototype.slice.call(arguments,1));for(var d in a)-1==h(c,d)&&(b[d]=a[d]);return b}function n(a,b){var c=R(a),d=c?[]:{};return S(a,function(a,e){b(a,e)&&(d[c?d.length:e]=a)}),d}function o(a,b){var c=R(a)?[]:{};return S(a,function(a,d){c[d]=b(a,d)}),c}function p(a){return a.then(c,function(){})&&a}function q(a,b){var d=1,f=2,i={},j=[],k=i,l=T(a.when(i),{$$promises:i,$$values:i});this.study=function(i){function n(a,c){if(t[c]!==f){if(s.push(c),t[c]===d)throw s.splice(0,h(s,c)),new Error("Cyclic dependency: "+s.join(" -> "));if(t[c]=d,P(a))r.push(c,[function(){return b.get(a)}],j);else{var e=b.annotate(a);S(e,function(a){a!==c&&i.hasOwnProperty(a)&&n(i[a],a)}),r.push(c,a,e)}s.pop(),t[c]=f}}function o(a){return Q(a)&&a.then&&a.$$promises}if(!Q(i))throw new Error("'invocables' must be an object");var q=g(i||{}),r=[],s=[],t={};return S(i,n),i=s=t=null,function(d,f,g){function h(){--v||(w||e(u,f.$$values),s.$$values=u,s.$$promises=s.$$promises||!0,delete s.$$inheritedValues,n.resolve(u))}function i(a){s.$$failure=a,n.reject(a)}if(o(d)&&g===c&&(g=f,f=d,d=null),d){if(!Q(d))throw new Error("'locals' must be an object")}else d=k;if(f){if(!o(f))throw new Error("'parent' must be a promise returned by $resolve.resolve()")}else f=l;var n=a.defer(),s=p(n.promise),t=s.$$promises={},u=T({},d),v=1+r.length/3,w=!1;if(p(s),N(f.$$failure))return i(f.$$failure),s;f.$$inheritedValues&&e(u,m(f.$$inheritedValues,q)),T(t,f.$$promises),f.$$values?(w=e(u,m(f.$$values,q)),s.$$inheritedValues=m(f.$$values,q),h()):(f.$$inheritedValues&&(s.$$inheritedValues=m(f.$$inheritedValues,q)),f.then(h,i));for(var x=0,y=r.length;x<y;x+=3)d.hasOwnProperty(r[x])?h():function(c,e,f){function j(a){l.reject(a),i(a)}function k(){if(!N(s.$$failure))try{l.resolve(b.invoke(e,g,u)),l.promise.then(function(a){u[c]=a,h()},j)}catch(a){j(a)}}var l=a.defer(),m=0;S(f,function(a){t.hasOwnProperty(a)&&!d.hasOwnProperty(a)&&(m++,t[a].then(function(b){u[a]=b,--m||k()},j))}),m||k(),t[c]=p(l.promise)
}(r[x],r[x+1],r[x+2]);return s}},this.resolve=function(a,b,c,d){return this.study(a)(b,c,d)}}function r(){var a=b.version.minor<3;this.shouldUnsafelyUseHttp=function(b){a=!!b},this.$get=["$http","$templateCache","$injector",function(b,c,d){return new s(b,c,d,a)}]}function s(a,b,c,d){this.fromConfig=function(a,b,c){return N(a.template)?this.fromString(a.template,b):N(a.templateUrl)?this.fromUrl(a.templateUrl,b):N(a.templateProvider)?this.fromProvider(a.templateProvider,b,c):null},this.fromString=function(a,b){return O(a)?a(b):a},this.fromUrl=function(e,f){return O(e)&&(e=e(f)),null==e?null:d?a.get(e,{cache:b,headers:{Accept:"text/html"}}).then(function(a){return a.data}):c.get("$templateRequest")(e)},this.fromProvider=function(a,b,d){return c.invoke(a,null,d||{params:b})}}function t(a,b,e){function f(b,c,d,e){if(q.push(b),o[b])return o[b];if(!/^\w+([-.]+\w+)*(?:\[\])?$/.test(b))throw new Error("Invalid parameter name '"+b+"' in pattern '"+a+"'");if(p[b])throw new Error("Duplicate parameter name '"+b+"' in pattern '"+a+"'");return p[b]=new W.Param(b,c,d,e),p[b]}function g(a,b,c,d){var e=["",""],f=a.replace(/[\\\[\]\^$*+?.()|{}]/g,"\\$&");if(!b)return f;switch(c){case!1:e=["(",")"+(d?"?":"")];break;case!0:f=f.replace(/\/$/,""),e=["(?:/(",")|/)?"];break;default:e=["("+c+"|",")?"]}return f+e[0]+b+e[1]}function h(e,f){var g,h,i,j,k;return g=e[2]||e[3],k=b.params[g],i=a.substring(m,e.index),h=f?e[4]:e[4]||("*"==e[1]?".*":null),h&&(j=W.type(h)||d(W.type("string"),{pattern:new RegExp(h,b.caseInsensitive?"i":c)})),{id:g,regexp:h,segment:i,type:j,cfg:k}}b=T({params:{}},Q(b)?b:{});var i,j=/([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g,k=/([:]?)([\w\[\].-]+)|\{([\w\[\].-]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g,l="^",m=0,n=this.segments=[],o=e?e.params:{},p=this.params=e?e.params.$$new():new W.ParamSet,q=[];this.source=a;for(var r,s,t;(i=j.exec(a))&&(r=h(i,!1),!(r.segment.indexOf("?")>=0));)s=f(r.id,r.type,r.cfg,"path"),l+=g(r.segment,s.type.pattern.source,s.squash,s.isOptional),n.push(r.segment),m=j.lastIndex;t=a.substring(m);var u=t.indexOf("?");if(u>=0){var v=this.sourceSearch=t.substring(u);if(t=t.substring(0,u),this.sourcePath=a.substring(0,m+u),v.length>0)for(m=0;i=k.exec(v);)r=h(i,!0),s=f(r.id,r.type,r.cfg,"search"),m=j.lastIndex}else this.sourcePath=a,this.sourceSearch="";l+=g(t)+(!1===b.strict?"/?":"")+"$",n.push(t),this.regexp=new RegExp(l,b.caseInsensitive?"i":c),this.prefix=n[0],this.$$paramNames=q}function u(a){T(this,a)}function v(){function a(a){return null!=a?a.toString().replace(/(~|\/)/g,function(a){return{"~":"~~","/":"~2F"}[a]}):a}function e(a){return null!=a?a.toString().replace(/(~~|~2F)/g,function(a){return{"~~":"~","~2F":"/"}[a]}):a}function f(){return{strict:p,caseInsensitive:m}}function i(a){return O(a)||R(a)&&O(a[a.length-1])}function j(){for(;w.length;){var a=w.shift();if(a.pattern)throw new Error("You cannot override a type's .pattern at runtime.");b.extend(r[a.name],l.invoke(a.def))}}function k(a){T(this,a||{})}W=this;var l,m=!1,p=!0,q=!1,r={},s=!0,w=[],x={string:{encode:a,decode:e,is:function(a){return null==a||!N(a)||"string"==typeof a},pattern:/[^\/]*/},int:{encode:a,decode:function(a){return parseInt(a,10)},is:function(a){return a!==c&&null!==a&&this.decode(a.toString())===a},pattern:/\d+/},bool:{encode:function(a){return a?1:0},decode:function(a){return 0!==parseInt(a,10)},is:function(a){return!0===a||!1===a},pattern:/0|1/},date:{encode:function(a){return this.is(a)?[a.getFullYear(),("0"+(a.getMonth()+1)).slice(-2),("0"+a.getDate()).slice(-2)].join("-"):c},decode:function(a){if(this.is(a))return a;var b=this.capture.exec(a);return b?new Date(b[1],b[2]-1,b[3]):c},is:function(a){return a instanceof Date&&!isNaN(a.valueOf())},equals:function(a,b){return this.is(a)&&this.is(b)&&a.toISOString()===b.toISOString()},pattern:/[0-9]{4}-(?:0[1-9]|1[0-2])-(?:0[1-9]|[1-2][0-9]|3[0-1])/,capture:/([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])/},json:{encode:b.toJson,decode:b.fromJson,is:b.isObject,equals:b.equals,pattern:/[^\/]*/},any:{encode:b.identity,decode:b.identity,equals:b.equals,pattern:/.*/}};v.$$getDefaultValue=function(a){if(!i(a.value))return a.value;if(!l)throw new Error("Injectable functions cannot be called at configuration time");return l.invoke(a.value)},this.caseInsensitive=function(a){return N(a)&&(m=a),m},this.strictMode=function(a){return N(a)&&(p=a),p},this.defaultSquashPolicy=function(a){if(!N(a))return q;if(!0!==a&&!1!==a&&!P(a))throw new Error("Invalid squash policy: "+a+". Valid policies: false, true, arbitrary-string");return q=a,a},this.compile=function(a,b){return new t(a,T(f(),b))},this.isMatcher=function(a){if(!Q(a))return!1;var b=!0;return S(t.prototype,function(c,d){O(c)&&(b=b&&N(a[d])&&O(a[d]))}),b},this.type=function(a,b,c){if(!N(b))return r[a];if(r.hasOwnProperty(a))throw new Error("A type named '"+a+"' has already been defined.");return r[a]=new u(T({name:a},b)),c&&(w.push({name:a,def:c}),s||j()),this},S(x,function(a,b){r[b]=new u(T({name:b},a))}),r=d(r,{}),this.$get=["$injector",function(a){return l=a,s=!1,j(),S(x,function(a,b){r[b]||(r[b]=new u(a))}),this}],this.Param=function(a,d,e,f){function t(){if(!l)throw new Error("Injectable functions cannot be called at configuration time");var a=l.invoke(e.$$fn);if(null!==a&&a!==c&&!x.type.is(a))throw new Error("Default value ("+a+") for parameter '"+x.id+"' is not an instance of Type ("+x.type.name+")");return a}function v(a){function b(a){return function(b){return b.from===a}}return a=function(a){var c=o(n(x.replace,b(a)),function(a){return a.to});return c.length?c[0]:a}(a),N(a)?x.type.$normalize(a):t()}function w(){return"{Param:"+a+" "+d+" squash: '"+A+"' optional: "+z+"}"}var x=this;e=function(a){var b=Q(a)?g(a):[];return-1===h(b,"value")&&-1===h(b,"type")&&-1===h(b,"squash")&&-1===h(b,"array")&&(a={value:a}),a.$$fn=i(a.value)?a.value:function(){return a.value},a}(e),d=function(c,d,e){if(c.type&&d)throw new Error("Param '"+a+"' has two type configurations.");return d||(c.type?b.isString(c.type)?r[c.type]:c.type instanceof u?c.type:new u(c.type):"config"===e?r.any:r.string)}(e,d,f);var y=function(){var b={array:"search"===f&&"auto"},c=a.match(/\[\]$/)?{array:!0}:{};return T(b,c,e).array}();d=y?d.$asArray(y,"search"===f):d,"string"!==d.name||y||"path"!==f||e.value!==c||(e.value="");var z=e.value!==c,A=function(a,b){var c=a.squash;if(!b||!1===c)return!1;if(!N(c)||null==c)return q;if(!0===c||P(c))return c;throw new Error("Invalid squash policy: '"+c+"'. Valid policies: false, true, or arbitrary string")}(e,z),B=function(a,b,d,e){var f,g,i=[{from:"",to:d||b?c:""},{from:null,to:d||b?c:""}];return f=R(a.replace)?a.replace:[],P(e)&&f.push({from:e,to:c}),g=o(f,function(a){return a.from}),n(i,function(a){return-1===h(g,a.from)}).concat(f)}(e,y,z,A);T(this,{id:a,type:d,location:f,array:y,squash:A,replace:B,isOptional:z,value:v,dynamic:c,config:e,toString:w})},k.prototype={$$new:function(){return d(this,T(new k,{$$parent:this}))},$$keys:function(){for(var a=[],b=[],c=this,d=g(k.prototype);c;)b.push(c),c=c.$$parent;return b.reverse(),S(b,function(b){S(g(b),function(b){-1===h(a,b)&&-1===h(d,b)&&a.push(b)})}),a},$$values:function(a){var b={},c=this;return S(c.$$keys(),function(d){b[d]=c[d].value(a&&a[d])}),b},$$equals:function(a,b){var c=!0,d=this;return S(d.$$keys(),function(e){var f=a&&a[e],g=b&&b[e];d[e].type.equals(f,g)||(c=!1)}),c},$$validates:function(a){var d,e,f,g,h,i=this.$$keys();for(d=0;d<i.length&&(e=this[i[d]],(f=a[i[d]])!==c&&null!==f||!e.isOptional);d++){if(g=e.type.$normalize(f),!e.type.is(g))return!1;if(h=e.type.encode(g),b.isString(h)&&!e.type.pattern.exec(h))return!1}return!0},$$parent:c},this.ParamSet=k}function w(a,d){function e(a){var b=/^\^((?:\\[^a-zA-Z0-9]|[^\\\[\]\^$*+?.()|{}]+)*)/.exec(a.source);return null!=b?b[1].replace(/\\(.)/g,"$1"):""}function f(a,b){return a.replace(/\$(\$|\d{1,2})/,function(a,c){return b["$"===c?0:Number(c)]})}function g(a,b,c){if(!c)return!1;var d=a.invoke(b,b,{$match:c});return!N(d)||d}function h(d,e,f,g,h){function m(a,b,c){return"/"===q?a:b?q.slice(0,-1)+a:c?q.slice(1)+a:a}function n(a){function b(a){var b=a(f,d);return!!b&&(P(b)&&d.replace().url(b),!0)}if(!a||!a.defaultPrevented){p&&d.url(),p=c;var e,g=j.length;for(e=0;e<g;e++)if(b(j[e]))return;k&&b(k)}}function o(){return i=i||e.$on("$locationChangeSuccess",n)}var p,q=g.baseHref(),r=d.url();return l||o(),{sync:function(){n()},listen:function(){return o()},update:function(a){return a?void(r=d.url()):void(d.url()!==r&&(d.url(r),d.replace()))},push:function(a,b,e){var f=a.format(b||{});null!==f&&b&&b["#"]&&(f+="#"+b["#"]),d.url(f),p=e&&e.$$avoidResync?d.url():c,e&&e.replace&&d.replace()},href:function(c,e,f){if(!c.validates(e))return null;var g=a.html5Mode();b.isObject(g)&&(g=g.enabled),g=g&&h.history;var i=c.format(e);if(f=f||{},g||null===i||(i="#"+a.hashPrefix()+i),null!==i&&e&&e["#"]&&(i+="#"+e["#"]),i=m(i,g,f.absolute),!f.absolute||!i)return i;var j=!g&&i?"/":"",k=d.port();return k=80===k||443===k?"":":"+k,[d.protocol(),"://",d.host(),k,j,i].join("")}}}var i,j=[],k=null,l=!1;this.rule=function(a){if(!O(a))throw new Error("'rule' must be a function");return j.push(a),this},this.otherwise=function(a){if(P(a)){var b=a;a=function(){return b}}else if(!O(a))throw new Error("'rule' must be a function");return k=a,this},this.when=function(a,b){var c,h=P(b);if(P(a)&&(a=d.compile(a)),!h&&!O(b)&&!R(b))throw new Error("invalid 'handler' in when()");var i={matcher:function(a,b){return h&&(c=d.compile(b),b=["$match",function(a){return c.format(a)}]),T(function(c,d){return g(c,b,a.exec(d.path(),d.search()))},{prefix:P(a.prefix)?a.prefix:""})},regex:function(a,b){if(a.global||a.sticky)throw new Error("when() RegExp must not be global or sticky");return h&&(c=b,b=["$match",function(a){return f(c,a)}]),T(function(c,d){return g(c,b,a.exec(d.path()))},{prefix:e(a)})}},j={matcher:d.isMatcher(a),regex:a instanceof RegExp};for(var k in j)if(j[k])return this.rule(i[k](a,b));throw new Error("invalid 'what' in when()")},this.deferIntercept=function(a){a===c&&(a=!0),l=a},this.$get=h,h.$inject=["$location","$rootScope","$injector","$browser","$sniffer"]}function x(a,e){function f(a){return 0===a.indexOf(".")||0===a.indexOf("^")}function m(a,b){if(!a)return c;var d=P(a),e=d?a:a.name;if(f(e)){if(!b)throw new Error("No reference point given for path '"+e+"'");b=m(b);for(var h=e.split("."),i=0,j=h.length,k=b;i<j;i++)if(""!==h[i]||0!==i){if("^"!==h[i])break;if(!k.parent)throw new Error("Path '"+e+"' not valid for state '"+b.name+"'");k=k.parent}else k=b;h=h.slice(i).join("."),e=k.name+(k.name&&h?".":"")+h}var l=A[e];return!l||!d&&(d||l!==a&&l.self!==a)?c:l}function n(a,b){B[a]||(B[a]=[]),B[a].push(b)}function q(a){for(var b=B[a]||[];b.length;)r(b.shift())}function r(b){b=d(b,{self:b,resolve:b.resolve||{},toString:function(){return this.name}});var c=b.name;if(!P(c)||c.indexOf("@")>=0)throw new Error("State must have a valid name");if(A.hasOwnProperty(c))throw new Error("State '"+c+"' is already defined");var e=-1!==c.indexOf(".")?c.substring(0,c.lastIndexOf(".")):P(b.parent)?b.parent:Q(b.parent)&&P(b.parent.name)?b.parent.name:"";if(e&&!A[e])return n(e,b.self);for(var f in D)O(D[f])&&(b[f]=D[f](b,D.$delegates[f]));return A[c]=b,!b[C]&&b.url&&a.when(b.url,["$match","$stateParams",function(a,c){z.$current.navigable==b&&j(a,c)||z.transitionTo(b,a,{inherit:!0,location:!1})}]),q(c),b}function s(a){return a.indexOf("*")>-1}function t(a){for(var b=a.split("."),c=z.$current.name.split("."),d=0,e=b.length;d<e;d++)"*"===b[d]&&(c[d]="*");return"**"===b[0]&&(c=c.slice(h(c,b[1])),c.unshift("**")),"**"===b[b.length-1]&&(c.splice(h(c,b[b.length-2])+1,Number.MAX_VALUE),c.push("**")),b.length==c.length&&c.join("")===b.join("")}function u(a,b){return P(a)&&!N(b)?D[a]:O(b)&&P(a)?(D[a]&&!D.$delegates[a]&&(D.$delegates[a]=D[a]),D[a]=b,this):this}function v(a,b){return Q(a)?b=a:b.name=a,r(b),this}function w(a,e,f,h,j,l,n,q,r){function u(b,c,d,f){var g=a.$broadcast("$stateNotFound",b,c,d);if(g.defaultPrevented)return n.update(),E;if(!g.retry)return null;if(f.$retry)return n.update(),F;var h=z.transition=e.when(g.retry);return h.then(function(){return h!==z.transition?(a.$broadcast("$stateChangeCancel",b.to,b.toParams,c,d),B):(b.options.$retry=!0,z.transitionTo(b.to,b.toParams,b.options))},function(){return E}),n.update(),h}function v(a,c,d,g,i,l){function m(){var c=[];return S(a.views,function(d,e){var g=d.resolve&&d.resolve!==a.resolve?d.resolve:{};g.$template=[function(){return f.load(e,{view:d,locals:i.globals,params:n,notify:l.notify})||""}],c.push(j.resolve(g,i.globals,i.resolve,a).then(function(c){if(O(d.controllerProvider)||R(d.controllerProvider)){var f=b.extend({},g,i.globals);c.$$controller=h.invoke(d.controllerProvider,null,f)}else c.$$controller=d.controller;c.$$state=a,c.$$controllerAs=d.controllerAs,c.$$resolveAs=d.resolveAs,i[e]=c}))}),e.all(c).then(function(){return i.globals})}var n=d?c:k(a.params.$$keys(),c),o={$stateParams:n};i.resolve=j.resolve(a.resolve,o,i.resolve,a);var p=[i.resolve.then(function(a){i.globals=a})];return g&&p.push(g),e.all(p).then(m).then(function(a){return i})}var w=new Error("transition superseded"),B=p(e.reject(w)),D=p(e.reject(new Error("transition prevented"))),E=p(e.reject(new Error("transition aborted"))),F=p(e.reject(new Error("transition failed")));return y.locals={resolve:null,globals:{$stateParams:{}}},z={params:{},current:y.self,$current:y,transition:null},z.reload=function(a){return z.transitionTo(z.current,l,{reload:a||!0,inherit:!1,notify:!0})},z.go=function(a,b,c){return z.transitionTo(a,b,T({inherit:!0,relative:z.$current},c))},z.transitionTo=function(b,c,f){c=c||{},f=T({location:!0,inherit:!1,relative:null,notify:!0,reload:!1,$retry:!1},f||{});var g,j=z.$current,o=z.params,q=j.path,r=m(b,f.relative),s=c["#"];if(!N(r)){var t={to:b,toParams:c,options:f},A=u(t,j.self,o,f);if(A)return A;if(b=t.to,c=t.toParams,f=t.options,r=m(b,f.relative),!N(r)){if(!f.relative)throw new Error("No such state '"+b+"'");throw new Error("Could not resolve '"+b+"' from state '"+f.relative+"'")}}if(r[C])throw new Error("Cannot transition to abstract state '"+b+"'");if(f.inherit&&(c=i(l,c||{},z.$current,r)),!r.params.$$validates(c))return F;c=r.params.$$values(c),b=r;var E=b.path,G=0,H=E[G],I=y.locals,J=[];if(f.reload){if(P(f.reload)||Q(f.reload)){if(Q(f.reload)&&!f.reload.name)throw new Error("Invalid reload state object");var K=!0===f.reload?q[0]:m(f.reload);if(f.reload&&!K)throw new Error("No such reload state '"+(P(f.reload)?f.reload:f.reload.name)+"'");for(;H&&H===q[G]&&H!==K;)I=J[G]=H.locals,G++,H=E[G]}}else for(;H&&H===q[G]&&H.ownParams.$$equals(c,o);)I=J[G]=H.locals,G++,H=E[G];if(x(b,c,j,o,I,f))return s&&(c["#"]=s),z.params=c,U(z.params,l),U(k(b.params.$$keys(),l),b.locals.globals.$stateParams),f.location&&b.navigable&&b.navigable.url&&(n.push(b.navigable.url,c,{$$avoidResync:!0,replace:"replace"===f.location}),n.update(!0)),z.transition=null,e.when(z.current);if(c=k(b.params.$$keys(),c||{}),s&&(c["#"]=s),f.notify&&a.$broadcast("$stateChangeStart",b.self,c,j.self,o,f).defaultPrevented)return a.$broadcast("$stateChangeCancel",b.self,c,j.self,o),null==z.transition&&n.update(),D;for(var L=e.when(I),M=G;M<E.length;M++,H=E[M])I=J[M]=d(I),L=v(H,c,H===b,L,I,f);var O=z.transition=L.then(function(){var d,e,g;if(z.transition!==O)return a.$broadcast("$stateChangeCancel",b.self,c,j.self,o),B;for(d=q.length-1;d>=G;d--)g=q[d],g.self.onExit&&h.invoke(g.self.onExit,g.self,g.locals.globals),g.locals=null;for(d=G;d<E.length;d++)e=E[d],e.locals=J[d],e.self.onEnter&&h.invoke(e.self.onEnter,e.self,e.locals.globals);return z.transition!==O?(a.$broadcast("$stateChangeCancel",b.self,c,j.self,o),B):(z.$current=b,z.current=b.self,z.params=c,U(z.params,l),z.transition=null,f.location&&b.navigable&&n.push(b.navigable.url,b.navigable.locals.globals.$stateParams,{$$avoidResync:!0,replace:"replace"===f.location}),f.notify&&a.$broadcast("$stateChangeSuccess",b.self,c,j.self,o),n.update(!0),z.current)}).then(null,function(d){return d===w?B:z.transition!==O?(a.$broadcast("$stateChangeCancel",b.self,c,j.self,o),B):(z.transition=null,g=a.$broadcast("$stateChangeError",b.self,c,j.self,o,d),g.defaultPrevented||n.update(),e.reject(d))});return p(O),O},z.is=function(a,b,d){d=T({relative:z.$current},d||{});var e=m(a,d.relative);return N(e)?z.$current===e&&(!b||g(b).reduce(function(a,c){var d=e.params[c];return a&&!d||d.type.equals(l[c],b[c])},!0)):c},z.includes=function(a,b,d){if(d=T({relative:z.$current},d||{}),P(a)&&s(a)){if(!t(a))return!1;a=z.$current.name}var e=m(a,d.relative);if(!N(e))return c;if(!N(z.$current.includes[e.name]))return!1;if(!b)return!0;for(var f=g(b),h=0;h<f.length;h++){var i=f[h],j=e.params[i];if(j&&!j.type.equals(l[i],b[i]))return!1}return g(b).reduce(function(a,c){var d=e.params[c];return a&&!d||d.type.equals(l[c],b[c])},!0)},z.href=function(a,b,d){d=T({lossy:!0,inherit:!0,absolute:!1,relative:z.$current},d||{});var e=m(a,d.relative);if(!N(e))return null;d.inherit&&(b=i(l,b||{},z.$current,e));var f=e&&d.lossy?e.navigable:e;return f&&f.url!==c&&null!==f.url?n.href(f.url,k(e.params.$$keys().concat("#"),b||{}),{absolute:d.absolute}):null},z.get=function(a,b){if(0===arguments.length)return o(g(A),function(a){return A[a].self});var c=m(a,b||z.$current);return c&&c.self?c.self:null},z}function x(a,b,c,d,e,f){if(!f.reload&&a===c&&(e===c.locals||!1===a.self.reloadOnSearch&&function(a,b,c){function d(b){return"search"!=a.params[b].location}var e=a.params.$$keys().filter(d),f=l.apply({},[a.params].concat(e));return new W.ParamSet(f).$$equals(b,c)}(c,d,b)))return!0}var y,z,A={},B={},C="abstract",D={parent:function(a){if(N(a.parent)&&a.parent)return m(a.parent);var b=/^(.+)\.[^.]+$/.exec(a.name);return b?m(b[1]):y},data:function(a){return a.parent&&a.parent.data&&(a.data=a.self.data=d(a.parent.data,a.data)),a.data},url:function(a){var b=a.url,c={params:a.params||{}};if(P(b))return"^"==b.charAt(0)?e.compile(b.substring(1),c):(a.parent.navigable||y).url.concat(b,c);if(!b||e.isMatcher(b))return b;throw new Error("Invalid url '"+b+"' in state '"+a+"'")},navigable:function(a){return a.url?a:a.parent?a.parent.navigable:null},ownParams:function(a){var b=a.url&&a.url.params||new W.ParamSet;return S(a.params||{},function(a,c){b[c]||(b[c]=new W.Param(c,null,a,"config"))}),b},params:function(a){var b=l(a.ownParams,a.ownParams.$$keys());return a.parent&&a.parent.params?T(a.parent.params.$$new(),b):new W.ParamSet},views:function(a){var b={};return S(N(a.views)?a.views:{"":a},function(c,d){d.indexOf("@")<0&&(d+="@"+a.parent.name),c.resolveAs=c.resolveAs||a.resolveAs||"$resolve",b[d]=c}),b},path:function(a){return a.parent?a.parent.path.concat(a):[]},includes:function(a){var b=a.parent?T({},a.parent.includes):{};return b[a.name]=!0,b},$delegates:{}};y=r({name:"",url:"^",views:null,abstract:!0}),y.navigable=null,this.decorator=u,this.state=v,this.$get=w,w.$inject=["$rootScope","$q","$view","$injector","$resolve","$stateParams","$urlRouter","$location","$urlMatcherFactory"]}function y(){function a(a,b){return{load:function(a,c){var d;return c=T({template:null,controller:null,view:null,locals:null,notify:!0,async:!0,params:{}},c),c.view&&(d=b.fromConfig(c.view,c.params,c.locals)),d}}}this.$get=a,a.$inject=["$rootScope","$templateFactory"]}function z(){var a=!1;this.useAnchorScroll=function(){a=!0},this.$get=["$anchorScroll","$timeout",function(b,c){return a?b:function(a){return c(function(){a[0].scrollIntoView()},0,!1)}}]}function A(a,c,d,e,f){function h(a,c){if(k)return{enter:function(a,c,d){b.version.minor>2?k.enter(a,null,c).then(d):k.enter(a,null,c,d)},leave:function(a,c){b.version.minor>2?k.leave(a).then(c):k.leave(a,c)}};if(j){var e=j&&j(c,a);return{enter:function(a,b,c){e.enter(a,null,b),c()},leave:function(a,b){e.leave(a),b()}}}return function(){return{enter:function(a,b,c){b.after(a),c()},leave:function(a,b){a.remove(),b()}}}()}var i=function(){return c.has?function(a){return c.has(a)?c.get(a):null}:function(a){try{return c.get(a)}catch(a){return null}}}(),j=i("$animator"),k=i("$animate");return{restrict:"ECA",terminal:!0,priority:400,transclude:"element",compile:function(c,g,i){return function(c,g,j){function k(){if(m&&(m.remove(),m=null),o&&(o.$destroy(),o=null),n){var a=n.data("$uiViewAnim");s.leave(n,function(){a.$$animLeave.resolve(),m=null}),m=n,n=null}}function l(h){var l,m=C(c,j,g,e),t=m&&a.$current&&a.$current.locals[m];if(h||t!==p){l=c.$new(),p=a.$current.locals[m],l.$emit("$viewContentLoading",m);var u=i(l,function(a){var e=f.defer(),h=f.defer(),i={$animEnter:e.promise,$animLeave:h.promise,$$animLeave:h};a.data("$uiViewAnim",i),s.enter(a,g,function(){e.resolve(),o&&o.$emit("$viewContentAnimationEnded"),(b.isDefined(r)&&!r||c.$eval(r))&&d(a)}),k()});n=u,o=l,o.$emit("$viewContentLoaded",m),o.$eval(q)}}var m,n,o,p,q=j.onload||"",r=j.autoscroll,s=h(j,c);g.inheritedData("$uiView"),c.$on("$stateChangeSuccess",function(){l(!1)}),l(!0)}}}}function B(a,c,d,e){return{restrict:"ECA",priority:-400,compile:function(f){var g=f.html();return f.empty?f.empty():f[0].innerHTML=null,function(f,h,i){var j=d.$current,k=C(f,i,h,e),l=j&&j.locals[k];if(!l)return h.html(g),void a(h.contents())(f);h.data("$uiView",{name:k,state:l.$$state}),h.html(l.$template?l.$template:g);var m=b.extend({},l);f[l.$$resolveAs]=m;var n=a(h.contents());if(l.$$controller){l.$scope=f,l.$element=h;var o=c(l.$$controller,l);l.$$controllerAs&&(f[l.$$controllerAs]=o,f[l.$$controllerAs][l.$$resolveAs]=m),O(o.$onInit)&&o.$onInit(),h.data("$ngControllerController",o),h.children().data("$ngControllerController",o)}n(f)}}}}function C(a,b,c,d){var e=d(b.uiView||b.name||"")(a),f=c.inheritedData("$uiView");return e.indexOf("@")>=0?e:e+"@"+(f?f.state.name:"")}function D(a,b){var c,d=a.match(/^\s*({[^}]*})\s*$/);if(d&&(a=b+"("+d[1]+")"),!(c=a.replace(/\n/g," ").match(/^([^(]+?)\s*(\((.*)\))?$/))||4!==c.length)throw new Error("Invalid state ref '"+a+"'");return{state:c[1],paramExpr:c[3]||null}}function E(a){var b=a.parent().inheritedData("$uiView");if(b&&b.state&&b.state.name)return b.state}function F(a){var b="[object SVGAnimatedString]"===Object.prototype.toString.call(a.prop("href")),c="FORM"===a[0].nodeName;return{attr:c?"action":b?"xlink:href":"href",isAnchor:"A"===a.prop("tagName").toUpperCase(),clickable:!c}}function G(a,b,c,d,e){return function(f){var g=f.which||f.button,h=e();if(!(g>1||f.ctrlKey||f.metaKey||f.shiftKey||a.attr("target"))){var i=c(function(){b.go(h.state,h.params,h.options)});f.preventDefault();var j=d.isAnchor&&!h.href?1:0;f.preventDefault=function(){j--<=0&&c.cancel(i)}}}}function H(a,b){return{relative:E(a)||b.$current,inherit:!0}}function I(a,c){return{restrict:"A",require:["?^uiSrefActive","?^uiSrefActiveEq"],link:function(d,e,f,g){var h,i=D(f.uiSref,a.current.name),j={state:i.state,href:null,params:null},k=F(e),l=g[1]||g[0],m=null;j.options=T(H(e,a),f.uiSrefOpts?d.$eval(f.uiSrefOpts):{});var n=function(c){c&&(j.params=b.copy(c)),j.href=a.href(i.state,j.params,j.options),m&&m(),l&&(m=l.$$addStateInfo(i.state,j.params)),null!==j.href&&f.$set(k.attr,j.href)};i.paramExpr&&(d.$watch(i.paramExpr,function(a){a!==j.params&&n(a)},!0),j.params=b.copy(d.$eval(i.paramExpr))),n(),k.clickable&&(h=G(e,a,c,k,function(){return j}),e[e.on?"on":"bind"]("click",h),d.$on("$destroy",function(){e[e.off?"off":"unbind"]("click",h)}))}}}function J(a,b){return{restrict:"A",require:["?^uiSrefActive","?^uiSrefActiveEq"],link:function(c,d,e,f){function g(b){m.state=b[0],m.params=b[1],m.options=b[2],m.href=a.href(m.state,m.params,m.options),n&&n(),j&&(n=j.$$addStateInfo(m.state,m.params)),m.href&&e.$set(i.attr,m.href)}var h,i=F(d),j=f[1]||f[0],k=[e.uiState,e.uiStateParams||null,e.uiStateOpts||null],l="["+k.map(function(a){return a||"null"}).join(", ")+"]",m={state:null,params:null,options:null,href:null},n=null;c.$watch(l,g,!0),g(c.$eval(l)),i.clickable&&(h=G(d,a,b,i,function(){return m}),d[d.on?"on":"bind"]("click",h),c.$on("$destroy",function(){d[d.off?"off":"unbind"]("click",h)}))}}}function K(a,b,c){return{restrict:"A",controller:["$scope","$element","$attrs","$timeout",function(b,d,e,f){function g(b,c,e){var f=a.get(b,E(d)),g=h(b,c),i={state:f||{name:b},params:c,hash:g};return p.push(i),q[g]=e,function(){var a=p.indexOf(i);-1!==a&&p.splice(a,1)}}function h(a,c){if(!P(a))throw new Error("state should be a string");return Q(c)?a+V(c):(c=b.$eval(c),Q(c)?a+V(c):a)}function i(){for(var a=0;a<p.length;a++)l(p[a].state,p[a].params)?j(d,q[p[a].hash]):k(d,q[p[a].hash]),m(p[a].state,p[a].params)?j(d,n):k(d,n)}function j(a,b){f(function(){a.addClass(b)})}function k(a,b){a.removeClass(b)}function l(b,c){return a.includes(b.name,c)}function m(b,c){return a.is(b.name,c)}var n,o,p=[],q={};n=c(e.uiSrefActiveEq||"",!1)(b);try{o=b.$eval(e.uiSrefActive)}catch(a){}o=o||c(e.uiSrefActive||"",!1)(b),Q(o)&&S(o,function(c,d){if(P(c)){var e=D(c,a.current.name);g(e.state,b.$eval(e.paramExpr),d)}}),this.$$addStateInfo=function(a,b){if(!(Q(o)&&p.length>0)){var c=g(a,b,o);return i(),c}},b.$on("$stateChangeSuccess",i),i()}]}}function L(a){var b=function(b,c){return a.is(b,c)};return b.$stateful=!0,b}function M(a){var b=function(b,c,d){return a.includes(b,c,d)};return b.$stateful=!0,b}var N=b.isDefined,O=b.isFunction,P=b.isString,Q=b.isObject,R=b.isArray,S=b.forEach,T=b.extend,U=b.copy,V=b.toJson;b.module("ui.router.util",["ng"]),b.module("ui.router.router",["ui.router.util"]),b.module("ui.router.state",["ui.router.router","ui.router.util"]),b.module("ui.router",["ui.router.state"]),b.module("ui.router.compat",["ui.router"]),q.$inject=["$q","$injector"],b.module("ui.router.util").service("$resolve",q),b.module("ui.router.util").provider("$templateFactory",r);var W;t.prototype.concat=function(a,b){var c={caseInsensitive:W.caseInsensitive(),strict:W.strictMode(),squash:W.defaultSquashPolicy()};return new t(this.sourcePath+a+this.sourceSearch,T(c,b),this)},t.prototype.toString=function(){return this.source},t.prototype.exec=function(a,b){var d=this.regexp.exec(a);if(!d)return null;b=b||{};var e,f,g,h=this.parameters(),i=h.length,j=this.segments.length-1,k={};if(j!==d.length-1)throw new Error("Unbalanced capture group in route '"+this.source+"'");var l,m;for(e=0;e<j;e++){for(g=h[e],l=this.params[g],m=d[e+1],f=0;f<l.replace.length;f++)l.replace[f].from===m&&(m=l.replace[f].to);m&&!0===l.array&&(m=function(a){function b(a){return a.split("").reverse().join("")}function c(a){return a.replace(/\\-/g,"-")}return o(o(b(a).split(/-(?!\\)/),b),c).reverse()}(m)),N(m)&&(m=l.type.decode(m)),k[g]=l.value(m)}for(;e<i;e++){for(g=h[e],k[g]=this.params[g].value(b[g]),l=this.params[g],m=b[g],f=0;f<l.replace.length;f++)l.replace[f].from===m&&(m=l.replace[f].to);N(m)&&(m=l.type.decode(m)),k[g]=l.value(m)}return k},t.prototype.parameters=function(a){return N(a)?this.params[a]||null:this.$$paramNames},t.prototype.validates=function(a){return this.params.$$validates(a)},t.prototype.format=function(a){function b(a){return encodeURIComponent(a).replace(/-/g,function(a){return"%5C%"+a.charCodeAt(0).toString(16).toUpperCase()})}a=a||{};var c=this.segments,d=this.parameters(),e=this.params;if(!this.validates(a))return null;var f,g=!1,h=c.length-1,i=d.length,j=c[0];for(f=0;f<i;f++){var k=f<h,l=d[f],m=e[l],n=m.value(a[l]),p=m.isOptional&&m.type.equals(m.value(),n),q=!!p&&m.squash,r=m.type.encode(n);if(k){var s=c[f+1],t=f+1===h;if(!1===q)null!=r&&(j+=R(r)?o(r,b).join("-"):encodeURIComponent(r)),j+=s;else if(!0===q){var u=j.match(/\/$/)?/\/?(.*)/:/(.*)/;j+=s.match(u)[1]}else P(q)&&(j+=q+s);t&&!0===m.squash&&"/"===j.slice(-1)&&(j=j.slice(0,-1))}else{if(null==r||p&&!1!==q)continue;if(R(r)||(r=[r]),0===r.length)continue;r=o(r,encodeURIComponent).join("&"+l+"="),j+=(g?"&":"?")+l+"="+r,g=!0}}return j},u.prototype.is=function(a,b){return!0},u.prototype.encode=function(a,b){return a},u.prototype.decode=function(a,b){return a},u.prototype.equals=function(a,b){return a==b},u.prototype.$subPattern=function(){var a=this.pattern.toString();return a.substr(1,a.length-2)},u.prototype.pattern=/.*/,u.prototype.toString=function(){return"{Type:"+this.name+"}"},u.prototype.$normalize=function(a){return this.is(a)?a:this.decode(a)},u.prototype.$asArray=function(a,b){function d(a,b){function d(a,b){return function(){return a[b].apply(a,arguments)}}function e(a){return R(a)?a:N(a)?[a]:[]}function f(a){switch(a.length){case 0:return c;case 1:return"auto"===b?a[0]:a;default:return a}}function g(a){return!a}function h(a,b){return function(c){if(R(c)&&0===c.length)return c;c=e(c);var d=o(c,a);return!0===b?0===n(d,g).length:f(d)}}this.encode=h(d(a,"encode")),this.decode=h(d(a,"decode")),this.is=h(d(a,"is"),!0),this.equals=function(a){return function(b,c){var d=e(b),f=e(c);if(d.length!==f.length)return!1;for(var g=0;g<d.length;g++)if(!a(d[g],f[g]))return!1;return!0}}(d(a,"equals")),this.pattern=a.pattern,this.$normalize=h(d(a,"$normalize")),this.name=a.name,this.$arrayMode=b}if(!a)return this;if("auto"===a&&!b)throw new Error("'auto' array mode is for query parameters only");return new d(this,a)},b.module("ui.router.util").provider("$urlMatcherFactory",v),b.module("ui.router.util").run(["$urlMatcherFactory",function(a){}]),w.$inject=["$locationProvider","$urlMatcherFactoryProvider"],b.module("ui.router.router").provider("$urlRouter",w),x.$inject=["$urlRouterProvider","$urlMatcherFactoryProvider"],b.module("ui.router.state").factory("$stateParams",function(){return{}}).constant("$state.runtime",{autoinject:!0}).provider("$state",x).run(["$injector",function(a){a.get("$state.runtime").autoinject&&a.get("$state")}]),y.$inject=[],b.module("ui.router.state").provider("$view",y),b.module("ui.router.state").provider("$uiViewScroll",z),A.$inject=["$state","$injector","$uiViewScroll","$interpolate","$q"],B.$inject=["$compile","$controller","$state","$interpolate"],b.module("ui.router.state").directive("uiView",A),b.module("ui.router.state").directive("uiView",B),I.$inject=["$state","$timeout"],J.$inject=["$state","$timeout"],K.$inject=["$state","$stateParams","$interpolate"],b.module("ui.router.state").directive("uiSref",I).directive("uiSrefActive",K).directive("uiSrefActiveEq",K).directive("uiState",J),L.$inject=["$state"],M.$inject=["$state"],b.module("ui.router.state").filter("isState",L).filter("includedByState",M)}(window,window.angular),function(factory){"function"==typeof define&&define.amd?define("picker",["jquery"],factory):"object"==typeof exports?module.exports=factory(require("jquery")):this.Picker=factory(jQuery)}(function($){function PickerConstructor(ELEMENT,NAME,COMPONENT,OPTIONS){function createWrappedComponent(){return PickerConstructor._.node("div",PickerConstructor._.node("div",PickerConstructor._.node("div",PickerConstructor._.node("div",P.component.nodes(STATE.open),CLASSES.box),CLASSES.wrap),CLASSES.frame),CLASSES.holder,'tabindex="-1"')}function prepareElement(){$ELEMENT.data(NAME,P).addClass(CLASSES.input).val($ELEMENT.data("value")?P.get("select",SETTINGS.format):ELEMENT.value),SETTINGS.editable||$ELEMENT.on("focus."+STATE.id+" click."+STATE.id,function(event){event.preventDefault(),P.open()}).on("keydown."+STATE.id,handleKeydownEvent),aria(ELEMENT,{haspopup:!0,expanded:!1,readonly:!1,owns:ELEMENT.id+"_root"})}function prepareElementRoot(){aria(P.$root[0],"hidden",!0)}function prepareElementHolder(){P.$holder.on({keydown:handleKeydownEvent,"focus.toOpen":handleFocusToOpenEvent,blur:function(){$ELEMENT.removeClass(CLASSES.target)},focusin:function(event){P.$root.removeClass(CLASSES.focused),event.stopPropagation()},"mousedown click":function(event){var target=event.target;target!=P.$holder[0]&&(event.stopPropagation(),"mousedown"!=event.type||$(target).is("input, select, textarea, button, option")||(event.preventDefault(),P.$holder[0].focus()))}}).on("click","[data-pick], [data-nav], [data-clear], [data-close]",function(){var $target=$(this),targetData=$target.data(),targetDisabled=$target.hasClass(CLASSES.navDisabled)||$target.hasClass(CLASSES.disabled),activeElement=getActiveElement()
;activeElement=activeElement&&(activeElement.type||activeElement.href),(targetDisabled||activeElement&&!$.contains(P.$root[0],activeElement))&&P.$holder[0].focus(),!targetDisabled&&targetData.nav?P.set("highlight",P.component.item.highlight,{nav:targetData.nav}):!targetDisabled&&"pick"in targetData?(P.set("select",targetData.pick),SETTINGS.closeOnSelect&&P.close(!0)):targetData.clear?(P.clear(),SETTINGS.closeOnClear&&P.close(!0)):targetData.close&&P.close(!0)})}function prepareElementHidden(){var name;!0===SETTINGS.hiddenName?(name=ELEMENT.name,ELEMENT.name=""):(name=["string"==typeof SETTINGS.hiddenPrefix?SETTINGS.hiddenPrefix:"","string"==typeof SETTINGS.hiddenSuffix?SETTINGS.hiddenSuffix:"_submit"],name=name[0]+ELEMENT.name+name[1]),P._hidden=$('<input type=hidden name="'+name+'"'+($ELEMENT.data("value")||ELEMENT.value?' value="'+P.get("select",SETTINGS.formatSubmit)+'"':"")+">")[0],$ELEMENT.on("change."+STATE.id,function(){P._hidden.value=ELEMENT.value?P.get("select",SETTINGS.formatSubmit):""})}function focusPickerOnceOpened(){IS_DEFAULT_THEME&&supportsTransitions?P.$holder.find("."+CLASSES.frame).one("transitionend",function(){P.$holder[0].focus()}):P.$holder[0].focus()}function handleFocusToOpenEvent(event){event.stopPropagation(),$ELEMENT.addClass(CLASSES.target),P.$root.addClass(CLASSES.focused),P.open()}function handleKeydownEvent(event){var keycode=event.keyCode,isKeycodeDelete=/^(8|46)$/.test(keycode);if(27==keycode)return P.close(!0),!1;(32==keycode||isKeycodeDelete||!STATE.open&&P.component.key[keycode])&&(event.preventDefault(),event.stopPropagation(),isKeycodeDelete?P.clear().close():P.open())}if(!ELEMENT)return PickerConstructor;var IS_DEFAULT_THEME=!1,STATE={id:ELEMENT.id||"P"+Math.abs(~~(Math.random()*new Date))},SETTINGS=COMPONENT?$.extend(!0,{},COMPONENT.defaults,OPTIONS):OPTIONS||{},CLASSES=$.extend({},PickerConstructor.klasses(),SETTINGS.klass),$ELEMENT=$(ELEMENT),PickerInstance=function(){return this.start()},P=PickerInstance.prototype={constructor:PickerInstance,$node:$ELEMENT,start:function(){return STATE&&STATE.start?P:(STATE.methods={},STATE.start=!0,STATE.open=!1,STATE.type=ELEMENT.type,ELEMENT.autofocus=ELEMENT==getActiveElement(),ELEMENT.readOnly=!SETTINGS.editable,ELEMENT.id=ELEMENT.id||STATE.id,"text"!=ELEMENT.type&&(ELEMENT.type="text"),P.component=new COMPONENT(P,SETTINGS),P.$root=$('<div class="'+CLASSES.picker+'" id="'+ELEMENT.id+'_root" />'),prepareElementRoot(),P.$holder=$(createWrappedComponent()).appendTo(P.$root),prepareElementHolder(),SETTINGS.formatSubmit&&prepareElementHidden(),prepareElement(),SETTINGS.containerHidden?$(SETTINGS.containerHidden).append(P._hidden):$ELEMENT.after(P._hidden),SETTINGS.container?$(SETTINGS.container).append(P.$root):$ELEMENT.after(P.$root),P.on({start:P.component.onStart,render:P.component.onRender,stop:P.component.onStop,open:P.component.onOpen,close:P.component.onClose,set:P.component.onSet}).on({start:SETTINGS.onStart,render:SETTINGS.onRender,stop:SETTINGS.onStop,open:SETTINGS.onOpen,close:SETTINGS.onClose,set:SETTINGS.onSet}),IS_DEFAULT_THEME=isUsingDefaultTheme(P.$holder[0]),ELEMENT.autofocus&&P.open(),P.trigger("start").trigger("render"))},render:function(entireComponent){return entireComponent?(P.$holder=$(createWrappedComponent()),prepareElementHolder(),P.$root.html(P.$holder)):P.$root.find("."+CLASSES.box).html(P.component.nodes(STATE.open)),P.trigger("render")},stop:function(){return STATE.start?(P.close(),P._hidden&&P._hidden.parentNode.removeChild(P._hidden),P.$root.remove(),$ELEMENT.removeClass(CLASSES.input).removeData(NAME),setTimeout(function(){$ELEMENT.off("."+STATE.id)},0),ELEMENT.type=STATE.type,ELEMENT.readOnly=!1,P.trigger("stop"),STATE.methods={},STATE.start=!1,P):P},open:function(dontGiveFocus){return STATE.open?P:($ELEMENT.addClass(CLASSES.active),aria(ELEMENT,"expanded",!0),setTimeout(function(){P.$root.addClass(CLASSES.opened),aria(P.$root[0],"hidden",!1)},0),!1!==dontGiveFocus&&(STATE.open=!0,IS_DEFAULT_THEME&&$html.css("overflow","hidden").css("padding-right","+="+getScrollbarWidth()),focusPickerOnceOpened(),$document.on("click."+STATE.id+" focusin."+STATE.id,function(event){var target=event.target;target!=ELEMENT&&target!=document&&3!=event.which&&P.close(target===P.$holder[0])}).on("keydown."+STATE.id,function(event){var keycode=event.keyCode,keycodeToMove=P.component.key[keycode],target=event.target;27==keycode?P.close(!0):target!=P.$holder[0]||!keycodeToMove&&13!=keycode?$.contains(P.$root[0],target)&&13==keycode&&(event.preventDefault(),target.click()):(event.preventDefault(),keycodeToMove?PickerConstructor._.trigger(P.component.key.go,P,[PickerConstructor._.trigger(keycodeToMove)]):P.$root.find("."+CLASSES.highlighted).hasClass(CLASSES.disabled)||(P.set("select",P.component.item.highlight),SETTINGS.closeOnSelect&&P.close(!0)))})),P.trigger("open"))},close:function(giveFocus){return giveFocus&&(SETTINGS.editable?ELEMENT.focus():(P.$holder.off("focus.toOpen").focus(),setTimeout(function(){P.$holder.on("focus.toOpen",handleFocusToOpenEvent)},0))),$ELEMENT.removeClass(CLASSES.active),aria(ELEMENT,"expanded",!1),setTimeout(function(){P.$root.removeClass(CLASSES.opened+" "+CLASSES.focused),aria(P.$root[0],"hidden",!0)},0),STATE.open?(STATE.open=!1,IS_DEFAULT_THEME&&$html.css("overflow","").css("padding-right","-="+getScrollbarWidth()),$document.off("."+STATE.id),P.trigger("close")):P},clear:function(options){return P.set("clear",null,options)},set:function(thing,value,options){var thingItem,thingValue,thingIsObject=$.isPlainObject(thing),thingObject=thingIsObject?thing:{};if(options=thingIsObject&&$.isPlainObject(value)?value:options||{},thing){thingIsObject||(thingObject[thing]=value);for(thingItem in thingObject)thingValue=thingObject[thingItem],thingItem in P.component.item&&(void 0===thingValue&&(thingValue=null),P.component.set(thingItem,thingValue,options)),"select"!=thingItem&&"clear"!=thingItem||$ELEMENT.val("clear"==thingItem?"":P.get(thingItem,SETTINGS.format)).trigger("change");P.render()}return options.muted?P:P.trigger("set",thingObject)},get:function(thing,format){if(thing=thing||"value",null!=STATE[thing])return STATE[thing];if("valueSubmit"==thing){if(P._hidden)return P._hidden.value;thing="value"}if("value"==thing)return ELEMENT.value;if(thing in P.component.item){if("string"==typeof format){var thingValue=P.component.get(thing);return thingValue?PickerConstructor._.trigger(P.component.formats.toString,P.component,[format,thingValue]):""}return P.component.get(thing)}},on:function(thing,method,internal){var thingName,thingMethod,thingIsObject=$.isPlainObject(thing),thingObject=thingIsObject?thing:{};if(thing){thingIsObject||(thingObject[thing]=method);for(thingName in thingObject)thingMethod=thingObject[thingName],internal&&(thingName="_"+thingName),STATE.methods[thingName]=STATE.methods[thingName]||[],STATE.methods[thingName].push(thingMethod)}return P},off:function(){var i,thingName,names=arguments;for(i=0,namesCount=names.length;i<namesCount;i+=1)(thingName=names[i])in STATE.methods&&delete STATE.methods[thingName];return P},trigger:function(name,data){var _trigger=function(name){var methodList=STATE.methods[name];methodList&&methodList.map(function(method){PickerConstructor._.trigger(method,P,[data])})};return _trigger("_"+name),_trigger(name),P}};return new PickerInstance}function isUsingDefaultTheme(element){var theme;return element.currentStyle?theme=element.currentStyle.position:window.getComputedStyle&&(theme=getComputedStyle(element).position),"fixed"==theme}function getScrollbarWidth(){if($html.height()<=$window.height())return 0;var $outer=$('<div style="visibility:hidden;width:100px" />').appendTo("body"),widthWithoutScroll=$outer[0].offsetWidth;$outer.css("overflow","scroll");var $inner=$('<div style="width:100%" />').appendTo($outer),widthWithScroll=$inner[0].offsetWidth;return $outer.remove(),widthWithoutScroll-widthWithScroll}function aria(element,attribute,value){if($.isPlainObject(attribute))for(var key in attribute)ariaSet(element,key,attribute[key]);else ariaSet(element,attribute,value)}function ariaSet(element,attribute,value){element.setAttribute(("role"==attribute?"":"aria-")+attribute,value)}function ariaAttr(attribute,data){$.isPlainObject(attribute)||(attribute={attribute:data}),data="";for(var key in attribute){var attr=("role"==key?"":"aria-")+key;data+=null==attribute[key]?"":attr+'="'+attribute[key]+'"'}return data}function getActiveElement(){try{return document.activeElement}catch(err){}}var $window=$(window),$document=$(document),$html=$(document.documentElement),supportsTransitions=null!=document.documentElement.style.transition;return PickerConstructor.klasses=function(prefix){return prefix=prefix||"picker",{picker:prefix,opened:prefix+"--opened",focused:prefix+"--focused",input:prefix+"__input",active:prefix+"__input--active",target:prefix+"__input--target",holder:prefix+"__holder",frame:prefix+"__frame",wrap:prefix+"__wrap",box:prefix+"__box"}},PickerConstructor._={group:function(groupObject){for(var loopObjectScope,nodesList="",counter=PickerConstructor._.trigger(groupObject.min,groupObject);counter<=PickerConstructor._.trigger(groupObject.max,groupObject,[counter]);counter+=groupObject.i)loopObjectScope=PickerConstructor._.trigger(groupObject.item,groupObject,[counter]),nodesList+=PickerConstructor._.node(groupObject.node,loopObjectScope[0],loopObjectScope[1],loopObjectScope[2]);return nodesList},node:function(wrapper,item,klass,attribute){return item?(item=$.isArray(item)?item.join(""):item,klass=klass?' class="'+klass+'"':"",attribute=attribute?" "+attribute:"","<"+wrapper+klass+attribute+">"+item+"</"+wrapper+">"):""},lead:function(number){return(number<10?"0":"")+number},trigger:function(callback,scope,args){return"function"==typeof callback?callback.apply(scope,args||[]):callback},digits:function(string){return/\d/.test(string[1])?2:1},isDate:function(value){return{}.toString.call(value).indexOf("Date")>-1&&this.isInteger(value.getDate())},isInteger:function(value){return{}.toString.call(value).indexOf("Number")>-1&&value%1==0},ariaAttr:ariaAttr},PickerConstructor.extend=function(name,Component){$.fn[name]=function(options,action){var componentData=this.data(name);return"picker"==options?componentData:componentData&&"string"==typeof options?PickerConstructor._.trigger(componentData[options],componentData,[action]):this.each(function(){$(this).data(name)||new PickerConstructor(this,name,Component,options)})},$.fn[name].defaults=Component.defaults},PickerConstructor}),function(factory){"function"==typeof define&&define.amd?define(["picker","jquery"],factory):"object"==typeof exports?module.exports=factory(require("./picker.js"),require("jquery")):factory(Picker,jQuery)}(function(Picker,$){function DatePicker(picker,settings){var calendar=this,element=picker.$node[0],elementValue=element.value,elementDataValue=picker.$node.data("value"),valueString=elementDataValue||elementValue,formatString=elementDataValue?settings.formatSubmit:settings.format,isRTL=function(){return element.currentStyle?"rtl"==element.currentStyle.direction:"rtl"==getComputedStyle(picker.$root[0]).direction};calendar.settings=settings,calendar.$node=picker.$node,calendar.queue={min:"measure create",max:"measure create",now:"now create",select:"parse create validate",highlight:"parse navigate create validate",view:"parse create validate viewset",disable:"deactivate",enable:"activate"},calendar.item={},calendar.item.clear=null,calendar.item.disable=(settings.disable||[]).slice(0),calendar.item.enable=-function(collectionDisabled){return!0===collectionDisabled[0]?collectionDisabled.shift():-1}(calendar.item.disable),calendar.set("min",settings.min).set("max",settings.max).set("now"),valueString?calendar.set("select",valueString,{format:formatString,defaultValue:!0}):calendar.set("select",null).set("highlight",calendar.item.now),calendar.key={40:7,38:-7,39:function(){return isRTL()?-1:1},37:function(){return isRTL()?1:-1},go:function(timeChange){var highlightedObject=calendar.item.highlight,targetDate=new Date(highlightedObject.year,highlightedObject.month,highlightedObject.date+timeChange);calendar.set("highlight",targetDate,{interval:timeChange}),this.render()}},picker.on("render",function(){picker.$root.find("."+settings.klass.selectMonth).on("change",function(){var value=this.value;value&&(picker.set("highlight",[picker.get("view").year,value,picker.get("highlight").date]),picker.$root.find("."+settings.klass.selectMonth).trigger("focus"))}),picker.$root.find("."+settings.klass.selectYear).on("change",function(){var value=this.value;value&&(picker.set("highlight",[value,picker.get("view").month,picker.get("highlight").date]),picker.$root.find("."+settings.klass.selectYear).trigger("focus"))})},1).on("open",function(){var includeToday="";calendar.disabled(calendar.get("now"))&&(includeToday=":not(."+settings.klass.buttonToday+")"),picker.$root.find("button"+includeToday+", select").attr("disabled",!1)},1).on("close",function(){picker.$root.find("button, select").attr("disabled",!0)},1)}var _=Picker._;DatePicker.prototype.set=function(type,value,options){var calendar=this,calendarItem=calendar.item;return null===value?("clear"==type&&(type="select"),calendarItem[type]=value,calendar):(calendarItem["enable"==type?"disable":"flip"==type?"enable":type]=calendar.queue[type].split(" ").map(function(method){return value=calendar[method](type,value,options)}).pop(),"select"==type?calendar.set("highlight",calendarItem.select,options):"highlight"==type?calendar.set("view",calendarItem.highlight,options):type.match(/^(flip|min|max|disable|enable)$/)&&(calendarItem.select&&calendar.disabled(calendarItem.select)&&calendar.set("select",calendarItem.select,options),calendarItem.highlight&&calendar.disabled(calendarItem.highlight)&&calendar.set("highlight",calendarItem.highlight,options)),calendar)},DatePicker.prototype.get=function(type){return this.item[type]},DatePicker.prototype.create=function(type,value,options){var isInfiniteValue,calendar=this;return value=void 0===value?type:value,value==-1/0||value==1/0?isInfiniteValue=value:$.isPlainObject(value)&&_.isInteger(value.pick)?value=value.obj:$.isArray(value)?(value=new Date(value[0],value[1],value[2]),value=_.isDate(value)?value:calendar.create().obj):value=_.isInteger(value)||_.isDate(value)?calendar.normalize(new Date(value),options):calendar.now(type,value,options),{year:isInfiniteValue||value.getFullYear(),month:isInfiniteValue||value.getMonth(),date:isInfiniteValue||value.getDate(),day:isInfiniteValue||value.getDay(),obj:isInfiniteValue||value,pick:isInfiniteValue||value.getTime()}},DatePicker.prototype.createRange=function(from,to){var calendar=this,createDate=function(date){return!0===date||$.isArray(date)||_.isDate(date)?calendar.create(date):date};return _.isInteger(from)||(from=createDate(from)),_.isInteger(to)||(to=createDate(to)),_.isInteger(from)&&$.isPlainObject(to)?from=[to.year,to.month,to.date+from]:_.isInteger(to)&&$.isPlainObject(from)&&(to=[from.year,from.month,from.date+to]),{from:createDate(from),to:createDate(to)}},DatePicker.prototype.withinRange=function(range,dateUnit){return range=this.createRange(range.from,range.to),dateUnit.pick>=range.from.pick&&dateUnit.pick<=range.to.pick},DatePicker.prototype.overlapRanges=function(one,two){var calendar=this;return one=calendar.createRange(one.from,one.to),two=calendar.createRange(two.from,two.to),calendar.withinRange(one,two.from)||calendar.withinRange(one,two.to)||calendar.withinRange(two,one.from)||calendar.withinRange(two,one.to)},DatePicker.prototype.now=function(type,value,options){return value=new Date,options&&options.rel&&value.setDate(value.getDate()+options.rel),this.normalize(value,options)},DatePicker.prototype.navigate=function(type,value,options){var targetDateObject,targetYear,targetMonth,targetDate,isTargetArray=$.isArray(value),isTargetObject=$.isPlainObject(value),viewsetObject=this.item.view;if(isTargetArray||isTargetObject){for(isTargetObject?(targetYear=value.year,targetMonth=value.month,targetDate=value.date):(targetYear=+value[0],targetMonth=+value[1],targetDate=+value[2]),options&&options.nav&&viewsetObject&&viewsetObject.month!==targetMonth&&(targetYear=viewsetObject.year,targetMonth=viewsetObject.month),targetDateObject=new Date(targetYear,targetMonth+(options&&options.nav?options.nav:0),1),targetYear=targetDateObject.getFullYear(),targetMonth=targetDateObject.getMonth();new Date(targetYear,targetMonth,targetDate).getMonth()!==targetMonth;)targetDate-=1;value=[targetYear,targetMonth,targetDate]}return value},DatePicker.prototype.normalize=function(value){return value.setHours(0,0,0,0),value},DatePicker.prototype.measure=function(type,value){var calendar=this;return value?"string"==typeof value?value=calendar.parse(type,value):_.isInteger(value)&&(value=calendar.now(type,value,{rel:value})):value="min"==type?-1/0:1/0,value},DatePicker.prototype.viewset=function(type,dateObject){return this.create([dateObject.year,dateObject.month,1])},DatePicker.prototype.validate=function(type,dateObject,options){var hasEnabledBeforeTarget,hasEnabledAfterTarget,reachedMin,reachedMax,calendar=this,originalDateObject=dateObject,interval=options&&options.interval?options.interval:1,isFlippedBase=-1===calendar.item.enable,minLimitObject=calendar.item.min,maxLimitObject=calendar.item.max,hasEnabledWeekdays=isFlippedBase&&calendar.item.disable.filter(function(value){if($.isArray(value)){var dateTime=calendar.create(value).pick;dateTime<dateObject.pick?hasEnabledBeforeTarget=!0:dateTime>dateObject.pick&&(hasEnabledAfterTarget=!0)}return _.isInteger(value)}).length;if((!options||!options.nav&&!options.defaultValue)&&(!isFlippedBase&&calendar.disabled(dateObject)||isFlippedBase&&calendar.disabled(dateObject)&&(hasEnabledWeekdays||hasEnabledBeforeTarget||hasEnabledAfterTarget)||!isFlippedBase&&(dateObject.pick<=minLimitObject.pick||dateObject.pick>=maxLimitObject.pick)))for(isFlippedBase&&!hasEnabledWeekdays&&(!hasEnabledAfterTarget&&interval>0||!hasEnabledBeforeTarget&&interval<0)&&(interval*=-1);calendar.disabled(dateObject)&&(Math.abs(interval)>1&&(dateObject.month<originalDateObject.month||dateObject.month>originalDateObject.month)&&(dateObject=originalDateObject,interval=interval>0?1:-1),dateObject.pick<=minLimitObject.pick?(reachedMin=!0,interval=1,dateObject=calendar.create([minLimitObject.year,minLimitObject.month,minLimitObject.date+(dateObject.pick===minLimitObject.pick?0:-1)])):dateObject.pick>=maxLimitObject.pick&&(reachedMax=!0,interval=-1,dateObject=calendar.create([maxLimitObject.year,maxLimitObject.month,maxLimitObject.date+(dateObject.pick===maxLimitObject.pick?0:1)])),!reachedMin||!reachedMax);)dateObject=calendar.create([dateObject.year,dateObject.month,dateObject.date+interval]);return dateObject},DatePicker.prototype.disabled=function(dateToVerify){var calendar=this,isDisabledMatch=calendar.item.disable.filter(function(dateToDisable){return _.isInteger(dateToDisable)?dateToVerify.day===(calendar.settings.firstDay?dateToDisable:dateToDisable-1)%7:$.isArray(dateToDisable)||_.isDate(dateToDisable)?dateToVerify.pick===calendar.create(dateToDisable).pick:$.isPlainObject(dateToDisable)?calendar.withinRange(dateToDisable,dateToVerify):void 0});return isDisabledMatch=isDisabledMatch.length&&!isDisabledMatch.filter(function(dateToDisable){return $.isArray(dateToDisable)&&"inverted"==dateToDisable[3]||$.isPlainObject(dateToDisable)&&dateToDisable.inverted}).length,-1===calendar.item.enable?!isDisabledMatch:isDisabledMatch||dateToVerify.pick<calendar.item.min.pick||dateToVerify.pick>calendar.item.max.pick},DatePicker.prototype.parse=function(type,value,options){var calendar=this,parsingObject={};return value&&"string"==typeof value?(options&&options.format||(options=options||{},options.format=calendar.settings.format),calendar.formats.toArray(options.format).map(function(label){var formattingLabel=calendar.formats[label],formatLength=formattingLabel?_.trigger(formattingLabel,calendar,[value,parsingObject]):label.replace(/^!/,"").length;formattingLabel&&(parsingObject[label]=value.substr(0,formatLength)),value=value.substr(formatLength)}),[parsingObject.yyyy||parsingObject.yy,+(parsingObject.mm||parsingObject.m)-1,parsingObject.dd||parsingObject.d]):value},DatePicker.prototype.formats=function(){function getWordLengthFromCollection(string,collection,dateObject){var word=string.match(/[^\x00-\x7F]+|\w+/)[0];return dateObject.mm||dateObject.m||(dateObject.m=collection.indexOf(word)+1),word.length}function getFirstWordLength(string){return string.match(/\w+/)[0].length}return{d:function(string,dateObject){return string?_.digits(string):dateObject.date},dd:function(string,dateObject){return string?2:_.lead(dateObject.date)},ddd:function(string,dateObject){return string?getFirstWordLength(string):this.settings.weekdaysShort[dateObject.day]},dddd:function(string,dateObject){return string?getFirstWordLength(string):this.settings.weekdaysFull[dateObject.day]},m:function(string,dateObject){return string?_.digits(string):dateObject.month+1},mm:function(string,dateObject){return string?2:_.lead(dateObject.month+1)},mmm:function(string,dateObject){var collection=this.settings.monthsShort;return string?getWordLengthFromCollection(string,collection,dateObject):collection[dateObject.month]},mmmm:function(string,dateObject){var collection=this.settings.monthsFull;return string?getWordLengthFromCollection(string,collection,dateObject):collection[dateObject.month]},yy:function(string,dateObject){return string?2:(""+dateObject.year).slice(2)},yyyy:function(string,dateObject){return string?4:dateObject.year},toArray:function(formatString){return formatString.split(/(d{1,4}|m{1,4}|y{4}|yy|!.)/g)},toString:function(formatString,itemObject){var calendar=this;return calendar.formats.toArray(formatString).map(function(label){return _.trigger(calendar.formats[label],calendar,[0,itemObject])||label.replace(/^!/,"")}).join("")}}}(),DatePicker.prototype.isDateExact=function(one,two){var calendar=this;return _.isInteger(one)&&_.isInteger(two)||"boolean"==typeof one&&"boolean"==typeof two?one===two:(_.isDate(one)||$.isArray(one))&&(_.isDate(two)||$.isArray(two))?calendar.create(one).pick===calendar.create(two).pick:!(!$.isPlainObject(one)||!$.isPlainObject(two))&&(calendar.isDateExact(one.from,two.from)&&calendar.isDateExact(one.to,two.to))},DatePicker.prototype.isDateOverlap=function(one,two){var calendar=this,firstDay=calendar.settings.firstDay?1:0;return _.isInteger(one)&&(_.isDate(two)||$.isArray(two))?(one=one%7+firstDay)===calendar.create(two).day+1:_.isInteger(two)&&(_.isDate(one)||$.isArray(one))?(two=two%7+firstDay)===calendar.create(one).day+1:!(!$.isPlainObject(one)||!$.isPlainObject(two))&&calendar.overlapRanges(one,two)},DatePicker.prototype.flipEnable=function(val){var itemObject=this.item;itemObject.enable=val||(-1==itemObject.enable?1:-1)},DatePicker.prototype.deactivate=function(type,datesToDisable){var calendar=this,disabledItems=calendar.item.disable.slice(0);return"flip"==datesToDisable?calendar.flipEnable():!1===datesToDisable?(calendar.flipEnable(1),disabledItems=[]):!0===datesToDisable?(calendar.flipEnable(-1),disabledItems=[]):datesToDisable.map(function(unitToDisable){for(var matchFound,index=0;index<disabledItems.length;index+=1)if(calendar.isDateExact(unitToDisable,disabledItems[index])){matchFound=!0;break}matchFound||(_.isInteger(unitToDisable)||_.isDate(unitToDisable)||$.isArray(unitToDisable)||$.isPlainObject(unitToDisable)&&unitToDisable.from&&unitToDisable.to)&&disabledItems.push(unitToDisable)}),disabledItems},DatePicker.prototype.activate=function(type,datesToEnable){var calendar=this,disabledItems=calendar.item.disable,disabledItemsCount=disabledItems.length;return"flip"==datesToEnable?calendar.flipEnable():!0===datesToEnable?(calendar.flipEnable(1),disabledItems=[]):!1===datesToEnable?(calendar.flipEnable(-1),disabledItems=[]):datesToEnable.map(function(unitToEnable){var matchFound,disabledUnit,index,isExactRange;for(index=0;index<disabledItemsCount;index+=1){if(disabledUnit=disabledItems[index],calendar.isDateExact(disabledUnit,unitToEnable)){matchFound=disabledItems[index]=null,isExactRange=!0;break}if(calendar.isDateOverlap(disabledUnit,unitToEnable)){$.isPlainObject(unitToEnable)?(unitToEnable.inverted=!0,matchFound=unitToEnable):$.isArray(unitToEnable)?(matchFound=unitToEnable,matchFound[3]||matchFound.push("inverted")):_.isDate(unitToEnable)&&(matchFound=[unitToEnable.getFullYear(),unitToEnable.getMonth(),unitToEnable.getDate(),"inverted"]);break}}if(matchFound)for(index=0;index<disabledItemsCount;index+=1)if(calendar.isDateExact(disabledItems[index],unitToEnable)){disabledItems[index]=null;break}if(isExactRange)for(index=0;index<disabledItemsCount;index+=1)if(calendar.isDateOverlap(disabledItems[index],unitToEnable)){disabledItems[index]=null;break}matchFound&&disabledItems.push(matchFound)}),disabledItems.filter(function(val){return null!=val})},DatePicker.prototype.nodes=function(isOpen){var calendar=this,settings=calendar.settings,calendarItem=calendar.item,nowObject=calendarItem.now,selectedObject=calendarItem.select,highlightedObject=calendarItem.highlight,viewsetObject=calendarItem.view,disabledCollection=calendarItem.disable,minLimitObject=calendarItem.min,maxLimitObject=calendarItem.max,tableHead=function(collection,fullCollection){return settings.firstDay&&(collection.push(collection.shift()),fullCollection.push(fullCollection.shift())),_.node("thead",_.node("tr",_.group({min:0,max:6,i:1,node:"th",item:function(counter){return[collection[counter],settings.klass.weekdays,'scope=col title="'+fullCollection[counter]+'"']}})))}((settings.showWeekdaysFull?settings.weekdaysFull:settings.weekdaysShort).slice(0),settings.weekdaysFull.slice(0)),createMonthNav=function(next){return _.node("div"," ",settings.klass["nav"+(next?"Next":"Prev")]+(next&&viewsetObject.year>=maxLimitObject.year&&viewsetObject.month>=maxLimitObject.month||!next&&viewsetObject.year<=minLimitObject.year&&viewsetObject.month<=minLimitObject.month?" "+settings.klass.navDisabled:""),"data-nav="+(next||-1)+" "+_.ariaAttr({role:"button",controls:calendar.$node[0].id+"_table"})+' title="'+(next?settings.labelMonthNext:settings.labelMonthPrev)+'"')},createMonthLabel=function(){var monthsCollection=settings.showMonthsShort?settings.monthsShort:settings.monthsFull;return settings.selectMonths?_.node("select",_.group({min:0,max:11,i:1,node:"option",item:function(loopedMonth){return[monthsCollection[loopedMonth],0,"value="+loopedMonth+(viewsetObject.month==loopedMonth?" selected":"")+(viewsetObject.year==minLimitObject.year&&loopedMonth<minLimitObject.month||viewsetObject.year==maxLimitObject.year&&loopedMonth>maxLimitObject.month?" disabled":"")]}}),settings.klass.selectMonth,(isOpen?"":"disabled")+" "+_.ariaAttr({controls:calendar.$node[0].id+"_table"})+' title="'+settings.labelMonthSelect+'"'):_.node("div",monthsCollection[viewsetObject.month],settings.klass.month)},createYearLabel=function(){var focusedYear=viewsetObject.year,numberYears=!0===settings.selectYears?5:~~(settings.selectYears/2);if(numberYears){var minYear=minLimitObject.year,maxYear=maxLimitObject.year,lowestYear=focusedYear-numberYears,highestYear=focusedYear+numberYears;if(minYear>lowestYear&&(highestYear+=minYear-lowestYear,lowestYear=minYear),maxYear<highestYear){var availableYears=lowestYear-minYear,neededYears=highestYear-maxYear;lowestYear-=availableYears>neededYears?neededYears:availableYears,highestYear=maxYear}return _.node("select",_.group({min:lowestYear,max:highestYear,i:1,node:"option",item:function(loopedYear){return[loopedYear,0,"value="+loopedYear+(focusedYear==loopedYear?" selected":"")]}}),settings.klass.selectYear,(isOpen?"":"disabled")+" "+_.ariaAttr({controls:calendar.$node[0].id+"_table"})+' title="'+settings.labelYearSelect+'"')}return _.node("div",focusedYear,settings.klass.year)};return _.node("div",(settings.selectYears?createYearLabel()+createMonthLabel():createMonthLabel()+createYearLabel())+createMonthNav()+createMonthNav(1),settings.klass.header)+_.node("table",tableHead+_.node("tbody",_.group({min:0,max:5,i:1,node:"tr",item:function(rowCounter){var shiftDateBy=settings.firstDay&&0===calendar.create([viewsetObject.year,viewsetObject.month,1]).day?-7:0;return[_.group({min:7*rowCounter-viewsetObject.day+shiftDateBy+1,max:function(){return this.min+7-1},i:1,node:"td",item:function(targetDate){targetDate=calendar.create([viewsetObject.year,viewsetObject.month,targetDate+(settings.firstDay?1:0)]);var isSelected=selectedObject&&selectedObject.pick==targetDate.pick,isHighlighted=highlightedObject&&highlightedObject.pick==targetDate.pick,isDisabled=disabledCollection&&calendar.disabled(targetDate)||targetDate.pick<minLimitObject.pick||targetDate.pick>maxLimitObject.pick,formattedDate=_.trigger(calendar.formats.toString,calendar,[settings.format,targetDate]);return[_.node("div",targetDate.date,function(klasses){return klasses.push(viewsetObject.month==targetDate.month?settings.klass.infocus:settings.klass.outfocus),nowObject.pick==targetDate.pick&&klasses.push(settings.klass.now),isSelected&&klasses.push(settings.klass.selected),isHighlighted&&klasses.push(settings.klass.highlighted),isDisabled&&klasses.push(settings.klass.disabled),klasses.join(" ")}([settings.klass.day]),"data-pick="+targetDate.pick+" "+_.ariaAttr({role:"gridcell",label:formattedDate,selected:!(!isSelected||calendar.$node.val()!==formattedDate)||null,activedescendant:!!isHighlighted||null,disabled:!!isDisabled||null})),"",_.ariaAttr({role:"presentation"})]}})]}})),settings.klass.table,'id="'+calendar.$node[0].id+'_table" '+_.ariaAttr({role:"grid",controls:calendar.$node[0].id,readonly:!0}))+_.node("div",_.node("button",settings.today,settings.klass.buttonToday,"type=button data-pick="+nowObject.pick+(isOpen&&!calendar.disabled(nowObject)?"":" disabled")+" "+_.ariaAttr({controls:calendar.$node[0].id}))+_.node("button",settings.clear,settings.klass.buttonClear,"type=button data-clear=1"+(isOpen?"":" disabled")+" "+_.ariaAttr({controls:calendar.$node[0].id}))+_.node("button",settings.close,settings.klass.buttonClose,"type=button data-close=true "+(isOpen?"":" disabled")+" "+_.ariaAttr({controls:calendar.$node[0].id})),settings.klass.footer)},DatePicker.defaults=function(prefix){return{labelMonthNext:"Next month",labelMonthPrev:"Previous month",labelMonthSelect:"Select a month",labelYearSelect:"Select a year",monthsFull:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],weekdaysFull:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],weekdaysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],today:"Today",clear:"Clear",close:"Close",closeOnSelect:!0,closeOnClear:!0,format:"d mmmm, yyyy",klass:{table:prefix+"table",header:prefix+"header",navPrev:prefix+"nav--prev",navNext:prefix+"nav--next",navDisabled:prefix+"nav--disabled",month:prefix+"month",year:prefix+"year",selectMonth:prefix+"select--month",selectYear:prefix+"select--year",weekdays:prefix+"weekday",day:prefix+"day",disabled:prefix+"day--disabled",selected:prefix+"day--selected",highlighted:prefix+"day--highlighted",now:prefix+"day--today",infocus:prefix+"day--infocus",outfocus:prefix+"day--outfocus",footer:prefix+"footer",buttonClear:prefix+"button--clear",buttonToday:prefix+"button--today",buttonClose:prefix+"button--close"}}}(Picker.klasses().picker+"__"),Picker.extend("pickadate",DatePicker)}),function(window,document,Math){function IScroll(el,options){this.wrapper="string"==typeof el?document.querySelector(el):el,this.scroller=this.wrapper.children[0],this.scrollerStyle=this.scroller.style,this.options={resizeScrollbars:!0,mouseWheelSpeed:20,snapThreshold:.334,disablePointer:!utils.hasPointer,disableTouch:utils.hasPointer||!utils.hasTouch,disableMouse:utils.hasPointer||utils.hasTouch,
startX:0,startY:0,scrollY:!0,directionLockThreshold:5,momentum:!0,bounce:!0,bounceTime:600,bounceEasing:"",preventDefault:!0,preventDefaultException:{tagName:/^(INPUT|TEXTAREA|BUTTON|SELECT)$/},HWCompositing:!0,useTransition:!0,useTransform:!0,bindToWrapper:void 0===window.onmousedown};for(var i in options)this.options[i]=options[i];this.translateZ=this.options.HWCompositing&&utils.hasPerspective?" translateZ(0)":"",this.options.useTransition=utils.hasTransition&&this.options.useTransition,this.options.useTransform=utils.hasTransform&&this.options.useTransform,this.options.eventPassthrough=!0===this.options.eventPassthrough?"vertical":this.options.eventPassthrough,this.options.preventDefault=!this.options.eventPassthrough&&this.options.preventDefault,this.options.scrollY="vertical"!=this.options.eventPassthrough&&this.options.scrollY,this.options.scrollX="horizontal"!=this.options.eventPassthrough&&this.options.scrollX,this.options.freeScroll=this.options.freeScroll&&!this.options.eventPassthrough,this.options.directionLockThreshold=this.options.eventPassthrough?0:this.options.directionLockThreshold,this.options.bounceEasing="string"==typeof this.options.bounceEasing?utils.ease[this.options.bounceEasing]||utils.ease.circular:this.options.bounceEasing,this.options.resizePolling=void 0===this.options.resizePolling?60:this.options.resizePolling,!0===this.options.tap&&(this.options.tap="tap"),this.options.useTransition||this.options.useTransform||/relative|absolute/i.test(this.scrollerStyle.position)||(this.scrollerStyle.position="relative"),"scale"==this.options.shrinkScrollbars&&(this.options.useTransition=!1),this.options.invertWheelDirection=this.options.invertWheelDirection?-1:1,this.x=0,this.y=0,this.directionX=0,this.directionY=0,this._events={},this._init(),this.refresh(),this.scrollTo(this.options.startX,this.options.startY),this.enable()}function createDefaultScrollbar(direction,interactive,type){var scrollbar=document.createElement("div"),indicator=document.createElement("div");return!0===type&&(scrollbar.style.cssText="position:absolute;z-index:9999",indicator.style.cssText="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);border-radius:3px"),indicator.className="iScrollIndicator","h"==direction?(!0===type&&(scrollbar.style.cssText+=";height:7px;left:2px;right:2px;bottom:0",indicator.style.height="100%"),scrollbar.className="iScrollHorizontalScrollbar"):(!0===type&&(scrollbar.style.cssText+=";width:7px;bottom:2px;top:2px;right:1px",indicator.style.width="100%"),scrollbar.className="iScrollVerticalScrollbar"),scrollbar.style.cssText+=";overflow:hidden",interactive||(scrollbar.style.pointerEvents="none"),scrollbar.appendChild(indicator),scrollbar}function Indicator(scroller,options){this.wrapper="string"==typeof options.el?document.querySelector(options.el):options.el,this.wrapperStyle=this.wrapper.style,this.indicator=this.wrapper.children[0],this.indicatorStyle=this.indicator.style,this.scroller=scroller,this.options={listenX:!0,listenY:!0,interactive:!1,resize:!0,defaultScrollbars:!1,shrink:!1,fade:!1,speedRatioX:0,speedRatioY:0};for(var i in options)this.options[i]=options[i];if(this.sizeRatioX=1,this.sizeRatioY=1,this.maxPosX=0,this.maxPosY=0,this.options.interactive&&(this.options.disableTouch||(utils.addEvent(this.indicator,"touchstart",this),utils.addEvent(window,"touchend",this)),this.options.disablePointer||(utils.addEvent(this.indicator,utils.prefixPointerEvent("pointerdown"),this),utils.addEvent(window,utils.prefixPointerEvent("pointerup"),this)),this.options.disableMouse||(utils.addEvent(this.indicator,"mousedown",this),utils.addEvent(window,"mouseup",this))),this.options.fade){this.wrapperStyle[utils.style.transform]=this.scroller.translateZ;var durationProp=utils.style.transitionDuration;if(!durationProp)return;this.wrapperStyle[durationProp]=utils.isBadAndroid?"0.0001ms":"0ms";var self=this;utils.isBadAndroid&&rAF(function(){"0.0001ms"===self.wrapperStyle[durationProp]&&(self.wrapperStyle[durationProp]="0s")}),this.wrapperStyle.opacity="0"}}var rAF=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(callback){window.setTimeout(callback,1e3/60)},utils=function(){function _prefixStyle(style){return!1!==_vendor&&(""===_vendor?style:_vendor+style.charAt(0).toUpperCase()+style.substr(1))}var me={},_elementStyle=document.createElement("div").style,_vendor=function(){for(var vendors=["t","webkitT","MozT","msT","OT"],i=0,l=vendors.length;i<l;i++)if(vendors[i]+"ransform"in _elementStyle)return vendors[i].substr(0,vendors[i].length-1);return!1}();me.getTime=Date.now||function(){return(new Date).getTime()},me.extend=function(target,obj){for(var i in obj)target[i]=obj[i]},me.addEvent=function(el,type,fn,capture){el.addEventListener(type,fn,!!capture)},me.removeEvent=function(el,type,fn,capture){el.removeEventListener(type,fn,!!capture)},me.prefixPointerEvent=function(pointerEvent){return window.MSPointerEvent?"MSPointer"+pointerEvent.charAt(7).toUpperCase()+pointerEvent.substr(8):pointerEvent},me.momentum=function(current,start,time,lowerMargin,wrapperSize,deceleration){var destination,duration,distance=current-start,speed=Math.abs(distance)/time;return deceleration=void 0===deceleration?6e-4:deceleration,destination=current+speed*speed/(2*deceleration)*(distance<0?-1:1),duration=speed/deceleration,destination<lowerMargin?(destination=wrapperSize?lowerMargin-wrapperSize/2.5*(speed/8):lowerMargin,distance=Math.abs(destination-current),duration=distance/speed):destination>0&&(destination=wrapperSize?wrapperSize/2.5*(speed/8):0,distance=Math.abs(current)+destination,duration=distance/speed),{destination:Math.round(destination),duration:duration}};var _transform=_prefixStyle("transform");return me.extend(me,{hasTransform:!1!==_transform,hasPerspective:_prefixStyle("perspective")in _elementStyle,hasTouch:"ontouchstart"in window,hasPointer:!(!window.PointerEvent&&!window.MSPointerEvent),hasTransition:_prefixStyle("transition")in _elementStyle}),me.isBadAndroid=function(){var appVersion=window.navigator.appVersion;if(/Android/.test(appVersion)&&!/Chrome\/\d/.test(appVersion)){var safariVersion=appVersion.match(/Safari\/(\d+.\d)/);return!(safariVersion&&"object"==typeof safariVersion&&safariVersion.length>=2)||parseFloat(safariVersion[1])<535.19}return!1}(),me.extend(me.style={},{transform:_transform,transitionTimingFunction:_prefixStyle("transitionTimingFunction"),transitionDuration:_prefixStyle("transitionDuration"),transitionDelay:_prefixStyle("transitionDelay"),transformOrigin:_prefixStyle("transformOrigin")}),me.hasClass=function(e,c){return new RegExp("(^|\\s)"+c+"(\\s|$)").test(e.className)},me.addClass=function(e,c){if(!me.hasClass(e,c)){var newclass=e.className.split(" ");newclass.push(c),e.className=newclass.join(" ")}},me.removeClass=function(e,c){if(me.hasClass(e,c)){var re=new RegExp("(^|\\s)"+c+"(\\s|$)","g");e.className=e.className.replace(re," ")}},me.offset=function(el){for(var left=-el.offsetLeft,top=-el.offsetTop;el=el.offsetParent;)left-=el.offsetLeft,top-=el.offsetTop;return{left:left,top:top}},me.preventDefaultException=function(el,exceptions){for(var i in exceptions)if(exceptions[i].test(el[i]))return!0;return!1},me.extend(me.eventType={},{touchstart:1,touchmove:1,touchend:1,mousedown:2,mousemove:2,mouseup:2,pointerdown:3,pointermove:3,pointerup:3,MSPointerDown:3,MSPointerMove:3,MSPointerUp:3}),me.extend(me.ease={},{quadratic:{style:"cubic-bezier(0.25, 0.46, 0.45, 0.94)",fn:function(k){return k*(2-k)}},circular:{style:"cubic-bezier(0.1, 0.57, 0.1, 1)",fn:function(k){return Math.sqrt(1- --k*k)}},back:{style:"cubic-bezier(0.175, 0.885, 0.32, 1.275)",fn:function(k){return(k-=1)*k*(5*k+4)+1}},bounce:{style:"",fn:function(k){return(k/=1)<1/2.75?7.5625*k*k:k<2/2.75?7.5625*(k-=1.5/2.75)*k+.75:k<2.5/2.75?7.5625*(k-=2.25/2.75)*k+.9375:7.5625*(k-=2.625/2.75)*k+.984375}},elastic:{style:"",fn:function(k){return 0===k?0:1==k?1:.4*Math.pow(2,-10*k)*Math.sin((k-.055)*(2*Math.PI)/.22)+1}}}),me.tap=function(e,eventName){var ev=document.createEvent("Event");ev.initEvent(eventName,!0,!0),ev.pageX=e.pageX,ev.pageY=e.pageY,e.target.dispatchEvent(ev)},me.click=function(e){var ev,target=e.target;/(SELECT|INPUT|TEXTAREA)/i.test(target.tagName)||(ev=document.createEvent(window.MouseEvent?"MouseEvents":"Event"),ev.initEvent("click",!0,!0),ev.view=e.view||window,ev.detail=1,ev.screenX=target.screenX||0,ev.screenY=target.screenY||0,ev.clientX=target.clientX||0,ev.clientY=target.clientY||0,ev.ctrlKey=!!e.ctrlKey,ev.altKey=!!e.altKey,ev.shiftKey=!!e.shiftKey,ev.metaKey=!!e.metaKey,ev.button=0,ev.relatedTarget=null,ev._constructed=!0,target.dispatchEvent(ev))},me}();IScroll.prototype={version:"5.2.0",_init:function(){this._initEvents(),(this.options.scrollbars||this.options.indicators)&&this._initIndicators(),this.options.mouseWheel&&this._initWheel(),this.options.snap&&this._initSnap(),this.options.keyBindings&&this._initKeys()},destroy:function(){this._initEvents(!0),clearTimeout(this.resizeTimeout),this.resizeTimeout=null,this._execEvent("destroy")},_transitionEnd:function(e){e.target==this.scroller&&this.isInTransition&&(this._transitionTime(),this.resetPosition(this.options.bounceTime)||(this.isInTransition=!1,this._execEvent("scrollEnd")))},_start:function(e){if(1!=utils.eventType[e.type]){if(0!==(e.which?e.button:e.button<2?0:4==e.button?1:2))return}if(this.enabled&&(!this.initiated||utils.eventType[e.type]===this.initiated)){!this.options.preventDefault||utils.isBadAndroid||utils.preventDefaultException(e.target,this.options.preventDefaultException)||e.preventDefault();var pos,point=e.touches?e.touches[0]:e;this.initiated=utils.eventType[e.type],this.moved=!1,this.distX=0,this.distY=0,this.directionX=0,this.directionY=0,this.directionLocked=0,this.startTime=utils.getTime(),this.options.useTransition&&this.isInTransition?(this._transitionTime(),this.isInTransition=!1,pos=this.getComputedPosition(),this._translate(Math.round(pos.x),Math.round(pos.y)),this._execEvent("scrollEnd")):!this.options.useTransition&&this.isAnimating&&(this.isAnimating=!1,this._execEvent("scrollEnd")),this.startX=this.x,this.startY=this.y,this.absStartX=this.x,this.absStartY=this.y,this.pointX=point.pageX,this.pointY=point.pageY,this._execEvent("beforeScrollStart")}},_move:function(e){if(this.enabled&&utils.eventType[e.type]===this.initiated){this.options.preventDefault&&e.preventDefault();var newX,newY,absDistX,absDistY,point=e.touches?e.touches[0]:e,deltaX=point.pageX-this.pointX,deltaY=point.pageY-this.pointY,timestamp=utils.getTime();if(this.pointX=point.pageX,this.pointY=point.pageY,this.distX+=deltaX,this.distY+=deltaY,absDistX=Math.abs(this.distX),absDistY=Math.abs(this.distY),!(timestamp-this.endTime>300&&absDistX<10&&absDistY<10)){if(this.directionLocked||this.options.freeScroll||(absDistX>absDistY+this.options.directionLockThreshold?this.directionLocked="h":absDistY>=absDistX+this.options.directionLockThreshold?this.directionLocked="v":this.directionLocked="n"),"h"==this.directionLocked){if("vertical"==this.options.eventPassthrough)e.preventDefault();else if("horizontal"==this.options.eventPassthrough)return void(this.initiated=!1);deltaY=0}else if("v"==this.directionLocked){if("horizontal"==this.options.eventPassthrough)e.preventDefault();else if("vertical"==this.options.eventPassthrough)return void(this.initiated=!1);deltaX=0}deltaX=this.hasHorizontalScroll?deltaX:0,deltaY=this.hasVerticalScroll?deltaY:0,newX=this.x+deltaX,newY=this.y+deltaY,(newX>0||newX<this.maxScrollX)&&(newX=this.options.bounce?this.x+deltaX/3:newX>0?0:this.maxScrollX),(newY>0||newY<this.maxScrollY)&&(newY=this.options.bounce?this.y+deltaY/3:newY>0?0:this.maxScrollY),this.directionX=deltaX>0?-1:deltaX<0?1:0,this.directionY=deltaY>0?-1:deltaY<0?1:0,this.moved||this._execEvent("scrollStart"),this.moved=!0,this._translate(newX,newY),timestamp-this.startTime>300&&(this.startTime=timestamp,this.startX=this.x,this.startY=this.y)}}},_end:function(e){if(this.enabled&&utils.eventType[e.type]===this.initiated){this.options.preventDefault&&!utils.preventDefaultException(e.target,this.options.preventDefaultException)&&e.preventDefault();var momentumX,momentumY,duration=(e.changedTouches&&e.changedTouches[0],utils.getTime()-this.startTime),newX=Math.round(this.x),newY=Math.round(this.y),distanceX=Math.abs(newX-this.startX),distanceY=Math.abs(newY-this.startY),time=0,easing="";if(this.isInTransition=0,this.initiated=0,this.endTime=utils.getTime(),!this.resetPosition(this.options.bounceTime)){if(this.scrollTo(newX,newY),!this.moved)return this.options.tap&&utils.tap(e,this.options.tap),this.options.click&&utils.click(e),void this._execEvent("scrollCancel");if(this._events.flick&&duration<200&&distanceX<100&&distanceY<100)return void this._execEvent("flick");if(this.options.momentum&&duration<300&&(momentumX=this.hasHorizontalScroll?utils.momentum(this.x,this.startX,duration,this.maxScrollX,this.options.bounce?this.wrapperWidth:0,this.options.deceleration):{destination:newX,duration:0},momentumY=this.hasVerticalScroll?utils.momentum(this.y,this.startY,duration,this.maxScrollY,this.options.bounce?this.wrapperHeight:0,this.options.deceleration):{destination:newY,duration:0},newX=momentumX.destination,newY=momentumY.destination,time=Math.max(momentumX.duration,momentumY.duration),this.isInTransition=1),this.options.snap){var snap=this._nearestSnap(newX,newY);this.currentPage=snap,time=this.options.snapSpeed||Math.max(Math.max(Math.min(Math.abs(newX-snap.x),1e3),Math.min(Math.abs(newY-snap.y),1e3)),300),newX=snap.x,newY=snap.y,this.directionX=0,this.directionY=0,easing=this.options.bounceEasing}if(newX!=this.x||newY!=this.y)return(newX>0||newX<this.maxScrollX||newY>0||newY<this.maxScrollY)&&(easing=utils.ease.quadratic),void this.scrollTo(newX,newY,time,easing);this._execEvent("scrollEnd")}}},_resize:function(){var that=this;clearTimeout(this.resizeTimeout),this.resizeTimeout=setTimeout(function(){that.refresh()},this.options.resizePolling)},resetPosition:function(time){var x=this.x,y=this.y;return time=time||0,!this.hasHorizontalScroll||this.x>0?x=0:this.x<this.maxScrollX&&(x=this.maxScrollX),!this.hasVerticalScroll||this.y>0?y=0:this.y<this.maxScrollY&&(y=this.maxScrollY),(x!=this.x||y!=this.y)&&(this.scrollTo(x,y,time,this.options.bounceEasing),!0)},disable:function(){this.enabled=!1},enable:function(){this.enabled=!0},refresh:function(){this.wrapper.offsetHeight;this.wrapperWidth=this.wrapper.clientWidth,this.wrapperHeight=this.wrapper.clientHeight,this.scrollerWidth=this.scroller.offsetWidth,this.scrollerHeight=this.scroller.offsetHeight,this.maxScrollX=this.wrapperWidth-this.scrollerWidth,this.maxScrollY=this.wrapperHeight-this.scrollerHeight,this.hasHorizontalScroll=this.options.scrollX&&this.maxScrollX<0,this.hasVerticalScroll=this.options.scrollY&&this.maxScrollY<0,this.hasHorizontalScroll||(this.maxScrollX=0,this.scrollerWidth=this.wrapperWidth),this.hasVerticalScroll||(this.maxScrollY=0,this.scrollerHeight=this.wrapperHeight),this.endTime=0,this.directionX=0,this.directionY=0,this.wrapperOffset=utils.offset(this.wrapper),this._execEvent("refresh"),this.resetPosition()},on:function(type,fn){this._events[type]||(this._events[type]=[]),this._events[type].push(fn)},off:function(type,fn){if(this._events[type]){var index=this._events[type].indexOf(fn);index>-1&&this._events[type].splice(index,1)}},_execEvent:function(type){if(this._events[type]){var i=0,l=this._events[type].length;if(l)for(;i<l;i++)this._events[type][i].apply(this,[].slice.call(arguments,1))}},scrollBy:function(x,y,time,easing){x=this.x+x,y=this.y+y,time=time||0,this.scrollTo(x,y,time,easing)},scrollTo:function(x,y,time,easing){easing=easing||utils.ease.circular,this.isInTransition=this.options.useTransition&&time>0;var transitionType=this.options.useTransition&&easing.style;!time||transitionType?(transitionType&&(this._transitionTimingFunction(easing.style),this._transitionTime(time)),this._translate(x,y)):this._animate(x,y,time,easing.fn)},scrollToElement:function(el,time,offsetX,offsetY,easing){if(el=el.nodeType?el:this.scroller.querySelector(el)){var pos=utils.offset(el);pos.left-=this.wrapperOffset.left,pos.top-=this.wrapperOffset.top,!0===offsetX&&(offsetX=Math.round(el.offsetWidth/2-this.wrapper.offsetWidth/2)),!0===offsetY&&(offsetY=Math.round(el.offsetHeight/2-this.wrapper.offsetHeight/2)),pos.left-=offsetX||0,pos.top-=offsetY||0,pos.left=pos.left>0?0:pos.left<this.maxScrollX?this.maxScrollX:pos.left,pos.top=pos.top>0?0:pos.top<this.maxScrollY?this.maxScrollY:pos.top,time=void 0===time||null===time||"auto"===time?Math.max(Math.abs(this.x-pos.left),Math.abs(this.y-pos.top)):time,this.scrollTo(pos.left,pos.top,time,easing)}},_transitionTime:function(time){if(this.options.useTransition){time=time||0;var durationProp=utils.style.transitionDuration;if(durationProp){if(this.scrollerStyle[durationProp]=time+"ms",!time&&utils.isBadAndroid){this.scrollerStyle[durationProp]="0.0001ms";var self=this;rAF(function(){"0.0001ms"===self.scrollerStyle[durationProp]&&(self.scrollerStyle[durationProp]="0s")})}if(this.indicators)for(var i=this.indicators.length;i--;)this.indicators[i].transitionTime(time)}}},_transitionTimingFunction:function(easing){if(this.scrollerStyle[utils.style.transitionTimingFunction]=easing,this.indicators)for(var i=this.indicators.length;i--;)this.indicators[i].transitionTimingFunction(easing)},_translate:function(x,y){if(this.options.useTransform?this.scrollerStyle[utils.style.transform]="translate("+x+"px,"+y+"px)"+this.translateZ:(x=Math.round(x),y=Math.round(y),this.scrollerStyle.left=x+"px",this.scrollerStyle.top=y+"px"),this.x=x,this.y=y,this.indicators)for(var i=this.indicators.length;i--;)this.indicators[i].updatePosition()},_initEvents:function(remove){var eventType=remove?utils.removeEvent:utils.addEvent,target=this.options.bindToWrapper?this.wrapper:window;eventType(window,"orientationchange",this),eventType(window,"resize",this),this.options.click,this.options.disableMouse||(eventType(this.wrapper,"mousedown",this),eventType(target,"mousemove",this),eventType(target,"mousecancel",this),eventType(target,"mouseup",this)),utils.hasPointer&&!this.options.disablePointer&&(eventType(this.wrapper,utils.prefixPointerEvent("pointerdown"),this),eventType(target,utils.prefixPointerEvent("pointermove"),this),eventType(target,utils.prefixPointerEvent("pointercancel"),this),eventType(target,utils.prefixPointerEvent("pointerup"),this)),utils.hasTouch&&!this.options.disableTouch&&(eventType(this.wrapper,"touchstart",this),eventType(target,"touchmove",this),eventType(target,"touchcancel",this),eventType(target,"touchend",this)),eventType(this.scroller,"transitionend",this),eventType(this.scroller,"webkitTransitionEnd",this),eventType(this.scroller,"oTransitionEnd",this),eventType(this.scroller,"MSTransitionEnd",this)},getComputedPosition:function(){var x,y,matrix=window.getComputedStyle(this.scroller,null);return this.options.useTransform?(matrix=matrix[utils.style.transform].split(")")[0].split(", "),x=+(matrix[12]||matrix[4]),y=+(matrix[13]||matrix[5])):(x=+matrix.left.replace(/[^-\d.]/g,""),y=+matrix.top.replace(/[^-\d.]/g,"")),{x:x,y:y}},_initIndicators:function(){function _indicatorsMap(fn){if(that.indicators)for(var i=that.indicators.length;i--;)fn.call(that.indicators[i])}var indicator,interactive=this.options.interactiveScrollbars,customStyle="string"!=typeof this.options.scrollbars,indicators=[],that=this;this.indicators=[],this.options.scrollbars&&(this.options.scrollY&&(indicator={el:createDefaultScrollbar("v",interactive,this.options.scrollbars),interactive:interactive,defaultScrollbars:!0,customStyle:customStyle,resize:this.options.resizeScrollbars,shrink:this.options.shrinkScrollbars,fade:this.options.fadeScrollbars,listenX:!1},this.wrapper.appendChild(indicator.el),indicators.push(indicator)),this.options.scrollX&&(indicator={el:createDefaultScrollbar("h",interactive,this.options.scrollbars),interactive:interactive,defaultScrollbars:!0,customStyle:customStyle,resize:this.options.resizeScrollbars,shrink:this.options.shrinkScrollbars,fade:this.options.fadeScrollbars,listenY:!1},this.wrapper.appendChild(indicator.el),indicators.push(indicator))),this.options.indicators&&(indicators=indicators.concat(this.options.indicators));for(var i=indicators.length;i--;)this.indicators.push(new Indicator(this,indicators[i]));this.options.fadeScrollbars&&(this.on("scrollEnd",function(){_indicatorsMap(function(){this.fade()})}),this.on("scrollCancel",function(){_indicatorsMap(function(){this.fade()})}),this.on("scrollStart",function(){_indicatorsMap(function(){this.fade(1)})}),this.on("beforeScrollStart",function(){_indicatorsMap(function(){this.fade(1,!0)})})),this.on("refresh",function(){_indicatorsMap(function(){this.refresh()})}),this.on("destroy",function(){_indicatorsMap(function(){this.destroy()}),delete this.indicators})},_initWheel:function(){utils.addEvent(this.wrapper,"wheel",this),utils.addEvent(this.wrapper,"mousewheel",this),utils.addEvent(this.wrapper,"DOMMouseScroll",this),this.on("destroy",function(){clearTimeout(this.wheelTimeout),this.wheelTimeout=null,utils.removeEvent(this.wrapper,"wheel",this),utils.removeEvent(this.wrapper,"mousewheel",this),utils.removeEvent(this.wrapper,"DOMMouseScroll",this)})},_wheel:function(e){if(this.enabled){e.preventDefault();var wheelDeltaX,wheelDeltaY,newX,newY,that=this;if(void 0===this.wheelTimeout&&that._execEvent("scrollStart"),clearTimeout(this.wheelTimeout),this.wheelTimeout=setTimeout(function(){that.options.snap||that._execEvent("scrollEnd"),that.wheelTimeout=void 0},400),"deltaX"in e)1===e.deltaMode?(wheelDeltaX=-e.deltaX*this.options.mouseWheelSpeed,wheelDeltaY=-e.deltaY*this.options.mouseWheelSpeed):(wheelDeltaX=-e.deltaX,wheelDeltaY=-e.deltaY);else if("wheelDeltaX"in e)wheelDeltaX=e.wheelDeltaX/120*this.options.mouseWheelSpeed,wheelDeltaY=e.wheelDeltaY/120*this.options.mouseWheelSpeed;else if("wheelDelta"in e)wheelDeltaX=wheelDeltaY=e.wheelDelta/120*this.options.mouseWheelSpeed;else{if(!("detail"in e))return;wheelDeltaX=wheelDeltaY=-e.detail/3*this.options.mouseWheelSpeed}if(wheelDeltaX*=this.options.invertWheelDirection,wheelDeltaY*=this.options.invertWheelDirection,this.hasVerticalScroll||(wheelDeltaX=wheelDeltaY,wheelDeltaY=0),this.options.snap)return newX=this.currentPage.pageX,newY=this.currentPage.pageY,wheelDeltaX>0?newX--:wheelDeltaX<0&&newX++,wheelDeltaY>0?newY--:wheelDeltaY<0&&newY++,void this.goToPage(newX,newY);newX=this.x+Math.round(this.hasHorizontalScroll?wheelDeltaX:0),newY=this.y+Math.round(this.hasVerticalScroll?wheelDeltaY:0),this.directionX=wheelDeltaX>0?-1:wheelDeltaX<0?1:0,this.directionY=wheelDeltaY>0?-1:wheelDeltaY<0?1:0,newX>0?newX=0:newX<this.maxScrollX&&(newX=this.maxScrollX),newY>0?newY=0:newY<this.maxScrollY&&(newY=this.maxScrollY),this.scrollTo(newX,newY,0)}},_initSnap:function(){this.currentPage={},"string"==typeof this.options.snap&&(this.options.snap=this.scroller.querySelectorAll(this.options.snap)),this.on("refresh",function(){var l,n,cx,cy,y,el,i=0,m=0,x=0,stepX=this.options.snapStepX||this.wrapperWidth,stepY=this.options.snapStepY||this.wrapperHeight;if(this.pages=[],this.wrapperWidth&&this.wrapperHeight&&this.scrollerWidth&&this.scrollerHeight){if(!0===this.options.snap)for(cx=Math.round(stepX/2),cy=Math.round(stepY/2);x>-this.scrollerWidth;){for(this.pages[i]=[],l=0,y=0;y>-this.scrollerHeight;)this.pages[i][l]={x:Math.max(x,this.maxScrollX),y:Math.max(y,this.maxScrollY),width:stepX,height:stepY,cx:x-cx,cy:y-cy},y-=stepY,l++;x-=stepX,i++}else for(el=this.options.snap,l=el.length,n=-1;i<l;i++)(0===i||el[i].offsetLeft<=el[i-1].offsetLeft)&&(m=0,n++),this.pages[m]||(this.pages[m]=[]),x=Math.max(-el[i].offsetLeft,this.maxScrollX),y=Math.max(-el[i].offsetTop,this.maxScrollY),cx=x-Math.round(el[i].offsetWidth/2),cy=y-Math.round(el[i].offsetHeight/2),this.pages[m][n]={x:x,y:y,width:el[i].offsetWidth,height:el[i].offsetHeight,cx:cx,cy:cy},x>this.maxScrollX&&m++;this.goToPage(this.currentPage.pageX||0,this.currentPage.pageY||0,0),this.options.snapThreshold%1==0?(this.snapThresholdX=this.options.snapThreshold,this.snapThresholdY=this.options.snapThreshold):(this.snapThresholdX=Math.round(this.pages[this.currentPage.pageX][this.currentPage.pageY].width*this.options.snapThreshold),this.snapThresholdY=Math.round(this.pages[this.currentPage.pageX][this.currentPage.pageY].height*this.options.snapThreshold))}}),this.on("flick",function(){var time=this.options.snapSpeed||Math.max(Math.max(Math.min(Math.abs(this.x-this.startX),1e3),Math.min(Math.abs(this.y-this.startY),1e3)),300);this.goToPage(this.currentPage.pageX+this.directionX,this.currentPage.pageY+this.directionY,time)})},_nearestSnap:function(x,y){if(!this.pages.length)return{x:0,y:0,pageX:0,pageY:0};var i=0,l=this.pages.length,m=0;if(Math.abs(x-this.absStartX)<this.snapThresholdX&&Math.abs(y-this.absStartY)<this.snapThresholdY)return this.currentPage;for(x>0?x=0:x<this.maxScrollX&&(x=this.maxScrollX),y>0?y=0:y<this.maxScrollY&&(y=this.maxScrollY);i<l;i++)if(x>=this.pages[i][0].cx){x=this.pages[i][0].x;break}for(l=this.pages[i].length;m<l;m++)if(y>=this.pages[0][m].cy){y=this.pages[0][m].y;break}return i==this.currentPage.pageX&&(i+=this.directionX,i<0?i=0:i>=this.pages.length&&(i=this.pages.length-1),x=this.pages[i][0].x),m==this.currentPage.pageY&&(m+=this.directionY,m<0?m=0:m>=this.pages[0].length&&(m=this.pages[0].length-1),y=this.pages[0][m].y),{x:x,y:y,pageX:i,pageY:m}},goToPage:function(x,y,time,easing){easing=easing||this.options.bounceEasing,x>=this.pages.length?x=this.pages.length-1:x<0&&(x=0),y>=this.pages[x].length?y=this.pages[x].length-1:y<0&&(y=0);var posX=this.pages[x][y].x,posY=this.pages[x][y].y;time=void 0===time?this.options.snapSpeed||Math.max(Math.max(Math.min(Math.abs(posX-this.x),1e3),Math.min(Math.abs(posY-this.y),1e3)),300):time,this.currentPage={x:posX,y:posY,pageX:x,pageY:y},this.scrollTo(posX,posY,time,easing)},next:function(time,easing){var x=this.currentPage.pageX,y=this.currentPage.pageY;x++,x>=this.pages.length&&this.hasVerticalScroll&&(x=0,y++),this.goToPage(x,y,time,easing)},prev:function(time,easing){var x=this.currentPage.pageX,y=this.currentPage.pageY;x--,x<0&&this.hasVerticalScroll&&(x=0,y--),this.goToPage(x,y,time,easing)},_initKeys:function(e){var i,keys={pageUp:33,pageDown:34,end:35,home:36,left:37,up:38,right:39,down:40};if("object"==typeof this.options.keyBindings)for(i in this.options.keyBindings)"string"==typeof this.options.keyBindings[i]&&(this.options.keyBindings[i]=this.options.keyBindings[i].toUpperCase().charCodeAt(0));else this.options.keyBindings={};for(i in keys)this.options.keyBindings[i]=this.options.keyBindings[i]||keys[i];utils.addEvent(window,"keydown",this),this.on("destroy",function(){utils.removeEvent(window,"keydown",this)})},_key:function(e){if(this.enabled){var pos,snap=this.options.snap,newX=snap?this.currentPage.pageX:this.x,newY=snap?this.currentPage.pageY:this.y,now=utils.getTime(),prevTime=this.keyTime||0;switch(this.options.useTransition&&this.isInTransition&&(pos=this.getComputedPosition(),this._translate(Math.round(pos.x),Math.round(pos.y)),this.isInTransition=!1),this.keyAcceleration=now-prevTime<200?Math.min(this.keyAcceleration+.25,50):0,e.keyCode){case this.options.keyBindings.pageUp:this.hasHorizontalScroll&&!this.hasVerticalScroll?newX+=snap?1:this.wrapperWidth:newY+=snap?1:this.wrapperHeight;break;case this.options.keyBindings.pageDown:this.hasHorizontalScroll&&!this.hasVerticalScroll?newX-=snap?1:this.wrapperWidth:newY-=snap?1:this.wrapperHeight;break;case this.options.keyBindings.end:newX=snap?this.pages.length-1:this.maxScrollX,newY=snap?this.pages[0].length-1:this.maxScrollY;break;case this.options.keyBindings.home:newX=0,newY=0;break;case this.options.keyBindings.left:newX+=snap?-1:5+this.keyAcceleration>>0;break;case this.options.keyBindings.up:newY+=snap?1:5+this.keyAcceleration>>0;break;case this.options.keyBindings.right:newX-=snap?-1:5+this.keyAcceleration>>0;break;case this.options.keyBindings.down:newY-=snap?1:5+this.keyAcceleration>>0;break;default:return}if(snap)return void this.goToPage(newX,newY);newX>0?(newX=0,this.keyAcceleration=0):newX<this.maxScrollX&&(newX=this.maxScrollX,this.keyAcceleration=0),newY>0?(newY=0,this.keyAcceleration=0):newY<this.maxScrollY&&(newY=this.maxScrollY,this.keyAcceleration=0),this.scrollTo(newX,newY,0),this.keyTime=now}},_animate:function(destX,destY,duration,easingFn){function step(){var newX,newY,easing,now=utils.getTime();if(now>=destTime)return that.isAnimating=!1,that._translate(destX,destY),void(that.resetPosition(that.options.bounceTime)||that._execEvent("scrollEnd"));now=(now-startTime)/duration,easing=easingFn(now),newX=(destX-startX)*easing+startX,newY=(destY-startY)*easing+startY,that._translate(newX,newY),that.isAnimating&&rAF(step)}var that=this,startX=this.x,startY=this.y,startTime=utils.getTime(),destTime=startTime+duration;this.isAnimating=!0,step()},handleEvent:function(e){switch(e.type){case"touchstart":case"pointerdown":case"MSPointerDown":case"mousedown":this._start(e);break;case"touchmove":case"pointermove":case"MSPointerMove":case"mousemove":this._move(e);break;case"touchend":case"pointerup":case"MSPointerUp":case"mouseup":case"touchcancel":case"pointercancel":case"MSPointerCancel":case"mousecancel":this._end(e);break;case"orientationchange":case"resize":this._resize();break;case"transitionend":case"webkitTransitionEnd":case"oTransitionEnd":case"MSTransitionEnd":this._transitionEnd(e);break;case"wheel":case"DOMMouseScroll":case"mousewheel":this._wheel(e);break;case"keydown":this._key(e);break;case"click":this.enabled&&!e._constructed&&(e.preventDefault(),e.stopPropagation())}}},Indicator.prototype={handleEvent:function(e){switch(e.type){case"touchstart":case"pointerdown":case"MSPointerDown":case"mousedown":this._start(e);break;case"touchmove":case"pointermove":case"MSPointerMove":case"mousemove":this._move(e);break;case"touchend":case"pointerup":case"MSPointerUp":case"mouseup":case"touchcancel":case"pointercancel":case"MSPointerCancel":case"mousecancel":this._end(e)}},destroy:function(){this.options.fadeScrollbars&&(clearTimeout(this.fadeTimeout),this.fadeTimeout=null),this.options.interactive&&(utils.removeEvent(this.indicator,"touchstart",this),utils.removeEvent(this.indicator,utils.prefixPointerEvent("pointerdown"),this),utils.removeEvent(this.indicator,"mousedown",this),utils.removeEvent(window,"touchmove",this),utils.removeEvent(window,utils.prefixPointerEvent("pointermove"),this),utils.removeEvent(window,"mousemove",this),utils.removeEvent(window,"touchend",this),utils.removeEvent(window,utils.prefixPointerEvent("pointerup"),this),utils.removeEvent(window,"mouseup",this)),this.options.defaultScrollbars&&this.wrapper.parentNode.removeChild(this.wrapper)},_start:function(e){var point=e.touches?e.touches[0]:e;e.preventDefault(),e.stopPropagation(),this.transitionTime(),this.initiated=!0,this.moved=!1,this.lastPointX=point.pageX,this.lastPointY=point.pageY,this.startTime=utils.getTime(),this.options.disableTouch||utils.addEvent(window,"touchmove",this),this.options.disablePointer||utils.addEvent(window,utils.prefixPointerEvent("pointermove"),this),this.options.disableMouse||utils.addEvent(window,"mousemove",this),this.scroller._execEvent("beforeScrollStart")},_move:function(e){var deltaX,deltaY,newX,newY,point=e.touches?e.touches[0]:e;utils.getTime();this.moved||this.scroller._execEvent("scrollStart"),this.moved=!0,deltaX=point.pageX-this.lastPointX,this.lastPointX=point.pageX,deltaY=point.pageY-this.lastPointY,this.lastPointY=point.pageY,newX=this.x+deltaX,newY=this.y+deltaY,this._pos(newX,newY),e.preventDefault(),e.stopPropagation()},_end:function(e){if(this.initiated){if(this.initiated=!1,e.preventDefault(),e.stopPropagation(),
utils.removeEvent(window,"touchmove",this),utils.removeEvent(window,utils.prefixPointerEvent("pointermove"),this),utils.removeEvent(window,"mousemove",this),this.scroller.options.snap){var snap=this.scroller._nearestSnap(this.scroller.x,this.scroller.y),time=this.options.snapSpeed||Math.max(Math.max(Math.min(Math.abs(this.scroller.x-snap.x),1e3),Math.min(Math.abs(this.scroller.y-snap.y),1e3)),300);this.scroller.x==snap.x&&this.scroller.y==snap.y||(this.scroller.directionX=0,this.scroller.directionY=0,this.scroller.currentPage=snap,this.scroller.scrollTo(snap.x,snap.y,time,this.scroller.options.bounceEasing))}this.moved&&this.scroller._execEvent("scrollEnd")}},transitionTime:function(time){time=time||0;var durationProp=utils.style.transitionDuration;if(durationProp&&(this.indicatorStyle[durationProp]=time+"ms",!time&&utils.isBadAndroid)){this.indicatorStyle[durationProp]="0.0001ms";var self=this;rAF(function(){"0.0001ms"===self.indicatorStyle[durationProp]&&(self.indicatorStyle[durationProp]="0s")})}},transitionTimingFunction:function(easing){this.indicatorStyle[utils.style.transitionTimingFunction]=easing},refresh:function(){this.transitionTime(),this.options.listenX&&!this.options.listenY?this.indicatorStyle.display=this.scroller.hasHorizontalScroll?"block":"none":this.options.listenY&&!this.options.listenX?this.indicatorStyle.display=this.scroller.hasVerticalScroll?"block":"none":this.indicatorStyle.display=this.scroller.hasHorizontalScroll||this.scroller.hasVerticalScroll?"block":"none",this.scroller.hasHorizontalScroll&&this.scroller.hasVerticalScroll?(utils.addClass(this.wrapper,"iScrollBothScrollbars"),utils.removeClass(this.wrapper,"iScrollLoneScrollbar"),this.options.defaultScrollbars&&this.options.customStyle&&(this.options.listenX?this.wrapper.style.right="8px":this.wrapper.style.bottom="8px")):(utils.removeClass(this.wrapper,"iScrollBothScrollbars"),utils.addClass(this.wrapper,"iScrollLoneScrollbar"),this.options.defaultScrollbars&&this.options.customStyle&&(this.options.listenX?this.wrapper.style.right="2px":this.wrapper.style.bottom="2px"));this.wrapper.offsetHeight;this.options.listenX&&(this.wrapperWidth=this.wrapper.clientWidth,this.options.resize?(this.indicatorWidth=Math.max(Math.round(this.wrapperWidth*this.wrapperWidth/(this.scroller.scrollerWidth||this.wrapperWidth||1)),8),this.indicatorStyle.width=this.indicatorWidth+"px"):this.indicatorWidth=this.indicator.clientWidth,this.maxPosX=this.wrapperWidth-this.indicatorWidth,"clip"==this.options.shrink?(this.minBoundaryX=8-this.indicatorWidth,this.maxBoundaryX=this.wrapperWidth-8):(this.minBoundaryX=0,this.maxBoundaryX=this.maxPosX),this.sizeRatioX=this.options.speedRatioX||this.scroller.maxScrollX&&this.maxPosX/this.scroller.maxScrollX),this.options.listenY&&(this.wrapperHeight=this.wrapper.clientHeight,this.options.resize?(this.indicatorHeight=Math.max(Math.round(this.wrapperHeight*this.wrapperHeight/(this.scroller.scrollerHeight||this.wrapperHeight||1)),8),this.indicatorStyle.height=this.indicatorHeight+"px"):this.indicatorHeight=this.indicator.clientHeight,this.maxPosY=this.wrapperHeight-this.indicatorHeight,"clip"==this.options.shrink?(this.minBoundaryY=8-this.indicatorHeight,this.maxBoundaryY=this.wrapperHeight-8):(this.minBoundaryY=0,this.maxBoundaryY=this.maxPosY),this.maxPosY=this.wrapperHeight-this.indicatorHeight,this.sizeRatioY=this.options.speedRatioY||this.scroller.maxScrollY&&this.maxPosY/this.scroller.maxScrollY),this.updatePosition()},updatePosition:function(){var x=this.options.listenX&&Math.round(this.sizeRatioX*this.scroller.x)||0,y=this.options.listenY&&Math.round(this.sizeRatioY*this.scroller.y)||0;this.options.ignoreBoundaries||(x<this.minBoundaryX?("scale"==this.options.shrink&&(this.width=Math.max(this.indicatorWidth+x,8),this.indicatorStyle.width=this.width+"px"),x=this.minBoundaryX):x>this.maxBoundaryX?"scale"==this.options.shrink?(this.width=Math.max(this.indicatorWidth-(x-this.maxPosX),8),this.indicatorStyle.width=this.width+"px",x=this.maxPosX+this.indicatorWidth-this.width):x=this.maxBoundaryX:"scale"==this.options.shrink&&this.width!=this.indicatorWidth&&(this.width=this.indicatorWidth,this.indicatorStyle.width=this.width+"px"),y<this.minBoundaryY?("scale"==this.options.shrink&&(this.height=Math.max(this.indicatorHeight+3*y,8),this.indicatorStyle.height=this.height+"px"),y=this.minBoundaryY):y>this.maxBoundaryY?"scale"==this.options.shrink?(this.height=Math.max(this.indicatorHeight-3*(y-this.maxPosY),8),this.indicatorStyle.height=this.height+"px",y=this.maxPosY+this.indicatorHeight-this.height):y=this.maxBoundaryY:"scale"==this.options.shrink&&this.height!=this.indicatorHeight&&(this.height=this.indicatorHeight,this.indicatorStyle.height=this.height+"px")),this.x=x,this.y=y,this.scroller.options.useTransform?this.indicatorStyle[utils.style.transform]="translate("+x+"px,"+y+"px)"+this.scroller.translateZ:(this.indicatorStyle.left=x+"px",this.indicatorStyle.top=y+"px")},_pos:function(x,y){x<0?x=0:x>this.maxPosX&&(x=this.maxPosX),y<0?y=0:y>this.maxPosY&&(y=this.maxPosY),x=this.options.listenX?Math.round(x/this.sizeRatioX):this.scroller.x,y=this.options.listenY?Math.round(y/this.sizeRatioY):this.scroller.y,this.scroller.scrollTo(x,y)},fade:function(val,hold){if(!hold||this.visible){clearTimeout(this.fadeTimeout),this.fadeTimeout=null;var time=val?250:500,delay=val?0:300;val=val?"1":"0",this.wrapperStyle[utils.style.transitionDuration]=time+"ms",this.fadeTimeout=setTimeout(function(val){this.wrapperStyle.opacity=val,this.visible=+val}.bind(this,val),delay)}}},IScroll.utils=utils,void 0!==module&&module.exports?module.exports=IScroll:"function"==typeof define&&define.amd?define(function(){return IScroll}):window.IScroll=IScroll}(window,document,Math),function(a,b){"function"==typeof define&&define.amd?define(["jquery"],function(c){return b(a,c)}):"object"==typeof module&&"object"==typeof module.exports?module.exports=b(a,require("jquery")):a.lity=b(a,a.jQuery||a.Zepto)}("undefined"!=typeof window?window:this,function(a,b){"use strict";function c(){o[p>0?"addClass":"removeClass"]("lity-active")}function d(a){var c=b.Deferred();return w?(a.one(w,c.resolve),setTimeout(c.resolve,500)):c.resolve(),c.promise()}function e(a,c,d){if(1===arguments.length)return b.extend({},a);if("string"==typeof c){if(void 0===d)return void 0===a[c]?null:a[c];a[c]=d}else b.extend(a,c);return this}function f(a){for(var b,c=decodeURI(a).split("&"),d={},e=0,f=c.length;f>e;e++)c[e]&&(b=c[e].split("="),d[b[0]]=b[1]);return d}function g(a,c){return a+(a.indexOf("?")>-1?"&":"?")+b.param(c)}function h(a){return b('<span class="lity-error"/>').append(a)}function i(a){if(!q.test(a))return!1;var c=b('<img src="'+a+'">'),d=b.Deferred(),e=function(){d.reject(h("Failed loading image"))};return c.on("load",function(){return 0===this.naturalWidth?e():void d.resolve(c)}).on("error",e),d.promise()}function j(a){var c;try{c=b(a)}catch(d){return!1}if(!c.length)return!1;var e=b('<span style="display:none !important" class="lity-inline-placeholder"/>');return c.after(e).on("lity:ready",function(a,b){b.one("lity:remove",function(){e.before(c.addClass("lity-hide")).remove()})})}function k(a){var c,d=a;return c=r.exec(a),c&&(d=g("https://www.youtube"+(c[2]||"")+".com/embed/"+c[4],b.extend({autoplay:1},f(c[5]||"")))),c=s.exec(a),c&&(d=g("https://player.vimeo.com/video/"+c[3],b.extend({autoplay:1},f(c[4]||"")))),c=t.exec(a),c&&(d=g("https://www.google."+c[3]+"/maps?"+c[6],{output:c[6].indexOf("layer=c")>0?"svembed":"embed"})),'<div class="lity-iframe-container"><iframe frameborder="0" allowfullscreen src="'+d+'"></iframe></div>'}function l(a){function f(a){27===a.keyCode&&k()}function g(){var a=m.documentElement.clientHeight?m.documentElement.clientHeight:Math.round(n.height());q.css("max-height",Math.floor(a)+"px").trigger("lity:resize",[o])}function h(a,c){o&&(q=b(c),n.on("resize",g),g(),o.find(".lity-loader").each(function(){var a=b(this);d(a).always(function(){a.remove()})}),o.removeClass("lity-loading").find(".lity-content").empty().append(q),q.removeClass("lity-hide").trigger("lity:ready",[o,a]),t.resolve())}function i(a,d,e,g){t=b.Deferred(),p++,c(),o=b(e.template).addClass("lity-loading").appendTo("body"),e.esc&&n.on("keyup",f),setTimeout(function(){o.addClass("lity-opened lity-"+a).on("click","[data-lity-close]",function(a){b(a.target).is("[data-lity-close]")&&k()}).trigger("lity:open",[o,g]),b.when(d).always(b.proxy(h,null,g))},0)}function j(a,c,d){var e,f,g=b.extend({},u,s);if(c=b.extend({},v,r,c),c.handler&&g[c.handler])f=g[c.handler](a,l),e=c.handler;else{var h={};b.each(["inline","iframe"],function(a,b){g[b]&&(h[b]=g[b]),delete g[b]});var j=function(b,c){return!c||(f=c(a,l),f?(e=b,!1):void 0)};b.each(g,j),e||b.each(h,j)}return f&&b.when(k()).done(b.proxy(i,null,e,f,c,d)),!!f}function k(){if(o){var a=b.Deferred();return t.done(function(){p--,c(),n.off("resize",g).off("keyup",f),q.trigger("lity:close",[o]),o.removeClass("lity-opened").addClass("lity-closed");var b=o,e=q;o=null,q=null,d(e.add(b)).always(function(){e.trigger("lity:remove",[b]),b.remove(),a.resolve()})}),a.promise()}}function l(a){if(!a.preventDefault)return l.open(a);var c=b(this),d=c.data("lity-target")||c.attr("href")||c.attr("src");if(d){j(d,c.data("lity-options")||c.data("lity"),c)&&(c.blur(),a.preventDefault())}}var o,q,r={},s={},t=b.Deferred().resolve();return l.handlers=b.proxy(e,l,s),l.options=b.proxy(e,l,r),l.open=function(a,b,c){return j(a,b,c),l},l.close=function(){return k(),l},l.options(a)}var m=a.document,n=b(a),o=b("html"),p=0,q=/(^data:image\/)|(\.(png|jpe?g|gif|svg|webp|bmp|ico|tiff?)(\?\S*)?$)/i,r=/(youtube(-nocookie)?\.com|youtu\.be)\/(watch\?v=|v\/|u\/|embed\/?)?([\w-]{11})(.*)?/i,s=/(vimeo(pro)?.com)\/(?:[^\d]+)?(\d+)\??(.*)?$/,t=/((maps|www)\.)?google\.([^\/\?]+)\/?((maps\/?)?\?)(.*)/i,u={image:i,inline:j,iframe:k},v={esc:!0,handler:null,template:'<div class="lity" tabindex="-1"><div class="lity-wrap" data-lity-close><div class="lity-loader">Loading...</div><div class="lity-container"><div class="lity-content"></div><button class="lity-close" type="button" title="Close (Esc)" data-lity-close>×</button></div></div></div>'},w=function(){var a=m.createElement("div"),b={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var c in b)if(void 0!==a.style[c])return b[c];return!1}();return l.version="1.6.6",l.handlers=b.proxy(e,l,u),l.options=b.proxy(e,l,v),b(m).on("click","[data-lity]",l()),l}),!function(t,e){function n(t,e,n){var r=t.children(),o=!1;t.empty();for(var i=0,d=r.length;d>i;i++){var l=r.eq(i);if(t.append(l),n&&t.append(n),a(t,e)){l.remove(),o=!0;break}n&&n.detach()}return o}function r(e,n,i,d,l){var s=!1;return e.contents().detach().each(function(){var h=this,f=t(h);if(void 0===h)return!0;if(f.is("script, .dotdotdot-keep"))e.append(f);else{if(s)return!0;e.append(f),!l||f.is(d.after)||f.find(d.after).length||e[e.is("a, table, thead, tbody, tfoot, tr, col, colgroup, object, embed, param, ol, ul, dl, blockquote, select, optgroup, option, textarea, script, style")?"after":"append"](l),a(i,d)&&(s=3==h.nodeType?o(f,n,i,d,l):r(f,n,i,d,l)),s||l&&l.detach()}}),n.addClass("is-truncated"),s}function o(e,n,r,o,d){var c=e[0];if(!c)return!1;var h=s(c),f=-1!==h.indexOf(" ")?" ":"　",p="letter"==o.wrap?"":f,g=h.split(p),v=-1,w=-1,b=0,m=g.length-1;for(o.fallbackToLetter&&0==b&&0==m&&(p="",g=h.split(p),m=g.length-1);m>=b&&(0!=b||0!=m);){var y=Math.floor((b+m)/2);if(y==w)break;w=y,l(c,g.slice(0,w+1).join(p)+o.ellipsis),r.children().each(function(){t(this).toggle().toggle()}),a(r,o)?(m=w,o.fallbackToLetter&&0==b&&0==m&&(p="",g=g[0].split(p),v=-1,w=-1,b=0,m=g.length-1)):(v=w,b=w)}if(-1==v||1==g.length&&0==g[0].length){var x=e.parent();e.detach();var C=d&&d.closest(x).length?d.length:0;if(x.contents().length>C?c=u(x.contents().eq(-1-C),n):(c=u(x,n,!0),C||x.detach()),c&&(h=i(s(c),o),l(c,h),C&&d)){var T=d.parent();t(c).parent().append(d),t.trim(T.html())||T.remove()}}else h=i(g.slice(0,v+1).join(p),o),l(c,h);return!0}function a(t,e){return t.innerHeight()>e.maxHeight}function i(e,n){for(;t.inArray(e.slice(-1),n.lastCharacter.remove)>-1;)e=e.slice(0,-1);return t.inArray(e.slice(-1),n.lastCharacter.noEllipsis)<0&&(e+=n.ellipsis),e}function d(t){return{width:t.innerWidth(),height:t.innerHeight()}}function l(t,e){t.innerText?t.innerText=e:t.nodeValue?t.nodeValue=e:t.textContent&&(t.textContent=e)}function s(t){return t.innerText?t.innerText:t.nodeValue?t.nodeValue:t.textContent?t.textContent:""}function c(t){do{t=t.previousSibling}while(t&&1!==t.nodeType&&3!==t.nodeType);return t}function u(e,n,r){var o,a=e&&e[0];if(a){if(!r){if(3===a.nodeType)return a;if(t.trim(e.text()))return u(e.contents().last(),n)}for(o=c(a);!o;){if(e=e.parent(),e.is(n)||!e.length)return!1;o=c(e[0])}if(o)return u(t(o),n)}return!1}function h(e,n){return!!e&&("string"==typeof e?(e=t(e,n),!!e.length&&e):!!e.jquery&&e)}function f(t){for(var e=t.innerHeight(),n=["paddingTop","paddingBottom"],r=0,o=n.length;o>r;r++){var a=parseInt(t.css(n[r]),10);isNaN(a)&&(a=0),e-=a}return e}if(!t.fn.dotdotdot){t.fn.dotdotdot=function(e){if(0==this.length)return t.fn.dotdotdot.debug('No element found for "'+this.selector+'".'),this;if(this.length>1)return this.each(function(){t(this).dotdotdot(e)});var o=this,i=o.contents();o.data("dotdotdot")&&o.trigger("destroy.dot"),o.data("dotdotdot-style",o.attr("style")||""),o.css("word-wrap","break-word"),"nowrap"===o.css("white-space")&&o.css("white-space","normal"),o.bind_events=function(){return o.bind("update.dot",function(e,d){switch(o.removeClass("is-truncated"),e.preventDefault(),e.stopPropagation(),typeof l.height){case"number":l.maxHeight=l.height;break;case"function":l.maxHeight=l.height.call(o[0]);break;default:l.maxHeight=f(o)}l.maxHeight+=l.tolerance,void 0!==d&&(("string"==typeof d||"nodeType"in d&&1===d.nodeType)&&(d=t("<div />").append(d).contents()),d instanceof t&&(i=d)),g=o.wrapInner('<div class="dotdotdot" />').children(),g.contents().detach().end().append(i.clone(!0)).find("br").replaceWith("  <br />  ").end().css({height:"auto",width:"auto",border:"none",padding:0,margin:0});var c=!1,u=!1;return s.afterElement&&(c=s.afterElement.clone(!0),c.show(),s.afterElement.detach()),a(g,l)&&(u="children"==l.wrap?n(g,l,c):r(g,o,g,l,c)),g.replaceWith(g.contents()),g=null,t.isFunction(l.callback)&&l.callback.call(o[0],u,i),s.isTruncated=u,u}).bind("isTruncated.dot",function(t,e){return t.preventDefault(),t.stopPropagation(),"function"==typeof e&&e.call(o[0],s.isTruncated),s.isTruncated}).bind("originalContent.dot",function(t,e){return t.preventDefault(),t.stopPropagation(),"function"==typeof e&&e.call(o[0],i),i}).bind("destroy.dot",function(t){t.preventDefault(),t.stopPropagation(),o.unwatch().unbind_events().contents().detach().end().append(i).attr("style",o.data("dotdotdot-style")||"").removeClass("is-truncated").data("dotdotdot",!1)}),o},o.unbind_events=function(){return o.unbind(".dot"),o},o.watch=function(){if(o.unwatch(),"window"==l.watch){var e=t(window),n=e.width(),r=e.height();e.bind("resize.dot"+s.dotId,function(){n==e.width()&&r==e.height()&&l.windowResizeFix||(n=e.width(),r=e.height(),u&&clearInterval(u),u=setTimeout(function(){o.trigger("update.dot")},100))})}else c=d(o),u=setInterval(function(){if(o.is(":visible")){var t=d(o);c.width==t.width&&c.height==t.height||(o.trigger("update.dot"),c=t)}},500);return o},o.unwatch=function(){return t(window).unbind("resize.dot"+s.dotId),u&&clearInterval(u),o};var l=t.extend(!0,{},t.fn.dotdotdot.defaults,e),s={},c={},u=null,g=null;return l.lastCharacter.remove instanceof Array||(l.lastCharacter.remove=t.fn.dotdotdot.defaultArrays.lastCharacter.remove),l.lastCharacter.noEllipsis instanceof Array||(l.lastCharacter.noEllipsis=t.fn.dotdotdot.defaultArrays.lastCharacter.noEllipsis),s.afterElement=h(l.after,o),s.isTruncated=!1,s.dotId=p++,o.data("dotdotdot",!0).bind_events().trigger("update.dot"),l.watch&&o.watch(),o},t.fn.dotdotdot.defaults={ellipsis:"... ",wrap:"word",fallbackToLetter:!0,lastCharacter:{},tolerance:0,callback:null,after:null,height:null,watch:!1,windowResizeFix:!0},t.fn.dotdotdot.defaultArrays={lastCharacter:{remove:[" ","　",",",";",".","!","?"],noEllipsis:[]}},t.fn.dotdotdot.debug=function(t){};var p=1,g=t.fn.html;t.fn.html=function(n){return n!=e&&!t.isFunction(n)&&this.data("dotdotdot")?this.trigger("update",[n]):g.apply(this,arguments)};var v=t.fn.text;t.fn.text=function(n){return n!=e&&!t.isFunction(n)&&this.data("dotdotdot")?(n=t("<div />").text(n).html(),this.trigger("update",[n])):v.apply(this,arguments)}}}(jQuery),jQuery(document).ready(function(t){t(".dot-ellipsis").each(function(){var e=t(this).hasClass("dot-resize-update"),n=t(this).hasClass("dot-timer-update"),r=0,o=t(this).attr("class").split(/\s+/);t.each(o,function(t,e){var n=e.match(/^dot-height-(\d+)$/);null!==n&&(r=Number(n[1]))});var a=new Object;n&&(a.watch=!0),e&&(a.watch="window"),r>0&&(a.height=r),t(this).dotdotdot(a)})}),jQuery(window).on("load",function(){jQuery(".dot-ellipsis.dot-load-update").trigger("update.dot")}),window.IsMobile=function(){var check=!1;return function(a){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(a)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(a.substr(0,4)))&&(check=!0)}(navigator.userAgent||navigator.vendor||window.opera),check};var module=angular.module("app",["ngAnimate","ngCookies","ui.router"]);module.config(function($httpProvider){$httpProvider.interceptors.push("httpRequestInterceptor"),window.carcare={}});var fb_try=0,fb_max=5,app={init:function(){"undefined"==typeof FB?fb_try<fb_max?(fb_try++,setTimeout(function(){app.init()},1e3)):(app.dissmissLoad(),angular.bootstrap(document,["app"])):(FB.init({appId:"1722927571299619",xfbml:!0,version:"v2.9"}),app.dissmissLoad(),angular.bootstrap(document,["app"]))},dissmissLoad:function(){setTimeout(function(){$(".fakeLoad").remove()},0)},debug:!1};$(document).ready(function(){app.init(),navigator.userAgent.toLowerCase().indexOf("android")>-1?$("body").addClass("android"):/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&$("body").addClass("ios")}),$(window).resize(function(){footer()}),function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];d.getElementById(id)||(js=d.createElement(s),js.id=id,js.src="//connect.facebook.net/en_US/sdk.js",fjs.parentNode.insertBefore(js,fjs))}(document,"script","facebook-jssdk"),Number.prototype.formatMoney=function(c,d,t){var n=this,c=isNaN(c=Math.abs(c))?2:c,d=void 0==d?".":d,t=void 0==t?",":t,s=n<0?"-":"",i=parseInt(n=Math.abs(+n||0).toFixed(c))+"",j=(j=i.length)>3?j%3:0;return s+(j?i.substr(0,j)+t:"")+i.substr(j).replace(/(\d{3})(?=\d)/g,"$1"+t)+(c?d+Math.abs(n-i).toFixed(c).slice(2):"")};var WorkSlide=function(){var context,areaWidth,itemWidth,items=$(".filter-box .filter-item"),container=$(".work-filter-container"),leftArrow=$(".filter-box .fa-angle-left"),rightArrow=$(".filter-box .fa-angle-right"),left=0,index=0;this.init=function(){this.viewPort(),this.calculate(),this.events(),this.sizeChange()},this.calculate=function(){areaWidth=$(window).width(),itemWidth=areaWidth-60,slideArea=itemWidth+20,this.isMobile?(container.css("position","relative"),container.width(areaWidth*items.length),items.width(itemWidth)):(container.css("width","100%"),container.css("left","0"),items.css("width","auto"))},this.events=function(){leftArrow.click(function(){index>0&&(left+=slideArea,index--,container.animate({left:left},500))}),rightArrow.click(function(){index<items.length-1&&(left-=slideArea,index++,container.animate({left:left},500))})},this.viewPort=function(){window.matchMedia("(max-width: 767px)").matches?this.isMobile=!0:this.isMobile=!1},this.sizeChange=function(){$(window).resize(function(){context.viewPort(),context.calculate()})},context=this,this.init()},ShareWorkSlide=function(){var context,areaWidth,padding,items=$(".works .work-item"),container=$(".works .work-list"),leftArrow=$(".works .fa-angle-left"),rightArrow=$(".works .fa-angle-right"),left=0,index=0;this.init=function(){this.viewPort(),this.calculate(),this.events(),this.sizeChange()},this.calculate=function(){padding=window.matchMedia("(max-width: 500px)").matches?50:80,areaWidth=$(window).width()-padding,this.isMobile?(container.css("position","relative"),container.width((areaWidth+20)*items.length),items.width(areaWidth)):(container.css("width","100%"),container.css("left","0"),items.css("width","auto"))},this.events=function(){leftArrow.click(function(){index>0&&(left+=areaWidth+20,index--,container.animate({left:left},500))}),rightArrow.click(function(){index<items.length-1&&(left-=areaWidth+20,index++,container.animate({left:left},500))})},this.viewPort=function(){window.matchMedia("(max-width: 767px)").matches?this.isMobile=!0:this.isMobile=!1},this.sizeChange=function(){$(window).resize(function(){clearTimeout(resize);var resize=setTimeout(function(){left=-index*(areaWidth+20),container.animate({left:left},0),context.viewPort(),context.calculate()},200)})},context=this,this.init()};module.directive("load",["$timeout","Event",function($timeout,Event){return{restrict:"E",templateUrl:"/partials/load.html",scope:{},link:function(scope,element,attrs){scope.display=!0,scope.$on(Event.Load.Dismiss,function(event,task){scope.display&&($timeout(function(){scope.animation="fadeOut"},500),$timeout(function(){scope.display=!1,$("body").focus()},1e3))}),scope.$on(Event.Load.Display,function(event,task){scope.display||(scope.animation="fadeIn",scope.display=!0)})}}}]),module.directive("ratingStar",["$timeout",function($timeout){return{restrict:"E",templateUrl:"/partials/stars.html",scope:{rating:"=rating"},link:function(scope,element,attrs){}}}]),module.directive("giveRating",["$timeout",function($timeout){var ratings=["ไม่ระบุ","แย่มาก","แย่","พอได้","ดี","ดีมาก"];return{restrict:"E",templateUrl:"/partials/rating.html",scope:{rating:"=rating",callback:"=callback"},link:function(scope,element,attrs){scope.$watch("rating",function(newValue,oldValue){var text_index=0;newValue&&(text_index=newValue),scope.text=ratings[text_index]},!0)}}}]),module.directive("confirm",["$timeout","Event",function($timeout,Event){return{restrict:"E",templateUrl:"partials/confirm.html",scope:{},link:function(scope,element,attrs){function close(){$timeout(function(){scope.animation="fadeOut"},150),$timeout(function(){scope.display=!1},1e3)}scope.display=!1,scope.$on(Event.Confirm.Dismiss,function(){close()}),scope.$on(Event.Confirm.Display,function(event,callback,message){scope.animation="fadeIn",scope.display=!0,scope.callback=callback,scope.message=message||"คุณยืนยันที่จะลบข้อมูลนี้ออกจากระบบหรือไม่?",scope.no=function(){close()}})}}}]),module.directive("fileUpload",["$timeout","Event",function($timeout,Event){return{restrict:"E",templateUrl:"/partials/upload.html",scope:{callback:"=upload"},link:function(scope,element,attrs){element.unbind("change"),element.bind("change",function(event){scope.callback&&scope.callback(event.target.files)})}}}]),module.directive("shopPopup",["$timeout","$rootScope","Event","ShopService",function($timeout,$rootScope,Event,ShopService){return{restrict:"E",templateUrl:"/partials/shop-popup.html",scope:{},link:function(scope,element,attrs){function initShop(shops){angular.forEach(shops,function(s){angular.forEach(scope.provinces,function(p){s.province==p.key&&(s.province_str=p.th),s.image&&(s.file=s.image)})})}function findCityByName(city){var _city="krung_thep_maha_nakhon";return angular.forEach(scope.provinces,function(p){p.th==city&&(_city=p.key)}),_city}scope.provinces=_provinces,scope.shopSearchTask={},scope.close=function(){scope.display&&($timeout(function(){scope.animation="fadeOut"},10),$timeout(function(){scope.display=!1,$("body").focus()},500))},scope.searchShop=function(){$timeout.cancel(scope.shopSearchTask),scope.trySearch=!1,scope.form_submit=!0,console.log(scope.search),scope.search.key&&scope.search.city?scope.onSearchShop||(scope.shopSearchTask=$timeout(function(){scope.onSearchShop=!0,ShopService.search(scope.search.key,scope.search.city).then(function(res){scope.shops=res.data,initShop(scope.shops),$timeout(function(){scope.onSearchShop=!1,scope.trySearch=!0,$timeout(function(){$("#searchShop").focus()},200)},500)})},1500)):scope.shops=[]},scope.provinceChange=function(){scope.search.key&&scope.searchShop()},scope.createShop=function(){$rootScope.$broadcast(Event.Confirm.Display,function(){$rootScope.$broadcast(Event.Load.Display,"SAVE_SHOP"),ShopService.create({name:scope.search.key,province:scope.search.city}).then(function(res){console.log(res.data),$rootScope.$broadcast(Event.Load.Dismiss),scope.close(),scope.callback(res.data)}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),alert("CREATE SHOP ERROR")})},'คุณแน่ใจที่จะสร้างร้าน "'+scope.search.key+'" หรือไม่?')},scope.selectShop=function(shop){scope.close(),scope.callback(shop)},scope.$on(Event.Shop.DisplayPopup,function(event,prev_shops,city,callback){scope.display||(scope.animation="fadeIn",$timeout.cancel(scope.shopSearchTask),scope.shopSearchTask={},scope.trySearch=!1,scope.display=!0,scope.trySearch=!1,scope.onSearchShop=!1,scope.prev_shops=prev_shops,scope.callback=callback,scope.shop={selected:""},scope.search={city:findCityByName(city)},$timeout(scope.setHeight,200),console.log(city))}),scope.setHeight=function(){if($(window).height()<$(".shoppopup").height()+150){var height=$(window).height()-150;height>600&&(height=600);var half_height=height/2;$(".shoppopup").height(height),$(".shoppopup").css("margin-top",-(half_height+20)+"px")}else $(".shoppopup").height(600)},scope.shopChange=function(){if(scope.shop.selected){var selected_shop=JSON.parse(scope.shop.selected);selected_shop.id&&(scope.close(),scope.callback(selected_shop))}},$(window).resize(scope.setHeight)}}}]),module.directive("createShopPopup",["$timeout","$rootScope","Event","ShopService",function($timeout,$rootScope,Event,ShopService){return{restrict:"E",templateUrl:"/partials/shop-create-popup.html",scope:{},link:function(scope,element,attrs){function setHeight(){if($(window).height()<$(".shoppopup").height()+150){var height=$(window).height()-150;height>600&&(height=600);var half_height=height/2;$(".shoppopup").height(height),$(".shoppopup").css("margin-top",-(half_height+20)+"px")}else $(".shoppopup").height(600)}var form;scope.provinces=_provinces,scope.close=function(){scope.display&&($timeout(function(){scope.animation="fadeOut"},10),$timeout(function(){scope.display=!1,$("body").focus()},500))},scope.provinceChange=function(){scope.search.key&&scope.searchShop()},scope.createShop=function(){scope.form_submit=!0,form.$valid&&($rootScope.$broadcast(Event.Load.Display),ShopService.create(scope.model).then(function(res){$rootScope.$broadcast(Event.Load.Dismiss),scope.close(),window.location.href="/#!/edit-shop?id="+res.data.id+"&cd=true&fs=true"}).catch(function(){scope.close(),$rootScope.$broadcast(Event.Message.Display,"สร้างร้านไม่ได้กรุณาลองใหม่อีกครั้ง"),$rootScope.$broadcast(Event.Load.Dismiss)}))},scope.setFrom=function(_form){form=_form},scope.$on(Event.Shop.DisplayCreatePopup,function(){scope.display||(scope.animation="fadeIn",scope.display=!0,scope.model={name:"",province:"krung_thep_maha_nakhon"},$timeout(setHeight,200))}),$(window).resize(setHeight)}}}]),module.directive("workPopup",["$timeout","$rootScope","Event","WorkService",function($timeout,$rootScope,Event,WorkService){return{restrict:"E",templateUrl:"/partials/work-popup.html",scope:{},link:function(scope,element,attrs){function getWorkGroupById(works,id){var group;return angular.forEach(works,function(w){w.id==id&&(group=w)}),group.name}scope.close=function(){scope.display&&($timeout(function(){scope.animation="fadeOut"},10),$timeout(function(){scope.display=!1,$("body").focus()},500))},scope.$on(Event.Work.DisplayPopup,function(event,model,works,shop,callback){scope.display||(scope.display=!0,scope.error=!1,scope.animation="fadeIn",scope.work=angular.copy(model),scope.work.shop=shop,scope.works=works,scope.callback=callback,$timeout(scope.setHeight,200))}),scope.setHeight=function(){if($(window).height()<$(".workpopup").height()+150){var height=$(window).height()-150;height>600&&(height=600);var half_height=height/2;$(".workpopup").height(height),$(".workpopup").css("margin-top",-(half_height+20)+"px")}else $(".workpopup").height(600)},scope.save=function(form){angular.forEach(form.$error.required,function(field){field.$setDirty()}),form.$valid&&($rootScope.$broadcast(Event.Load.Display),scope.work.group=getWorkGroupById(scope.works,scope.work.work),scope.work.id?WorkService.update(scope.work).then(function(){$rootScope.$broadcast(Event.Load.Dismiss),scope.close(),scope.callback()}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),scope.error=!0}):WorkService.create(scope.work).then(function(){scope.close(),scope.callback()}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),scope.error=!0}))},$(window).resize(scope.setHeight)}}}]),module.directive("notificationPopup",["$timeout","$rootScope","Event","NotificationService","WorkService","Helper",function($timeout,$rootScope,Event,NotificationService,WorkService,Helper){return{restrict:"E",templateUrl:"/partials/notification-popup.html",scope:{},link:function(scope,element,attrs){scope.dates=Helper.dateArray(),scope.months=Helper.monthArray(),scope.close=function(){scope.display&&($timeout(function(){scope.animation="fadeOut"},10),$timeout(function(){scope.display=!1,$("body").focus()},500)),$("body,html").css("overflow-y","")},scope.$on(Event.Notification.DisplayPopup,function(event,model,strings,works,callback){scope.display||($("body,html").css("overflow-y","hidden"),scope.display=!0,scope.error=!1,scope.model=angular.copy(model),scope.strings=strings,scope.animation="fadeIn",scope.works=angular.copy(works),scope.callback=callback,$timeout(scope.setHeight,200))}),scope.setHeight=function(){if($(window).height()<$(".notification").height()+150){var height=$(window).height()-150;height>580&&(height=580);var half_height=height/2;$(".notification").height(height),$(".notification").css("margin-top",-(half_height+20)+"px")
}else $(".notification").height(580)},scope.add=function(form){scope.status={},angular.forEach(form.$error.required,function(field){field.$setDirty()}),form.$valid?(scope.model.day&&scope.model.month&&scope.model.year&&!isNaN(parseInt(scope.model.year))||2==scope.model.type)&&scope.model.car?($rootScope.$broadcast(Event.Load.Display),2!=scope.model.type&&(scope.model.date=new Date(parseInt(scope.model.year-543),parseInt(scope.model.month)-1,scope.model.day)),NotificationService.create(scope.model).then(function(res){scope.callback(),scope.close()}).catch(function(res){"CAR EXPIRE"==res.error.message?scope.status.car_expire=!0:scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)})):(scope.model.car||(scope.status.car=!0),isNaN(parseInt(scope.model.year))&&2!=scope.model.type&&(scope.status.invalid_year=!0),scope.status.invalid=!0):scope.status.invalid=!0},$(window).resize(scope.setHeight)}}}]),module.directive("imageCaptionPopup",["$timeout","$rootScope","Event","RepairService",function($timeout,$rootScope,Event,RepairService){return{restrict:"E",templateUrl:"/partials/image-caption-popup.html",scope:{},link:function(scope,element,attrs){scope.close=function(){scope.display&&($timeout(function(){scope.animation="fadeOut"},10),$timeout(function(){scope.display=!1,$("body").focus()},500))},scope.$on(Event.Repair.DisplayCaptionPopup,function(event,model,callback){scope.display||(scope.display=!0,scope.error=!1,scope.animation="fadeIn",scope.model=angular.copy(model),scope.callback=callback)}),scope.save=function(form){$rootScope.$broadcast(Event.Load.Display),RepairService.saveImage(scope.model).then(function(){$rootScope.$broadcast(Event.Load.Dismiss),scope.callback(scope.model),scope.close()}).catch(function(){scope.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)})}}}}]),module.factory("Event",[function(){return{User:{Update:"UPDATE_USER",Loaded:"USER_LOADED"},Page:{Ready:"READY"},Load:{Display:"DISPLAY_LOAD",Dismiss:"DISMISS_LOAD"},Confirm:{Display:"DISPLAY_CONFIRM",Dismiss:"DISMISS_CONFIRM"},Car:{PickCar:"SELECT_CAR",Clear:"CLEAR_ACTIVE",SetActive:"SET_ACTIVE",Update:"UPDATE_CAR",IDForUpload:"SEND_ID_FOR_UPLOAD"},File:{Success:"UPLOAD_SUCCESS",SetType:"SET_FILE_UPLOAD_TYPE"},Share:{Ready:"SHARE_READY"},Shop:{DispayPopup:"DISPLAY_SHOP_POPUP",DisplayCreatePopup:"DISPLAY_SHOP_CREATE_POPUP"},Notification:{Ready:"NOTIFICATION_READY",DisplayPopup:"DISPLAY_NOTIFICATION_POPUP"},Work:{DisplayPopup:"DISPLAY_WORK_POPUP"},Repair:{DisplayCaptionPopup:"DISPLAY_IMAGE_CAPTION_POPUP"},Workgroup:{DisplayWorkgroupPopup:"DISPLAY_WORKGROUP_POPUP"},Message:{Display:"DISPLAY_MESSAGE",Dismiss:"DISMISS_MESSAGE"},ImageDeleteConfirm:{Display:"DISPLAY_IMAGE_DELETE_CONFIRM"},Report:{Display:"DISPLAY_REPORT_POPUP"}}}]),module.factory("httpRequestInterceptor",["$cookies",function($cookies){return{request:function(config){var authorization=$cookies.get("Authorization");return authorization&&(config.headers.Authorization=authorization,config.timeout=15e3),config}}}]),String.prototype.replaceAll=function(search,replacement){return this.split(search).join(replacement)},module.factory("Helper",[function(){var _monthsShort=["ม.ค.","ก.พ.","มี.ค.","ม.ย.","พ.ค.","มิ.ย.","ก.ค.","ส.ค.","ก.ย.","ต.ค.","พ.ย.","ธ.ค."],_monthsFull=["มกราคม","กุมภาพันธ์","มีนาคม ","เมษายน","พฤษภาคม","มิถุนายน","กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤศจิกายน","ธันวาคม"];return{monthsShort:_monthsShort,monthsFull:_monthsFull,monthArray:function(){for(var months=[],i=1;i<=12;i++)months.push(i);return months},dateArray:function(){for(var dates=[],i=1;i<=31;i++)dates.push(i);return dates},getMonthListAsKeyPair:function(){for(var months=[],i=0;i<12;i++)months.push({key:_monthsShort[i],value:i});return months},getMonthListFullAsKeyPair:function(){for(var months=[],i=1;i<=12;i++)months.push({key:_monthsFull[i-1],value:i});return months},readableMonth:function(month_number){return _monthsFull[month_number-1]},readableDate:function(_date){var date=new Date(_date);return date.getDate()+" "+this.monthsFull[date.getMonth()]+" "+(date.getFullYear()+543)},shortDate:function(_date){var date=new Date(_date);return(date.getDate()<10?"0"+date.getDate():date.getDate())+"-"+(date.getMonth()+1<10?"0"+(date.getMonth()+1):date.getMonth()+1)+"-"+(date.getFullYear()+543)},readableDateTime:function(_date){var date=new Date(_date),hour=date.getHours(),min=date.getMinutes(),sec=date.getSeconds();return hour<10&&(hour="0"+hour),min<10&&(min="0"+min),sec<10&&(sec="0"+sec),date.getDate()+" "+this.monthsFull[date.getMonth()]+" "+(date.getFullYear()+543)+", "+hour+":"+min+":"+sec},replaceUrl:function(str){return str=str.replaceAll(",","-"),str=str.replaceAll(" ","-"),str=str.replaceAll(".","-"),str=str.replaceAll('"',"-"),str=str.replaceAll("?","-"),str=str.replaceAll("=","-"),str=str.replaceAll("&","-"),str=str.replaceAll("%","-"),str=str.replaceAll("%","*")},getQueryStringValue:function(param,dummyPath){for(var res,sPageURL=dummyPath||window.location.search.substring(1),sURLVariables=sPageURL.split(/[&||?]/),i=0;i<sURLVariables.length;i+=1){var paramName=sURLVariables[i],sParameterName=(paramName||"").split("=");sParameterName[0]===param&&(res=sParameterName[1])}return res},mergeArray:function(arr1,arr2){return angular.forEach(arr2,function(m){arr1.push(m)}),arr1}}}]),module.factory("WorkgroupService",["$q","$http","URLS",function($q,$http,URLS){var caches={};return{get:function(){return $q(function(resolve,reject){var key=URLS.model("workgroup").all;caches[key]?resolve(caches[key]):$http.get(key).then(function(res){caches[key]=res.data,resolve(caches[key])}).catch(function(res){reject(res)})})},create:function(model){return $q(function(resolve,reject){$http.post(URLS.model("workgroup").all,model).then(function(res){caches={},resolve(res.data)}).catch(function(res){reject(res)})})},update:function(model){return $q(function(resolve,reject){$http.patch(URLS.model("workgroup").all,model).then(function(res){caches={},resolve(res.data)}).catch(function(res){reject(res)})})},delete:function(model){return $q(function(resolve,reject){$http.delete(URLS.model("workgroup").one.replace("{id}",model.id),model).then(function(res){caches={},resolve(res.data)}).catch(function(res){reject(res)})})}}}]),module.factory("NotificationService",["$rootScope","$http","$q","$cookies","URLS","CarService","RepairService",function($rootScope,$http,$q,$cookies,URLS,CarService,RepairService){var service="notifications",cache={};return{get:function(page,type,car,limit){var key=URLS.model(service).all+"?p="+page+(type?"&t="+type:"")+(car?"&c="+car:"")+(limit?"&limit="+limit:"");return $q(function(resolve,reject){cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getById:function(id){return $q(function(resolve,reject){var key=URLS.model(service).one.replace("{id}",id);cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getByType:function(type){return $q(function(resolve,reject){var key=URLS.model(service).all+"/type/"+type;cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data.data,resolve(res.data.data)}).catch(function(res){reject(res)})})},create:function(model){return $q(function(resolve,reject){$http.post(URLS.model(service).all,model).then(function(res){cache={},CarService.removeCache(),RepairService.clearCache(),resolve(res.data)}).catch(reject)})},update:function(model){return $q(function(resolve,reject){$http.patch(URLS.model(service).all,model).then(function(res){cache={},CarService.removeCache(),RepairService.clearCache(),resolve(res.data.data)}).catch(reject)})},delete:function(id){return $q(function(resolve,reject){$http.delete(URLS.model(service).one.replace("{id}",id)).then(function(res){cache={},CarService.removeCache(),RepairService.clearCache(),resolve(res.data)}).catch(reject)})}}}]),module.factory("FileService",["$rootScope","$http","$q","URLS",function($rootScope,$http,$q,URLS){return{get:function(query){var key=URLS.model("files").all+"?p="+query.p+(query.q?"&q="+query.q:"")+(query.months?"&months="+query.months:"")+(query.year?"&year="+query.year:"")+(query.type?"&type="+query.type:"")+(query.sort?"&sort="+query.sort:"");return $q(function(resolve,reject){$http.get(key).then(function(res){resolve(res.data)}).catch(function(err){reject(err)})})},upload:function(file,car,type){return $q(function(resolve,reject){var fd=new FormData,url=URLS.model("files").all+"?type="+type+(car?"&car="+car:"");console.log("Send upload reques to: "+url),fd.append("file",file),$http.post(url,fd,{transformRequest:angular.identity,headers:{"Content-Type":void 0}}).then(function(res){resolve(res.data.data)}).catch(function(err){reject(err)})})},delete:function(id){var key=URLS.model("files").one.replace("{id}",id);return $q(function(resolve,reject){$http.delete(key).then(function(res){resolve(res.data)}).catch(function(err){reject(err)})})}}}]),module.factory("ShopService",["$rootScope","$http","$q","$cookies","URLS","RepairService",function($rootScope,$http,$q,$cookies,URLS,RepairService){var cache={};return{get:function(page,limits,query_text,services,province,rating,using_count){var key=URLS.model("shops").all+"?p="+page+(limits?"&limits="+limits:"")+(query_text?"&q="+query_text:"")+(services?"&s="+services:"")+(province?"&c="+province:"")+(rating?"&r="+rating:"")+(using_count?"&using_count="+using_count:"");return $q(function(resolve,reject){$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getById:function(id){return $q(function(resolve,reject){var key=URLS.model("shops").one.replace("{id}",id);cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data.data,resolve(res.data.data)}).catch(function(res){reject(res)})})},create:function(model){return $q(function(resolve,reject){$http.post(URLS.model("shops").all,model).then(function(res){cache={},resolve(res.data)}).catch(reject)})},update:function(model){return $q(function(resolve,reject){$http.patch(URLS.model("shops").all,model).then(function(res){cache={},RepairService.clearCache(),resolve(res.data.data)}).catch(reject)})},delete:function(id){return $q(function(resolve,reject){$http.delete(URLS.model("shops").one.replace("{id}",id)).then(function(res){cache={},resolve(res.data)}).catch(reject)})},search:function(q,province){var key=URLS.model("shops").all+"?limits=20&q="+q+(province?"&c="+province:"");return $q(function(resolve,reject){cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},clearCache:function(){cache={}}}}]),module.factory("WorkService",["$rootScope","$http","$q","URLS","RepairService","ShopService",function($rootScope,$http,$q,URLS,RepairService,ShopService){var cache={};return{get:function(p,c){var key=URLS.model("works").all+"?p="+p+(c?"&c="+c:"");return $q(function(resolve,reject){cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getById:function(id){return $q(function(resolve,reject){var key=URLS.model("works").one.replace("{id}",id);cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data.data,resolve(res.data.data)}).catch(function(res){reject(res)})})},create:function(model){return $q(function(resolve,reject){$http.post(URLS.model("works").all,model).then(function(res){cache={},ShopService.clearCache(),RepairService.clearCache(),resolve(res.data)}).catch(reject)})},update:function(model){return $q(function(resolve,reject){$http.patch(URLS.model("works").all,model).then(function(res){cache={},ShopService.clearCache(),RepairService.clearCache(),resolve(res.data.data)}).catch(reject)})},delete:function(id){return $q(function(resolve,reject){$http.delete(URLS.model("works").one.replace("{id}",id)).then(function(res){cache={},RepairService.clearCache(),resolve(res.data)}).catch(reject)})}}}]),module.config(function($stateProvider,$urlRouterProvider){$urlRouterProvider.otherwise("/"),$stateProvider.state("index",{url:"/",templateUrl:"/partials/index.html"}).state("register",{url:"/register",templateUrl:"/partials/register.html"}).state("account",{url:"/account",templateUrl:"partials/account.html"}).state("update-account",{url:"/update-account",templateUrl:"/partials/update-account.html"}).state("car",{url:"/car",templateUrl:"/partials/car.html"}).state("editcar",{url:"/edit-car",templateUrl:"/partials/edit-car.html"}).state("newcar",{url:"/new-car",templateUrl:"/partials/new-car.html"}).state("notifications",{url:"/notifications",templateUrl:"/partials/notifications.html"}).state("notification",{url:"/notification",templateUrl:"/partials/notification.html"}).state("editnotification",{url:"/edit-notification",templateUrl:"/partials/edit-notification.html"}).state("newnotification",{url:"/new-notification",templateUrl:"/partials/new-notification.html"}).state("repairs",{url:"/repairs",templateUrl:"/partials/repairs.html"}).state("repair",{url:"/repair",templateUrl:"/partials/repair.html"}).state("shares",{url:"/shares",templateUrl:"/partials/shares.html"}).state("new-repair",{url:"/new-repair",templateUrl:"/partials/new-repair.html"}).state("edit-repair",{url:"/edit-repair",templateUrl:"/partials/edit-repair.html"}).state("shops",{url:"/shops",templateUrl:"/partials/shops.html"}).state("shop",{url:"/shop",templateUrl:"/partials/shop.html"}).state("edit-shop",{url:"/edit-shop",templateUrl:"/partials/edit-shop.html"}).state("forgot-password",{url:"/forgot-password",templateUrl:"/partials/forgot-password.html"}).state("report",{url:"/report",templateUrl:"/partials/report.html"})}),module.factory("PageService",["$q","$http","URLS",function($q,$http,URLS){var cache={};return{getAll:function(){var key=URLS.model("pages").all;return $q(function(resolve,reject){cache[key]?resolve(cache[key]):$http.get(URLS.model("pages").all).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})}}}]),module.factory("ShareService",["$http","$q","URLS",function($http,$q,URLS){var cache={};return{get:function(p,q){var key=URLS.model("shares").all+"?p="+p+(q.q?"&q="+q.q:"")+"&limits="+q.limits+(q.work?"&work="+q.work:"")+(q.province?"&province="+q.province:"")+(q.months?"&months="+q.months:"")+(q.year?"&year="+q.year:"")+(q.lp?"&lp="+q.lp:"")+(q.hp?"&hp="+q.hp:"")+(q.rating?"&rating="+q.rating:"")+(q.hasimage?"&hasimage="+q.hasimage:"")+(q.sort_column?"&sort_column="+q.sort_column:"")+(q.sort_order?"&sort_order="+q.sort_order:"");return $q(function(resolve,reject){cache[key],$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getById:function(id){return $q(function(resolve,reject){var key=URLS.model("shares").one.replace("{id}",id);cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data.data,resolve(res.data.data)}).catch(function(res){reject(res)})})},countView:function(id){var key=URLS.model("repairs").countView.replace("{id}",id);return $q(function(resolve,reject){id?$http.patch(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)}):reject("INVALID")})},clearCache:function(){cache={}}}}]),module.factory("RepairService",["$rootScope","$http","$q","$cookies","URLS","ShareService","CarService",function($rootScope,$http,$q,$cookies,URLS,ShareService,CarService){var service="repairs",cache={};return{get:function(p,q){var key=URLS.model(service).all+"?p="+p+(q.car?"&car="+q.car:"")+(q.work?"&work="+q.work:"")+(q.title?"&title="+q.title:"")+(q.lp?"&lp="+q.lp:"")+(q.hp?"&hp="+q.hp:"")+(q.rating?"&rating="+q.rating:"")+(q.shop?"&shop="+q.shop:"")+(q.limit?"&limit="+q.limit:"");return $q(function(resolve,reject){cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getByShop:function(p,q){var key=URLS.model(service).all+"/shop?p="+p+(q.shop?"&shop="+q.shop:"")+(q.limit?"&limit="+q.limit:"");return $q(function(resolve,reject){cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getById:function(id){return $q(function(resolve,reject){var key=URLS.model(service).one.replace("{id}",id);cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data.data,resolve(res.data.data)}).catch(function(res){reject(res)})})},create:function(model){return $q(function(resolve,reject){$http.post(URLS.model(service).all,model).then(function(res){cache={},ShareService.clearCache(),resolve(res.data)}).catch(reject)})},update:function(model){return $q(function(resolve,reject){$http.patch(URLS.model(service).all,model).then(function(res){cache={},ShareService.clearCache(),resolve(res.data.data)}).catch(reject)})},delete:function(id){return $q(function(resolve,reject){$http.delete(URLS.model(service).one.replace("{id}",id)).then(function(res){cache={},ShareService.clearCache(),resolve(res.data)}).catch(reject)})},getPreviousShop:function(carId){return $q(function(resolve,reject){var key=URLS.model(service).shops+"?car="+carId;cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(reject)})},uploadImage:function(model){return $q(function(resolve,reject){$http.post(URLS.model(service).image,model).then(function(res){cache={},ShareService.clearCache(),CarService.removeCache(),resolve(res.data)}).catch(reject)})},deleteImage:function(model){return $q(function(resolve,reject){$http.delete(URLS.model(service).image_id.replace("{id}",model.id)).then(function(res){cache={},ShareService.clearCache(),CarService.removeCache(),resolve(res.data)}).catch(reject)})},saveImage:function(model){return $q(function(resolve,reject){$http.patch(URLS.model(service).image,model).then(function(res){cache={},ShareService.clearCache(),resolve(res.data)}).catch(reject)})},clearCache:function(){cache={}},getAdmin:function(p,q){var key=URLS.model(service).admin_all+"?p="+p+(q.q?"&q="+q.q:"")+"&limits="+q.limits+(q.work?"&work="+q.work:"")+(q.province?"&province="+q.province:"")+(q.months?"&months="+q.months:"")+(q.year?"&year="+q.year:"")+(q.lp?"&lp="+q.lp:"")+(q.hp?"&hp="+q.hp:"")+(q.rating?"&rating="+q.rating:"")+(q.hasimage?"&hasimage="+q.hasimage:"")+(q.sort_column?"&sort_column="+q.sort_column:"")+(q.sort_order?"&sort_order="+q.sort_order:"");return $q(function(resolve,reject){cache[key],$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})}}}]),module.factory("URLS",function(){function modelEndpoints(model){return{all:base+model,one:base+model+"/{id}",image:base+model+"/image",shops:base+model.slice(0,-1)+"/shops",image_id:base+model+"/image/{id}",admin_all:base+"admin/"+model,countView:base+model+"/view/{id}",captcha:base+model+"/captcha"}}var base="/api/v1/",models=["cars","files","workgroup","notifications","repairs","shops","works","shares","pages","contacts","reports","settings","problems"],endpoints={accounts:{login:base+"accounts/login",register:base+"accounts",me:base+"accounts/me",logout:base+"accounts/logout",update:base+"accounts",captcha:base+"accounts/captcha",all:base+"accounts",one:base+"admin/accounts/{id}",admin:base+"admin/accounts",forgot_password:base+"accounts/forgot-password",forgot_password_token:base+"accounts/validate-forgot-password",change_password_by_token:base+"accounts/change-password-by-token",hijack:base+"admin/accounts/hijack"},strings:"/resources/strings.json"};return{model:function(model){return models.indexOf(model)>-1?modelEndpoints(model):endpoints[model]}}}),module.factory("StringService",["$http","URLS",function($http,URLS){return{getStrings:function(){return $http.get(URLS.model("strings"))}}}]),module.factory("AccountService",["$rootScope","$http","$q","$cookies","URLS","Event",function($rootScope,$http,$q,$cookies,URLS,Event){function me(){return $http.get(URLS.model(service).me)}function login(model){return $http.post(URLS.model(service).login,model)}function initUserAuthentication(){$cookies.get("Authorization")?(app.debug&&console.log("HAS USER COOKIE"),me().then(function(res){app.debug&&console.log("SUCCESS ON GET ME INFO"),window.carcare.user=res.data.data,$rootScope.$broadcast(Event.User.Update),userAuthenticationCallback()}).catch(function(){app.debug&&console.error("ERROR ON GET ME INFO"),$cookies.remove("Authorization"),userAuthenticationReject()})):(app.debug&&console.log("NO AUTHENTICATION COOKIE"),notLoginState(),userAuthenticationReject())}function notLoginState(){window.carcare.user={}}var userAuthenticationCallback,userAuthenticationReject,service="accounts",caches={};return{login:function(model){return login(model)},register:function(model){return $http.post(URLS.model(service).register,model)},me:function(){return me()},update:function(model){return caches={},$http.patch(URLS.model(service).update,model)},delete:function(id){return $q(function(resolve,reject){$http.delete(URLS.model(service).one.replace("{id}",id)).then(function(res){caches={},resolve(res.data)}).catch(function(err){reject(err)})})},captcha:function(){return $http.get(URLS.model(service).captcha)},logout:function(){return $q(function(resolve,reject){FB.getLoginStatus(function(crets){crets.authResponse&&FB.logout(function(response){})}),resolve()})},setAuthenticationToken:function(res){return $q(function(resolve){var date=new Date,expire_date=new Date(date.getFullYear()+1,date.getMonth(),date.getDate());$cookies.put("Authorization",res.data.token,{path:"/",expires:expire_date}),window.carcare.user=res.data,resolve()})},initializeUserOnLoad:function(){return $q(function(resolve,reject){userAuthenticationCallback=resolve,userAuthenticationReject=reject,initUserAuthentication()})},getAll:function(q){return $q(function(resolve,reject){var key=URLS.model(service).all+"?p="+q.p+(q.q?"&q="+q.q:"")+(q.e?"&e="+q.e:"")+(q.r?"&r="+q.r:"")+(q.o?"&o="+q.o:"")+(q.s?"&s="+q.s:"");caches[key]?resolve(caches[key]):$http.get(key).then(function(res){caches[key]=res.data,resolve(caches[key])}).catch(function(res){reject(res)})})},getById:function(id){return $q(function(resolve,reject){var key=URLS.model(service).one.replace("{id}",id);caches[key]?resolve(caches[key]):$http.get(key).then(function(res){caches[key]=res.data,resolve(caches[key])}).catch(function(res){reject(res)})})},save:function(model){return $q(function(resolve,reject){var key=URLS.model(service).admin;$http.patch(key,model).then(function(res){caches={},caches[key]=res.data,resolve(caches[key])}).catch(function(res){reject(res)})})},forgotPassword:function(model){return $q(function(resolve,reject){var key=URLS.model(service).forgot_password;$http.post(key,model).then(function(res){resolve(res.data)}).catch(function(res){reject(res)})})},validateForgotPasswordToken:function(model){return $q(function(resolve,reject){var key=URLS.model(service).forgot_password_token;$http.post(key,model).then(function(res){resolve(res.data)}).catch(function(res){reject(res)})})},changePasswordByToken:function(model){return $q(function(resolve,reject){var key=URLS.model(service).change_password_by_token;$http.post(key,model).then(function(res){resolve(res.data)}).catch(function(res){reject(res)})})},AccountService:function(model){return $q(function(resolve,reject){var key=URLS.model(service).hijack;$http.post(key,model).then(function(res){resolve(res.data)}).catch(function(res){reject(res)})})}}}]),module.factory("CarService",["$rootScope","$http","$q","$cookies","URLS",function($rootScope,$http,$q,$cookies,URLS){var cache={};return{get:function(query){var key=URLS.model("cars").all;return $q(function(resolve,reject){cache[key]?resolve(cache[key]):$http.get(URLS.model("cars").all).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getAll:function(query){console.log(query);var key=URLS.model("cars").admin_all+"?p="+query.p+(query.q?"&q="+query.q:"")+(query.order?"&order="+query.order:"");return $q(function(resolve,reject){cache[key]?resolve(cache[key]):$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},getById:function(id){var key=URLS.model("cars").one.replace("{id}",id);return $q(function(resolve,reject){cache[key]?resolve(angular.copy(cache[key])):$http.get(key).then(function(res){resolve(res.data.data),cache[key]=res.data.data}).catch(function(res){reject(res)})})},getByIds:function(ids){var key=URLS.model("cars").one.replace("/{id}","")+"_ids?ids="+ids;return $q(function(resolve,reject){cache[key]?resolve(angular.copy(cache[key])):$http.get(key).then(function(res){resolve(res.data.data),cache[key]=res.data.data}).catch(function(res){reject(res)})})},create:function(model){return $q(function(resolve,reject){$http.post(URLS.model("cars").all,model).then(function(res){cache={},resolve(res.data)}).catch(reject)})},update:function(model){return $q(function(resolve,reject){$http.patch(URLS.model("cars").all,model).then(function(res){cache={},resolve(res.data.data)}).catch(function(res){reject(res.data)})})},updateAdmin:function(model){return $q(function(resolve,reject){$http.patch(URLS.model("cars").admin_all,model).then(function(res){cache={},resolve(res.data.data)}).catch(reject)})},delete:function(id){return $q(function(resolve,reject){$http.delete(URLS.model("cars").one.replace("{id}",id)).then(function(res){cache={},resolve(res.data)}).catch(reject)})},removeCache:function(){cache={}}}}]),module.controller("AppController",["$scope","$rootScope","$timeout","$cookies","$q","AccountService","StringService","Event","FileService","WorkgroupService","CarService","Helper",function($scope,$rootScope,$timeout,$cookies,$q,AccountService,StringService,Event,FileService,WorkgroupService,CarService,Helper){function initUserModel(model){return model.contacts&&model.contacts.length&&angular.forEach(model.contacts,function(c){c.pay_date=Helper.readableDate(c.createdAt)}),model}$scope.strings_ready=!1,$scope.user_ready=!1,$scope.upload_car_id="",$scope.displayView=function(){$timeout(function(){$rootScope.$broadcast(Event.Load.Dismiss),$("html, body").animate({scrollTop:0},0),$(".navbar-collapse").hasClass("in")&&$(".navbar-collapse").removeClass("in"),$timeout(function(){bindCarSection(),bindUserSection(),setDDD(),footer(),$scope.viewReady=!0},500)},1e3)},$scope.init=function(){AccountService.initializeUserOnLoad().then(function(){$scope.user_ready=!0,$scope.user=initUserModel($scope.user),app.debug&&console.log("LOGIN BY",$scope.user)}).catch(function(err){app.debug&&console.log("NOT LOGIN, ANONIMOUS USER"),$scope.user_ready=!0}),StringService.getStrings().then(function(res){$scope.strings=res.data,$scope.strings_ready=!0}),(error_404||error_500)&&$scope.displayView()},$scope.navigateTo=function(url,isRedirect){"#!/new-car"===url&&$scope.user.max_car<$(".car-item").length?$scope.max_car=!0:($scope.max_car=!1,isRedirect?("/"!=url[0]&&(url="/"+url),$rootScope.$broadcast(Event.Load.Display),window.location.href=url):url!==window.location.hash&&($rootScope.$broadcast(Event.Load.Display),window.location.hash?($scope.displayLogin=!1,window.location.hash=url):window.location.href="#!/"==url?"/":url))},$scope.upload=function(files){if($scope.uploading=!0,$("#invalidFile").hide(),files&&files.length){var file=files[0];"image/jpeg"==file.type||"image/jpg"==file.type||"image/png"==file.type||"image/gif"==file.type?FileService.upload(files[0],$scope.upload_car_id,$scope.uploadType).then(function(file){$rootScope.$broadcast(Event.File.Success,file),$scope.uploading=!1,$("#fileUpload").val("")}).catch(function(res){res.error&&"MAX_FILE"==res.error.message?$rootScope.$broadcast(Event.Message.Display,"พื้นที่เก็บไฟล์สำหรับรถคันนี้เต็มแล้ว กรุณาติดต่อผู้ดูแลระบบเพื่ออัพเกรดพื้นที่เก็บไฟล์"):$rootScope.$broadcast(Event.Message.Display,"อัพโหลดไฟล์ล้มเหลวกรุณาลองอีกครั้ง"),$("#fileUpload").val(""),$scope.uploading=!1}):($("#fileUpload").val(""),$scope.uploading=!1,$("#invalidFile").show())}},$scope.$on(Event.User.Update,function(){$scope.user=window.carcare.user}),$scope.$on(Event.Car.Clear,function(){angular.forEach($scope.cars,function(car){car.active=!1})}),$scope.$on(Event.Car.Update,function(event,cars){$scope.cars=cars}),$scope.$on(Event.Car.SetActive,function(event,id){angular.forEach($scope.cars,function(c){c.id==id?c.active=!0:c.active=!1})}),$scope.$on("$includeContentLoaded",function(event){}),$rootScope.$on("$stateChangeStart",function(event,toState,toParams,fromState,fromParams,options){$rootScope.$broadcast(Event.Load.Display),$scope.viewReady=!1}),$rootScope.$on("$stateChangeSuccess",function(event,toState,toParams,fromState,fromParams){}),$scope.logout=function(){$rootScope.$broadcast(Event.Load.Display),AccountService.logout().then(function(){$cookies.remove("Authorization",{path:"/"}),window.location.href="/"}).catch(function(err){$cookies.remove("Authorization",{path:"/"}),console.log(err)})},$scope.loginToggle=function(){$scope.displayLogin=!$scope.displayLogin,$scope.displayLogin&&$timeout(function(){FB.XFBML.parse()},100)};var navs=["isHomePage","isSharePage","isUsersPage","isCarPage","isWorksPage","isPage","isPaymentPage","isShopPage","isFilesPage","isRepairsPage","isReportsPage","isSettingsPage","isReportPage"];$scope.setNavActive=function(active){angular.forEach(navs,function(n){n===active?$scope[active]=!0:$scope[n]=!1})},$scope.$watch(function(){return location.hash},function(value){location.hash.indexOf("notification")>-1||location.hash.indexOf("repair")>-1||location.hash.indexOf("shares")>-1||location.hash.indexOf("shops")>-1?$scope.mainClass="opacity-theme":$scope.mainClass="";var url=decodeURIComponent(location.href).replace("http://127.0.0.1:8000","");url=url.replace("http://localhost:8000",""),url=url.replace("http://www.carcarenote.com",""),url=url.replace("http://carcarenote.com",""),url=url.split("?")[0],url=url.replace("#!/",""),location.hash.indexOf("shares")>-1||location.href.indexOf("share")>-1?$scope.setNavActive("isSharePage"):location.hash.indexOf("user")>-1?$scope.setNavActive("isUsersPage"):location.hash.indexOf("car")>-1?$scope.setNavActive("isCarPage"):location.hash.indexOf("works")>-1?$scope.setNavActive("isWorksPage"):location.hash.indexOf("page")>-1?$scope.setNavActive("isPage"):location.href.indexOf("payment")>-1?$scope.setNavActive("isPaymentPage"):location.href.indexOf("files")>-1?$scope.setNavActive("isFilesPage"):location.href.indexOf("shops")>-1?$scope.setNavActive("isShopPage"):location.href.indexOf("repairs")>-1?$scope.setNavActive("isRepairsPage"):location.href.indexOf("reports")>-1?$scope.setNavActive("isReportsPage"):location.href.indexOf("settings")>-1?$scope.setNavActive("isSettingsPage"):location.href.indexOf("report")>-1?$scope.setNavActive("isReportPage"):"/"!=url&&"/admin"!=url||$scope.setNavActive("isHomePage"),$scope.upload_car_id=""}),$scope.$on(Event.Car.IDForUpload,function(event,id){$timeout(function(){$scope.upload_car_id=id},500)}),$scope.$on(Event.File.SetType,function(event,t){$timeout(function(){$scope.uploadType=t},500)}),$scope.init()}]),module.controller("LoginController",["$scope","$rootScope","$cookies","AccountService","Event",function($scope,$rootScope,$cookies,AccountService,Event){function success(res){AccountService.setAuthenticationToken(res).then(function(){window.location.href="/"})}function error(res){400===res.status?res.data&&res.data.error&&"BAN"==res.data.error.message?$scope.status.ban=!0:$scope.status={invalid:!0,error:!1}:$scope.status={invalid:!1,error:!0},$rootScope.$broadcast(Event.Load.Dismiss,"LOG_IN")}$scope.init=function(){$scope.user&&$scope.user.id?window.location.hash="#!/":($scope.model={},$scope.status={invalid:!1,error:!1})},$scope.login=function(form){form.$valid&&($scope.status={},
$rootScope.$broadcast(Event.Load.Display,"LOG_IN"),AccountService.login($scope.model).then(function(res){success(res.data)}).catch(function(res,code){error(res)}))},$scope.keyPress=function(form,event){13===event.keyCode&&$scope.login(form)},$scope.facebookLogin=function(creds){$rootScope.$broadcast(Event.Load.Display),$scope.status={},AccountService.login(creds).then(function(res){success(res.data)}).catch(function(res){error(res)})},$scope.facebookLoginClick=function(){FB.login(function(res){checkLoginState(res)},function(res){console.log(res)})},$scope.init()}]),module.controller("NotificationsController",["$scope","$timeout","$rootScope","$q","NotificationService","CarService","WorkgroupService","Helper","Event",function($scope,$timeout,$rootScope,$q,NotificationService,CarService,WorkgroupService,Helper,Event){function isValid(){return $scope.user&&$scope.user.id}function separateNotificationType(cars){angular.forEach(cars,function(car){car.noti_date=[],car.noti_mile=[],angular.forEach(car.notification_list,function(noti){noti.date_str=Helper.readableDate(noti.date),1==noti.type?car.noti_date.push(noti):car.noti_mile.push(noti)}),car.noti_date.sort(function(a,b){return a.date>b.date?1:b.date>a.date?-1:0}),car.noti_mile.sort(function(a,b){return a.mile>b.mile?1:b.mile>a.mile?-1:0}),car.all_noti_date=angular.copy(car.noti_date),car.all_noti_mile=angular.copy(car.noti_mile)}),$scope.cars_=angular.copy($scope.cars)}$scope.isNotificationsPage=!0,$scope.cars_=[],$scope.query={status:"true"},$scope.notificationsPage=function(){$scope.user_ready?isValid()?($scope.page=1,$scope.getAll()):window.location.hash="#!/":$timeout(function(){$scope.notificationsPage()},200)},$scope.getAll=function(){$q.all([CarService.get().then(function(res){$scope.cars=angular.copy(res.data),separateNotificationType($scope.cars)}),WorkgroupService.get().then(function(res){$scope.works=angular.copy(res.data)})]).then(function(){$scope.filter(),$scope.displayView()})},$scope.filter=function(){$scope.carId?($scope.cars_=[],angular.forEach($scope.cars,function(car){car.id==$scope.carId&&$scope.cars_.push(car)})):$scope.cars_=angular.copy($scope.cars),$scope.query_data($scope.cars_)},$scope.query_data=function(cars){angular.forEach(cars,function(car){car.noti_date=[],car.noti_mile=[],angular.forEach(car.all_noti_date,function(noti){!(!$scope.query.status||noti.enable&&"true"==$scope.query.status||!noti.enable&&"false"==$scope.query.status)||$scope.query.work&&noti.work!=$scope.query.work||car.noti_date.push(noti)}),angular.forEach(car.all_noti_mile,function(noti){!(!$scope.query.status||noti.enable&&"true"==$scope.query.status||!noti.enable&&"false"==$scope.query.status)||$scope.query.work&&noti.work!=$scope.query.work||car.noti_mile.push(noti)})})},$scope.gotoPage=function(page){page>$scope.pages.length?page=$scope.pages.length:page<1&&(page=1),$scope.page!=page&&($scope.page=page,$scope.filter())},$scope.pagings=function(meta){if($scope.pages=[],$scope.total=meta.count,meta.count&&meta.limits)for(var page_count=Math.ceil(meta.count/meta.limits),i=1;i<=page_count;i++)$scope.pages.push(i)},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.carFilter=function(car){$scope.carId!=car.id?($scope.carId=car.id,angular.forEach($scope.cars,function(_car){_car.active=!1}),car.active=!0):(car.active=!1,$scope.carId=void 0),$scope.page=1,$scope.filter()},$scope.notificationsPage()}]),module.controller("NotificationController",["$scope","$rootScope","$timeout","$q","$location","NotificationService","CarService","WorkgroupService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,NotificationService,CarService,WorkgroupService,Event,Helper){function getById(){$q.all([NotificationService.getById($scope.params.id).then(function(res){$scope.model=angular.copy(res.data),setInitModel($scope.model)}).catch(function(){alert("ERROR LOAD NOTIFICATION")}),CarService.get().then(function(res){$scope.cars=angular.copy(res.data)}),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)})]).then(function(){$scope.displayView(),angular.forEach($scope.cars,function(_car){_car.id==$scope.model.for_car&&(_car.active=!0)})})}function setInitModel(model){if(model.date){var date=new Date(model.date);model.date_str=Helper.readableDate(date)}}function isValid(){return $scope.params.id&&$scope.user&&$scope.user.id}$scope.params=$location.search(),$scope.from_car=!!$scope.params.car,$scope.from_car&&($scope.carId=$scope.params.car),$scope.notificationPage=function(){$scope.user_ready?isValid()?getById():window.location.hash="#!/":$timeout(function(){$scope.notificationPage()},200)},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.notificationPage()}]),module.controller("RegisterController",["$scope","$rootScope","AccountService","Event",function($scope,$rootScope,AccountService,Event){$scope.model={},$scope.status={},$scope.captcha={},$scope.registerPage=function(){AccountService.captcha().then(function(res){$scope.captcha=res.data.data,$scope.model.key=$scope.captcha.key}).catch(function(){}).finally(function(){$scope.displayView()})},$scope.submit=function(form){$scope.status={},angular.forEach(form.$error.required,function(field){field.$setDirty()}),$scope.is_submit=!0,form.$valid&&$scope.model.password===$scope.model.confirm_password&&$scope.model.captcha===$scope.captcha.captcha&&($rootScope.$broadcast(Event.Load.Display),AccountService.register($scope.model).then(function(res){AccountService.setAuthenticationToken(res.data),window.location.href="/",$rootScope.$broadcast(Event.Load.Dismiss)}).catch(function(res){400===res.status&&res.data&&res.data.error&&res.data.error.message&&"email exist"===res.data.error.message.toLowerCase()?$scope.status.exist=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)}))},$scope.keyPress=function(event,form){13===event.keyCode&&$scope.submit(form)},$scope.registerPage()}]),module.controller("AccountController",["$scope","$rootScope","$timeout","$cookies","AccountService","CarService","Event",function($scope,$rootScope,$timeout,$cookies,AccountService,CarService,Event){function isValid(){return $scope.user&&$scope.user.id}function recursiveGetCars(start,end){$scope.model.contacts[start].car_ids?CarService.getByIds($scope.model.contacts[start].car_ids).then(function(res){$scope.model.contacts[start].cars=res,start<end-1&&recursiveGetCars(start+1,end)}):start<end-1&&recursiveGetCars(start+1,end)}$scope.setForm=function(form){$scope.form=form},$scope.accountPage=function(){$scope.user_ready?isValid()?($scope.status={},$scope.model=angular.copy($scope.user),CarService.get().then(function(res){$scope.cars=angular.copy(res.data),$scope.displayView(),recursiveGetCars(0,$scope.model.contacts.length)})):window.location.hash="#!/":$timeout(function(){$scope.accountPage()},200)},$scope.edit=function(){window.location.href="#!/account"},$scope.update=function(form){$scope.is_submit=!0,($scope.model.password&&$scope.model.password===$scope.model.confirm_password||!$scope.model.password)&&form.$valid&&($scope.status={},$rootScope.$broadcast(Event.Load.Display),AccountService.update($scope.model).then(function(res){$scope.status.success=!0,window.carcare.user=res.data.data,$rootScope.$broadcast(Event.Load.Dismiss),$rootScope.$broadcast(Event.User.Update),$timeout(function(){$scope.status={},$scope.is_submit=!1},5e3)}).catch(function(res){res.data&&"INVALID OLD PASSWORD"===res.data.error.message?$scope.status.invalid_password=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)}))},$scope.logout=function(){AccountService.logout().then(function(){$cookies.remove("Authorization"),window.location.href="/"}).catch(function(){$cookies.remove("Authorization"),window.location.href="/"})},$scope.setProfileImage=function(event,file){$scope.model.image=file,window.carcare.user.image=file,$rootScope.$broadcast(Event.User.Update),$scope.update($scope.form)},$scope.editAccount=function(){$scope.navigateTo("#!/update-account")},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)};var lightbox=lity();$scope.simpleLightbox=function(url){lightbox(url)},$scope.$on(Event.File.Success,$scope.setProfileImage),$scope.accountPage()}]),module.controller("UpdateAccountController",["$scope","$rootScope","$timeout","$cookies","AccountService","Event",function($scope,$rootScope,$timeout,$cookies,AccountService,Event){function isValid(){return $scope.user&&$scope.user.id}$scope.setForm=function(form){$scope.form=form},$scope.updateAccountPage=function(){$scope.user_ready?isValid()?($scope.status={},$scope.model=angular.copy($scope.user),$scope.displayView()):window.location.hash="#!/":$timeout(function(){$scope.updateAccountPage()},200),$rootScope.$broadcast(Event.File.SetType,1)},$scope.edit=function(){window.location.href="#!/account"},$scope.update=function(form,noRedirect){$scope.is_submit=!0,($scope.model.password&&$scope.model.password===$scope.model.confirm_password||!$scope.model.password)&&form.$valid&&($scope.status={},$rootScope.$broadcast(Event.Load.Display),AccountService.update($scope.model).then(function(){AccountService.me().then(function(res){window.carcare.user=res.data.data,noRedirect?$rootScope.$broadcast(Event.Load.Dismiss):($rootScope.$broadcast(Event.User.Update),$scope.navigateTo("#!/account"))})}).catch(function(res){res.data&&"INVALID OLD PASSWORD"===res.data.error.message?$scope.status.invalid_password=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)}))},$scope.logout=function(){AccountService.logout().then(function(){$cookies.remove("Authorization"),window.location.href="/"}).catch(function(){alert("ERROR")})},$scope.setProfileImage=function(event,file){$scope.model.file=file,window.carcare.user.file=file,$rootScope.$broadcast(Event.User.Update),$scope.update($scope.form,!0)},$scope.$on(Event.File.Success,$scope.setProfileImage),$scope.updateAccountPage()}]),module.controller("CarController",["$scope","$rootScope","$timeout","$q","$location","CarService","NotificationService","RepairService","WorkgroupService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,CarService,NotificationService,RepairService,WorkgroupService,Event,Helper){function initModel(items){angular.forEach(items,function(i){i.date_str=Helper.readableDate(i.date)})}function loadResources(){$q.all([CarService.getById($scope.params.id).then(function(data){$scope.car=angular.copy(data),$scope.repair_query.car=$scope.car.id,setModelDate($scope.car)}).catch(function(){window.location.href="/"}),CarService.get().then(function(res){$scope.cars=angular.copy(res.data)}),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)}),RepairService.getPreviousShop($scope.params.id).then(function(res){$scope.shops=res.data,angular.forEach($scope.shops,function(s){s.province_str=getProvinceByKey(s.province)})})]).then(function(){angular.forEach($scope.cars,function(_car){_car.id==$scope.car.id&&(_car.active=!0)}),$q.all([loadNotiByMile(),loadNotiByDate(),loadRepairs()]).then(function(){$scope.displayView()})})}function loadNotiByMile(notify){return $q(function(resolve,reject){notify&&$rootScope.$broadcast(Event.Load.Display),NotificationService.get($scope.milePage,2,$scope.car.id,9999).then(function(res){$scope.noti_miles=[],angular.forEach(res.data,function(n){n.enable&&$scope.noti_miles.push(n)}),$scope.setMilePagings(res.meta),notify&&$rootScope.$broadcast(Event.Load.Dismiss),resolve()})})}function loadNotiByDate(notify){return $q(function(resolve,reject){notify&&$rootScope.$broadcast(Event.Load.Display),NotificationService.get($scope.datePage,1,$scope.car.id,9999).then(function(res){$scope.noti_date=[],angular.forEach(res.data,function(n){n.enable&&$scope.noti_date.push(n)}),initModel($scope.noti_date),$scope.setDatePagings(res.meta),notify&&$rootScope.$broadcast(Event.Load.Dismiss),resolve()})})}function loadRepairs(notify){return $q(function(resolve,reject){notify&&$rootScope.$broadcast(Event.Load.Display),RepairService.get($scope.repairPage,{car:$scope.car.id,limit:9999}).then(function(res){$scope.repairs=res.data,initModel($scope.repairs),$scope.setRepairPagings(res.meta),notify&&$rootScope.$broadcast(Event.Load.Dismiss),resolve()})})}function setModelDate(model){model.month&&(model.month=Helper.readableMonth(model.month)),model.exp_date&&(model.exp_date_str=Helper.readableDate(model.exp_date)),$scope.file_usage_percentage=model.file_usage/model.max_file_size,$scope.file_usage_percentage>1&&($scope.file_usage_percentage=1),$scope.file_usage_percentage=100*$scope.file_usage_percentage,new Date(model.exp_date)<new Date&&(model.expire=!0)}function isValid(){return $scope.user&&$scope.user.id&&$scope.params.id}$scope.dates=Helper.dateArray(),$scope.months=Helper.monthArray(),$scope.params=$location.search(),$scope.milePage=1,$scope.datePage=1,$scope.repairPage=1,$scope.repair_query={limit:9999},$scope.carPage=function(){$scope.user_ready?isValid()?loadResources():window.location.hash="#!/":$timeout(function(){$scope.carPage()},200)},$scope.pickCar=function(car){$scope.car!=car.id&&(window.location.href="#!/car?id="+car.id,window.location.reload())},$scope.setMilePagings=function(meta){if($scope.milePagings=[],$scope.mileTotal=meta.count,meta.count&&meta.limits)for(var page_count=Math.ceil(meta.count/meta.limits),i=1;i<=page_count;i++)$scope.milePagings.push(i)},$scope.setDatePagings=function(meta){if($scope.datePagings=[],$scope.dateTotal=meta.count,meta.count&&meta.limits)for(var page_count=Math.ceil(meta.count/meta.limits),i=1;i<=page_count;i++)$scope.datePagings.push(i)},$scope.setRepairPagings=function(meta){if($scope.repairPagings=[],$scope.repairTotal=meta.count,meta.count&&meta.limits)for(var page_count=Math.ceil(meta.count/meta.limits),i=1;i<=page_count;i++)$scope.repairPagings.push(i)},$scope.gotoMilePage=function(page){page>$scope.milePagings.length?page=$scope.milePagings.length:page<1&&(page=1),$scope.milePage!=page&&($scope.milePage=page,loadNotiByMile(!0))},$scope.gotoDatePage=function(page){page>$scope.datePagings.length?page=$scope.datePagings.length:page<1&&(page=1),$scope.datePage!=page&&($scope.datePage=page,loadNotiByDate(!0))},$scope.gotoRepairPage=function(page){page>$scope.repairPagings.length?page=$scope.repairPagings.length:page<1&&(page=1),$scope.repairPage!=page&&($scope.repairPage=page,loadRepairs(!0))},$scope.filterRepair=function(){$rootScope.$broadcast(Event.Load.Display),RepairService.get($scope.repairPage,$scope.repair_query).then(function(res){$scope.repairs=res.data,initModel($scope.repairs),$scope.setRepairPagings(res.meta),$rootScope.$broadcast(Event.Load.Dismiss)})},$scope.createRepair=function(){$scope.car.expire?$rootScope.$broadcast(Event.Message.Display,"รถคันนี้หมดอายุการบันทึกข้อมูลแล้ว กรุณาติดต่อผู้ดูแลระบบเพื่อต่ออายุ"):$scope.navigateTo("#!/new-repair?car="+$scope.car.id)},$scope.carPage()}]),module.controller("RepairController",["$scope","$rootScope","$timeout","$q","$location","RepairService","CarService","AccountService","WorkgroupService","WorkService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,RepairService,CarService,AccountService,WorkgroupService,WorkService,Event,Helper){function getWorkGroupById(id){var group;return angular.forEach($scope.workgroup,function(w){w.id===id&&(group=w)}),group}function getById(){$q.all([RepairService.getById($scope.params.id).then(function(data){$scope.model=data}).catch(function(){alert("ERROR LOAD REPAIR")}),CarService.get().then(function(res){$scope.cars=angular.copy(res.data)}),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)}),RepairService.getPreviousShop($scope.params.car?$scope.params.car:0).then(function(res){$scope.previous_shops=res.data})]).then(function(){initModel($scope.model),watch(),$scope.displayView(),angular.forEach($scope.cars,function(_car){_car.id==$scope.model.for_car&&(_car.active=!0)}),$rootScope.$broadcast(Event.Car.IDForUpload,$scope.model.for_car),initScroll(),$timeout(function(){shopExpandCollapse()},500)})}function initModel(model){if(model.date){var date=new Date(model.date);model.date_str=Helper.readableDate(date)}angular.forEach(model.notifications,function(n){n.date_str=Helper.readableDate(n.date),angular.forEach($scope.workgroup,function(w){n.work==w.id&&(n.work_str=w.name)})}),$scope.calPrice()}function isValid(){return $scope.params.id&&$scope.user&&$scope.user.id}function watch(){watchShare&&watchShare(),watchScore&&watchScore(),watchScore=$scope.$watch("model.score",function(newValue,oldValue){isFirst||$scope.save()}),watchShare=$scope.$watch("model.share",function(newValue,oldValue){isFirst||$scope.save()}),$timeout(function(){isFirst=!1},1e3)}function initScroll(){$timeout(function(){new IScroll("#iscroll",{scrollX:!0,scrollY:!0,mouseWheel:!1,scrollbars:!0,click:!0})},200)}function shopExpandCollapse(){$(".shop-detail-on-repair .see-more").unbind("click"),$(".shop-detail-on-repair .close-more").unbind("click"),$(".shop-detail-on-repair .see-more").click(function(){$(this).parents(".shop-detail-on-repair").addClass("active")}),$(".shop-detail-on-repair .close-more").click(function(){$(this).parents(".shop-detail-on-repair").removeClass("active")})}$scope.provinces=_provinces,$scope.ratings=["ไม่ระบุ","แย่มาก","แย่","พอได้","ดี","ดีมาก"],$scope.params=$location.search(),$scope.from_car=!!$scope.params.car,$scope.from_car&&($scope.carId=$scope.params.car);var watchScore,watchShare,lightbox=lity(),isFirst=!0;$scope.repairPage=function(){$scope.user_ready?isValid()?getById():window.location.hash="#!/":$timeout(function(){$scope.repairPage()},200),$rootScope.$broadcast(Event.File.SetType,4)},$scope.reload=function(){RepairService.getById($scope.params.id).then(function(data){$scope.model=data,initModel($scope.model),$rootScope.$broadcast(Event.Load.Dismiss),$timeout(function(){shopExpandCollapse()},500)}).catch(function(){$timeout(function(){$rootScope.$broadcast(Event.Message.Display,"โหลดบันทึกการซ่อมไม่ได้กรุณาลองใหม่")})})},$scope.save=function(){$rootScope.$broadcast(Event.Load.Display);var group=getWorkGroupById($scope.model.work);group&&($scope.model.group=group.name),RepairService.update($scope.model).then(function(res){$rootScope.$broadcast(Event.Load.Dismiss)}).catch(function(res){$timeout(function(){$rootScope.$broadcast(Event.Message.Display,"บันทึกการซ่อมไม่ได้กรุณาลองใหม่")}),$rootScope.$broadcast(Event.Load.Dismiss)})},$scope.openShop=function(){$rootScope.$broadcast(Event.Shop.DisplayPopup,$scope.previous_shops,$scope.model.car.city,function(shop){$scope.model.shop=shop,$timeout(function(){shopExpandCollapse(),$scope.save()},500)})},$scope.openWork=function(){$rootScope.$broadcast(Event.Work.DisplayPopup,{repair:$scope.model.id,work:$scope.model.work+""},$scope.workgroup,$scope.model.shop?$scope.model.shop.id:"",function(){$timeout(function(){$scope.reload()},500)})},$scope.editWork=function(work){$rootScope.$broadcast(Event.Work.DisplayPopup,work,$scope.workgroup,$scope.model.shop?$scope.model.shop.id:"",function(){$timeout(function(){$scope.reload()},500)})},$scope.deleteWork=function(work){$rootScope.$broadcast(Event.Confirm.Display,function(){$rootScope.$broadcast(Event.Load.Display),WorkService.delete(work.id).then(function(res){$scope.reload()}).catch(function(){$timeout(function(){$rootScope.$broadcast(Event.Message.Display,"ลบรายการซ่อมไม่ได้กรุณาลองใหม่")})})})},$scope.openNotification=function(){$rootScope.$broadcast(Event.Notification.DisplayPopup,{car:$scope.model.car.id,repair:$scope.model.id,work:$scope.model.work+"",enable:!0},$scope.strings,$scope.workgroup,function(){$scope.reload()})},$scope.calPrice=function(){var price=0;angular.forEach($scope.model.repair_works,function(i){price+=i.price}),$scope.model.price!=price&&($scope.model.price=price,$scope.save())},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.rated=function(score){$scope.model.score=score},$scope.saveImage=function(event,file){var fileData={repair_id:$scope.model.id,image_id:file.id};RepairService.uploadImage(fileData).then(function(){$scope.reload()}).catch(function(){$timeout(function(){$rootScope.$broadcast(Event.Message.Display,"Upload ไม่ได้กรุณาลองใหม่")},500)})},$scope.removeImage=function(image){$rootScope.$broadcast(Event.Confirm.Display,function(){$rootScope.$broadcast(Event.Load.Display),RepairService.deleteImage(image).then(function(){$scope.reload()}).catch(function(){$rootScope.$broadcast(Event.Message.Display,"ลบรูปไม่ได้กรุณาลองใหม่")})})},$scope.imageCaption=function(image,index){$rootScope.$broadcast(Event.Repair.DisplayCaptionPopup,image,function(model){$scope.model.repair_images[index]=model})},$scope.lightbox=function(url,caption,index){lightbox(url),$timeout(function(){caption&&$(".lity-container").append('<p class="lb-caption animated fadeIn">'+caption+"</p>");var items=$(".repair-image");items.length>1&&($(".lity-container").append('<span class="lb-next animated fadeIn"><i class="fa fa-angle-right"></i></span>'),$(".lity-container").append('<span class="lb-prev animated fadeIn"><i class="fa fa-angle-left"></i></span>'),$(".lb-next").click(function(){++index>=items.length&&(index=0);var image_src=$($(items[index]).find("img")[0]).attr("src"),image_caption=$($(items[index]).find(".caption")[0]).text();$(".lity-container").find("img").attr("src",image_src),$(".lity-container").find(".lb-caption").text(image_caption)}),$(".lb-prev").click(function(){--index<0&&(index=items.length-1);var image_src=$($(items[index]).find("img")[0]).attr("src"),image_caption=$($(items[index]).find(".caption")[0]).text();$(".lity-container").find("img").attr("src",image_src),$(".lity-container").find(".lb-caption").text(image_caption)}))},200)},$scope.getProvinceByKey=function(key){var province="";return angular.forEach($scope.provinces,function(p){p.key==key&&(province=p.th)}),province},$scope.delete=function(){$rootScope.$broadcast(Event.Confirm.Display,function(){RepairService.delete($scope.model.id).then(function(res){$scope.from_car?window.location.hash="#!/car?id="+$scope.carId:window.location.href.toLowerCase().indexOf("admin")>-1?window.location.href="/admin#!/repairs":window.location.href="/"}).catch(function(res){$timeout(function(){$rootScope.$broadcast(Event.Message.Display,"ลบการซ่อมนี้ไม่ได้ กรุณาลองใหม่หรือตรวจสอบให้แน่ใจว่าได้ลบรูปและรายการซ่อมทั้งหมดแล้ว")},500),$rootScope.$broadcast(Event.Load.Dismiss)})})},$scope.impersonate=function(){AccountService.AccountService({id:$scope.model.user.id}).then(function(res){AccountService.setAuthenticationToken(res).then(function(){window.location.href="/#!/repair?id="+$scope.model.id})}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),$timeout(function(){$rootScope.$broadcast(Event.Message.Display,"พบปัญหาในการเข้าใช้ User นี้")},500)})},$scope.back=function(){$scope.navigateTo("#!/car?id="+$scope.model.for_car)},$scope.$on(Event.File.Success,$scope.saveImage),$scope.repairPage()}]),module.controller("RepairsController",["$scope","$timeout","$rootScope","$q","RepairService","Helper","Event",function($scope,$timeout,$rootScope,$q,RepairService,Helper,Event){function initModel(items){angular.forEach(items,function(i){i.score=i.score+"",i.date_str=Helper.readableDate(i.date)})}$scope.isRepairsPage=!0,$scope.query={},$scope.init=function(){$scope.page=1,$rootScope.$broadcast(Event.Car.Clear),$scope.getAll()},$scope.getAll=function(){$rootScope.$broadcast(Event.Load.Display,"GET_REPAIR"),RepairService.get($scope.page,$scope.query).then(function(res){$scope.repairs=res.data,initModel($scope.repairs),$scope.pagings(res.meta),$rootScope.$broadcast(Event.Load.Dismiss,"GET_REPAIR")}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss,"GET_REPAIR")})},$scope.$on(Event.Car.PickCar,function(event,carId){$scope.query.car=carId,$scope.page=1,$scope.getAll()}),$scope.gotoPage=function(page){page>$scope.pages.length?page=$scope.pages.length:page<1&&(page=1),$scope.page!=page&&($scope.page=page,$scope.getAll())},$scope.selectWorkgroup=function(work){work?work.active||(angular.forEach($scope.workgroup,function(w){w.active=!1}),work.active=!0,$scope.query.work=work.id,$scope.getAll()):(angular.forEach($scope.workgroup,function(w){w.active=!1}),$scope.query.work&&(delete $scope.query.work,$scope.getAll()))},$scope.pagings=function(meta){if($scope.pages=[],$scope.total=meta.count,meta.count&&meta.limits)for(var page_count=Math.ceil(meta.count/meta.limits),i=1;i<=page_count;i++)$scope.pages.push(i)},$scope.init()}]);var shareWorkSlide;module.controller("SharesController",["$scope","$rootScope","$timeout","$q","$location","ShareService","WorkgroupService","CarService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,ShareService,WorkgroupService,CarService,Event,Helper){function loadModel(notify,isLoadMode){notify&&$rootScope.$broadcast(Event.Load.Display),ShareService.get($scope.query.page,$scope.query).then(function(res){var objects=initModel(res.data);$scope.shares=isLoadMode?Helper.mergeArray($scope.shares,objects):objects,setMeta(res.meta),$scope.isLoadMore=!1,notify&&$rootScope.$broadcast(Event.Load.Dismiss)}).catch(function(){isLoadMore&&--$scope.query.page<0&&($scope.query.page=1),$scope.isLoadMore=!1,$rootScope.$broadcast(Event.Load.Dismiss),$rootScope.$broadcast(Event.Message.Display,"มีบางอย่างผิดพลาดกรุณาลองใหม่")})}function initModel(model){return angular.forEach(model,function(item){angular.forEach($scope.provinces,function(_province){item.shop&&item.shop.province==_province.key&&(item.shop.province_str=_province.th)})}),model}function setMeta(meta){meta.limits*$scope.query.page<meta.count?$scope.hasMore=!0:$scope.hasMore=!1}function loadDataForNotLoginUser(){$q.all([loadModel(),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)})]).then(onLoadFinished)}function loadDataForLoginUser(){$q.all([loadModel(),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)}),CarService.get().then(function(res){$scope.cars=angular.copy(res.data)})]).then(onLoadFinished)}function onLoadFinished(){$timeout(function(){shareWorkSlide=new ShareWorkSlide},500),$scope.displayView()}$scope.provinces=_provinces,$scope.sharesPage=function(){$scope.query={limits:24,page:1},$scope.user_ready?$scope.user&&$scope.user.id?loadDataForLoginUser():loadDataForNotLoginUser():$timeout(function(){$scope.sharesPage()},200)},$scope.getAll=function(){loadModel()},$scope.search=function(){$scope.query.page=1,loadModel(!0,!1)},$scope.loadMore=function(){$scope.query.page++,$scope.isLoadMore=!0,loadModel(!0,!0)},$scope.selectWorkgroup=function(work){work?work.active||(angular.forEach($scope.workgroup,function(w){w.active=!1}),work.active=!0,$scope.query.work=work.id,$scope.query.page=1,loadModel(!0,!1)):(angular.forEach($scope.workgroup,function(w){w.active=!1}),$scope.query.work&&(delete $scope.query.work,$scope.query.page=1,loadModel(!0,!1)))},$scope.workgroupChange=function(){$scope.query.work?angular.forEach($scope.workgroup,function(w){$scope.query.work==w.id?w.active=!0:w.active=!1}):(angular.forEach($scope.workgroup,function(w){w.active=!1}),$scope.query.work&&delete $scope.query.work),$scope.query.page=1,loadModel(!0,!1)},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.sharesPage()}]),module.controller("EditCarController",["$scope","$rootScope","$timeout","$q","$location","CarService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,CarService,Event,Helper){function getById(){$q.all([CarService.getById($scope.params.id).then(function(data){$scope.model=data}).catch(function(){alert("LOAD CAR ERROR")}),CarService.get().then(function(res){$scope.cars=angular.copy(res.data)})]).then(function(){setModelDate($scope.model),$scope.displayView(),angular.forEach($scope.cars,function(_car){_car.id==$scope.model.id&&(_car.active=!0)})})}function isValid(){return $scope.user&&$scope.user.id&&$scope.params.id}function validateCar(){return $scope.model.id&&$scope.model.brand&&$scope.model.city&&$scope.model.series&&$scope.model.serial&&(!$scope.model.year||!isNaN(parseInt($scope.model.year)))}function setModelDate(model){0==model.year?model.year="":model.year=model.year+"",0==model.month?model.month="":model.month=model.month+"",0==model.day?model.day="":model.day=model.day+""}function createProvinces(){$scope.provinces=[],angular.forEach(areas,function(area){angular.forEach(area.areas,function(p){$scope.provinces.push(p)})}),$scope.provinces.sort(function(a,b){return a.th>b.th?1:b.th>a.th?-1:0})}$scope.status={},$scope.dates=Helper.dateArray(),$scope.months=Helper.getMonthListFullAsKeyPair(),$scope.params=$location.search(),$scope.years=function(){for(var years=[],now=new Date,final_year=now.getFullYear(),current_year=1998;current_year<=final_year;current_year++)years.push(current_year+"");return years}(),$scope.editCarPage=function(){$scope.user_ready?isValid()?getById():window.location.hash="#!/":$timeout(function(){$scope.editCarPage()},200),createProvinces(),$rootScope.$broadcast(Event.File.SetType,2)},$scope.setForm=function(form){$scope.form=form,window.currentForm=form},$scope.update=function(notRedirect){angular.forEach(currentForm.$error.required,function(field){field.$setDirty()}),validateCar()?($rootScope.$broadcast(Event.Load.Display),$scope.status={},$scope.model.year&&($scope.model.year=parseInt($scope.model.year)),$scope.model.day&&($scope.model.day=parseInt($scope.model.day)),$scope.model.month&&($scope.model.month=parseInt($scope.model.month)),CarService.update($scope.model).then(function(car){notRedirect?$rootScope.$broadcast(Event.Load.Dismiss):window.location.href="/#!/car?id="+$scope.model.id}).catch(function(res){console.log(res),"CAR EXPIRE"==res.error.message?$scope.status.car_expire=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)})):($scope.model.year&&isNaN(parseInt($scope.model.year))&&($scope.status.invalid_year=!0),$scope.status.invalid=!0)},$scope.remove=function(){$rootScope.$broadcast(Event.Confirm.Display,function(){$rootScope.$broadcast(Event.Load.Display),CarService.delete($scope.params.id).then(function(){CarService.get().then(function(res){$scope.navigateTo("#!/")}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss)})}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),$scope.status.error_remove=!0})})},$scope.setCarImage=function(event,file){$scope.model&&($scope.model.image=file,$scope.update(!0))},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.$on(Event.File.Success,$scope.setCarImage),$scope.editCarPage()}]),module.controller("NewCarController",["$scope","$rootScope","$timeout","$location","CarService","Event","Helper",function($scope,$rootScope,$timeout,$location,CarService,Event,Helper){function validateCar(){return $scope.model.brand&&$scope.model.series&&$scope.model.city&&$scope.model.serial&&(!$scope.model.year||!isNaN(parseInt($scope.model.year)))}function createProvinces(){$scope.provinces=[],angular.forEach(areas,function(area){angular.forEach(area.areas,function(p){$scope.provinces.push(p)})}),$scope.provinces.sort(function(a,b){return a.th>b.th?1:b.th>a.th?-1:0})}$scope.status={},$scope.dates=Helper.dateArray(),$scope.months=Helper.getMonthListFullAsKeyPair(),$scope.years=function(){for(var years=[],now=new Date,final_year=now.getFullYear(),current_year=1998;current_year<=final_year;current_year++)years.push(current_year+"");return years}(),$scope.newCarPage=function(){$scope.user_ready?$scope.user&&$scope.user.id?($scope.model={},CarService.get().then(function(res){$scope.cars=angular.copy(res.data),$scope.displayView()})):window.location.hash="#!/":$timeout(function(){$scope.newCarPage()},200),createProvinces(),$rootScope.$broadcast(Event.File.SetType,2)},$scope.setForm=function(form){$scope.form=form},$scope.add=function(form){angular.forEach(form.$error.required,function(field){field.$setDirty()}),
validateCar()?($rootScope.$broadcast(Event.Load.Display),$scope.status={},$scope.model.year&&($scope.model.year=parseInt($scope.model.year)),$scope.model.day&&($scope.model.day=parseInt($scope.model.day)),$scope.model.month&&($scope.model.month=parseInt($scope.model.month)),CarService.create($scope.model).then(function(res){$scope.navigateTo("#!/car?id="+res.data.id)}).catch(function(res){"MAX CAR"===res.error.message?$scope.status.maxcar=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)})):($scope.model.year&&isNaN(parseInt($scope.model.year))&&($scope.status.invalid_year=!0),$scope.status.invalid=!0)},$scope.setImage=function(event,file){$scope.model&&($scope.model.image=file,$scope.model.id&&$scope.update($scope.form))},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.newCarPage(),$scope.$on(Event.File.Success,$scope.setImage)}]),module.controller("IndexController",["$scope","$rootScope","$q","$timeout","WorkgroupService","CarService","NotificationService","ShareService","ShopService","Helper","Event",function($scope,$rootScope,$q,$timeout,WorkgroupService,CarService,NotificationService,ShareService,ShopService,Helper,Event){function separateNotificationType(cars){angular.forEach(cars,function(car){car.noti_date=[],car.noti_mile=[],angular.forEach(car.notification_list,function(noti){noti.enable&&(noti.date_str=Helper.readableDate(noti.date),1==noti.type?car.noti_date.push(noti):car.noti_mile.push(noti))}),car.noti_date.sort(function(a,b){return a.date>b.date?1:b.date>a.date?-1:0}),car.noti_mile.sort(function(a,b){return a.mile>b.mile?1:b.mile>a.mile?-1:0}),car.all_noti_date=angular.copy(car.noti_date),car.all_noti_mile=angular.copy(car.noti_mile),car.noti_date.length>3&&car.noti_date.splice(3,car.noti_date.length-3),car.noti_mile.length>3&&car.noti_mile.splice(3,car.noti_mile.length-3)}),$scope.cars_=angular.copy($scope.cars)}function notLoginUser(){$q.all([WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)}),ShareService.get(1,{limits:limmits}).then(function(res){$scope.shares=res.data}),$scope.loadShop()]).then(function(){$timeout(function(){new WorkSlide},500),$scope.displayView()}).catch(function(){$scope.displayView()})}function loginUser(){$q.all([CarService.get().then(function(res){$scope.cars=angular.copy(res.data),separateNotificationType($scope.cars)}),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)}),ShareService.get(1,{limits:limmits}).then(function(res){$scope.shares=res.data}),$scope.loadShop()]).then(function(){$timeout(function(){new WorkSlide},500),$scope.displayView()}).catch(function(){$scope.displayView()})}function createProvinces(){$scope.provinces=_provinces}$scope.shop_query={page:1,services:"",province:"",isLoad:!1},$scope.provinces=[];var limmits=12;IsMobile()&&(limmits=5),$scope.loadIndex=function(){$scope.user_ready&&$scope.strings_ready?($scope.cars=[],createProvinces(),$scope.user&&$scope.user.id?loginUser():notLoginUser()):$timeout(function(){$scope.loadIndex()},500)},$scope.loadShop=function(){$scope.shop_query.page=1,$rootScope.$broadcast(Event.Load.Display),$scope.shop_query.isLoad=!0,ShopService.get($scope.shop_query.page,20,"",$scope.shop_query.services,$scope.shop_query.province,0,5).then(function(res){$scope.shops=res.data,angular.forEach($scope.shops,function(s){angular.forEach($scope.provinces,function(p){s.province==p.key&&(s.province_str=p.th)})}),res.meta.count>$scope.shops.length?$scope.shop_query.hasMore=!0:$scope.shop_query.hasMore=!1,$timeout(function(){$rootScope.$broadcast(Event.Load.Dismiss),$scope.shop_query.isLoad=!1},500)})},$scope.loadMoreShop=function(){$scope.shop_query.page++,$rootScope.$broadcast(Event.Load.Display),$scope.shop_query.isLoad=!0,ShopService.get($scope.shop_query.page,20,"",$scope.shop_query.services,$scope.shop_query.province,0,5).then(function(res){angular.forEach(res.data,function(s){angular.forEach($scope.provinces,function(p){s.province==p.key&&(s.province_str=p.th)}),$scope.shops.push(s)}),res.meta.count>$scope.shops.length?$scope.shop_query.hasMore=!0:$scope.shop_query.hasMore=!1,$timeout(function(){$rootScope.$broadcast(Event.Load.Dismiss),$scope.shop_query.isLoad=!1},500)})},$scope.shopWorkClick=function(w){angular.forEach($scope.workgroup,function(_w){_w.active=!1}),w?(w.active=!0,$scope.shop_query.services=w.name):$scope.shop_query.services="",$scope.loadShop()},$scope.shopWorkChange=function(){angular.forEach($scope.workgroup,function(_w){$scope.shop_query.services==_w.name?_w.active=!0:_w.active=!1}),$scope.loadShop(),console.log($scope.shop_query.services)};var lightbox=lity();$scope.simpleLightbox=function(url){lightbox(url)},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.loadIndex()}]),module.controller("EditNotificationController",["$scope","$rootScope","$timeout","$q","$location","NotificationService","CarService","WorkgroupService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,NotificationService,CarService,WorkgroupService,Event,Helper){function getById(){$q.all([NotificationService.getById($scope.params.id).then(function(res){$scope.model=angular.copy(res.data),setInitModel($scope.model)}).catch(function(){alert("ERROR LOAD NOTIFICATION")}),CarService.get().then(function(res){$scope.cars=angular.copy(res.data),$scope.from_car&&angular.forEach($scope.cars,function(_car){_car.id==$scope.carId&&(_car.active=!0)})}),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)})]).then(function(){$scope.displayView()})}function setInitModel(model){if(model.car=model.for_car+"",model.type=model.type+"",model.work=model.work+"",model.date){var date=new Date(model.date);model.year=date.getFullYear()+543,model.month=date.getMonth()+1+"",model.day=date.getDate()+""}$rootScope.$broadcast(Event.Car.SetActive,model.car)}function isValid(){return $scope.params.id&&$scope.user&&$scope.user.id}$scope.status={},$scope.dates=Helper.dateArray(),$scope.months=Helper.monthArray(),$scope.params=$location.search(),$scope.from_car=!!$scope.params.car,$scope.from_car&&($scope.carId=$scope.params.car),$scope.editNotificationPage=function(){$scope.user_ready?isValid()?getById():window.location.hash="#!/":$timeout(function(){$scope.editNotificationPage()},200)},$scope.setForm=function(form){$scope.form=form},$scope.update=function(form){angular.forEach(form.$error.required,function(field){field.$setDirty()}),form.$valid?($scope.model.day&&$scope.model.month&&$scope.model.year&&!isNaN(parseInt($scope.model.year))||2==$scope.model.type)&&$scope.model.car?($rootScope.$broadcast(Event.Load.Display),2!=$scope.model.type&&($scope.model.date=new Date(parseInt($scope.model.year-543),parseInt($scope.model.month)-1,$scope.model.day)),$scope.status={},NotificationService.update($scope.model).then(function(res){$scope.from_car?$scope.navigateTo("#!/notification?id="+$scope.model.id+"&car="+$scope.carId):$scope.navigateTo("#!/notification?id="+$scope.model.id)}).catch(function(res){"CAR EXPIRE"==res.error.message?$scope.status.car_expire=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)})):($scope.model.car||($scope.status.car=!0),isNaN(parseInt($scope.model.year))&&2!=$scope.model.type&&($scope.status.invalid_year=!0),$scope.status.invalid=!0):$scope.status.invalid=!0},$scope.remove=function(){$rootScope.$broadcast(Event.Confirm.Display,function(){$rootScope.$broadcast(Event.Load.Display),NotificationService.delete($scope.params.id).then(function(){$scope.from_car?$scope.navigateTo("#!/car?id="+$scope.carId):$scope.navigateTo("#!/notifications")}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),alert("ERROR")})})},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.editNotificationPage()}]),module.controller("NewNotificationController",["$scope","$rootScope","$timeout","$q","$location","NotificationService","CarService","WorkgroupService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,NotificationService,CarService,WorkgroupService,Event,Helper){$scope.status={},$scope.dates=Helper.dateArray(),$scope.months=Helper.monthArray(),$scope.params=$location.search(),$scope.from_car=!!$scope.params.car,$scope.carId=$scope.params.car,$scope.newNotificationPage=function(){$scope.model={enable:!0},$scope.from_car&&($scope.model.car=$scope.carId),$q.all([CarService.get().then(function(res){$scope.cars=angular.copy(res.data),$scope.from_car&&angular.forEach($scope.cars,function(_car){_car.id==$scope.carId&&(_car.active=!0)})}),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)})]).then(function(){1==$scope.cars.length&&($scope.model.car=$scope.cars[0].id,console.log($scope.model.car)),$scope.displayView()})},$scope.setForm=function(form){$scope.form=form},$scope.add=function(form){angular.forEach(form.$error.required,function(field){field.$setDirty()}),form.$valid?($scope.model.day&&$scope.model.month&&$scope.model.year&&!isNaN(parseInt($scope.model.year))||2==$scope.model.type)&&$scope.model.car?($rootScope.$broadcast(Event.Load.Display),2!=$scope.model.type&&($scope.model.date=new Date(parseInt($scope.model.year-543),parseInt($scope.model.month)-1,$scope.model.day)),$scope.status={},NotificationService.create($scope.model).then(function(res){$scope.from_car?$scope.navigateTo("#!/car?id="+$scope.carId):$scope.navigateTo("#!/notifications")}).catch(function(res){"CAR EXPIRE"==res.error.message?$scope.status.car_expire=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)})):($scope.model.car||($scope.status.car=!0),isNaN(parseInt($scope.model.year))&&2!=$scope.model.type&&($scope.status.invalid_year=!0),$scope.status.invalid=!0):$scope.status.invalid=!0},$scope.carChange=function(){angular.forEach($scope.cars,function(_car){_car.id==$scope.model.car?_car.active=!0:_car.active=!1})},$scope.pickCar=function(car){$scope.from_car?$scope.navigateTo("#!/car?id="+car.id):($scope.model.car=car.id+"",angular.forEach($scope.cars,function(_car){_car.active=!1}),car.active=!0)},$scope.newNotificationPage()}]),module.controller("NewRepairController",["$scope","$rootScope","$timeout","$q","$location","RepairService","Event","Helper","ShopService","WorkService","CarService","WorkgroupService",function($scope,$rootScope,$timeout,$q,$location,RepairService,Event,Helper,ShopService,WorkService,CarService,WorkgroupService){function initModel(){$scope.model={car:$scope.carId,date:new Date},$scope.model.year=$scope.model.date.getFullYear()+543+"",$scope.model.month=$scope.model.date.getMonth()+1+"",$scope.model.day=$scope.model.date.getDate()+"",console.log($scope.model)}$scope.status={},$scope.dates=Helper.dateArray(),$scope.months=Helper.monthArray(),$scope.params=$location.search(),$scope.from_car=!!$scope.params.car,$scope.carId=$scope.params.car,$scope.newRepair=function(){$scope.user_ready?$scope.user&&$scope.user.id?$q.all([CarService.get().then(function(res){$scope.cars=angular.copy(res.data),$scope.from_car&&angular.forEach($scope.cars,function(_car){_car.id==$scope.carId&&(_car.active=!0)})}),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)})]).then(function(){initModel(),$scope.displayView()}):window.location.hash="#!/":$timeout(function(){$scope.newRepair()},200)},$scope.setForm=function(form){$scope.form=form},$scope.add=function(form){$scope.form_submit=!0,angular.forEach(form.$error.required,function(field){field.$setDirty()}),form.$valid?$scope.model.day&&$scope.model.month&&$scope.model.year&&!isNaN(parseInt($scope.model.year))?($scope.model.date=new Date(parseInt($scope.model.year-543),parseInt($scope.model.month)-1,$scope.model.day),$rootScope.$broadcast(Event.Load.Display),$scope.status={},$scope.model.share=!0,RepairService.create($scope.model).then(function(res){$scope.model.id=res.data.id,$scope.from_car?$scope.navigateTo("#!/repair?id="+res.data.id+"&car="+$scope.carId):$scope.navigateTo("#!/repair?id="+res.data.id)}).catch(function(res){"CAR EXPIRE"==res.error.message?$scope.status.car_expire=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)})):($scope.status.invalid=!0,isNaN(parseInt($scope.model.year))&&($scope.status.invalid_year=!0)):$scope.status.invalid=!0},$scope.pickCar=function(car){$scope.from_car?$scope.navigateTo("#!/car?id="+car.id):($scope.model.car=car.id+"",angular.forEach($scope.cars,function(_car){_car.active=!1}),car.active=!0)},$scope.newRepair()}]),$(document).on("keydown",function(e){8!==e.which||$(e.target).is("input, textarea")||e.preventDefault()}),module.controller("EditRepairController",["$scope","$rootScope","$timeout","$q","$location","RepairService","Event","Helper","ShopService","WorkService","CarService","WorkgroupService",function($scope,$rootScope,$timeout,$q,$location,RepairService,Event,Helper,ShopService,WorkService,CarService,WorkgroupService){function getById(){RepairService.getById($scope.params.id).then(function(data){$scope.model=angular.copy(data),initModel($scope.model)}).catch(function(){})}function initModel(model){if(model.work=model.work+"",model.date){var date=new Date(model.date);model.year=date.getFullYear()+543+"",model.month=date.getMonth()+1+"",model.day=date.getDate()+""}}$scope.status={},$scope.dates=Helper.dateArray(),$scope.months=Helper.monthArray(),$scope.params=$location.search(),$scope.carId=$scope.params.car,$scope.from_car=!!$scope.params.car,$scope.editRepair=function(){$scope.user_ready?$scope.user&&$scope.user.id?$q.all([CarService.get().then(function(res){$scope.cars=angular.copy(res.data),$scope.from_car&&angular.forEach($scope.cars,function(_car){_car.id==$scope.carId&&(_car.active=!0)})}),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)}),getById()]).then(function(){$scope.displayView()}):window.location.hash="#!/":$timeout(function(){$scope.editRepair()},200)},$scope.update=function(){$scope.form_submit=!0,angular.forEach($scope.form.$error.required,function(field){field.$setDirty()}),$scope.form.$valid?$scope.model.day&&$scope.model.month&&$scope.model.year&&!isNaN(parseInt($scope.model.year))?($scope.model.date=new Date(parseInt($scope.model.year-543),parseInt($scope.model.month)-1,$scope.model.day),$rootScope.$broadcast(Event.Load.Display),$scope.status={},RepairService.update($scope.model).then(function(res){$scope.from_car?$scope.navigateTo("#!/repair?id="+res.id+"&car="+$scope.carId):$scope.navigateTo("#!/repair?id="+res.id)}).catch(function(res){"CAR EXPIRE"==res.error.message?$scope.status.car_expire=!0:$scope.status.error=!0,$rootScope.$broadcast(Event.Load.Dismiss)})):($scope.status.invalid=!0,isNaN(parseInt($scope.model.year))&&($scope.status.invalid_year=!0)):$scope.status.invalid=!0},$scope.setForm=function(form){$scope.form=form},$scope.pickCar=function(car){$scope.from_car?$scope.navigateTo("#!/car?id="+car.id):($scope.model.car=car.id+"",angular.forEach($scope.cars,function(_car){_car.active=!1}),car.active=!0)},$scope.editRepair()}]),$(document).on("keydown",function(e){8!==e.which||$(e.target).is("input, textarea")||e.preventDefault()}),module.controller("EditShopController",["$scope","$rootScope","$timeout","$q","$location","$window","Event","Helper","ShopService","WorkService","CarService","WorkgroupService",function($scope,$rootScope,$timeout,$q,$location,$window,Event,Helper,ShopService,WorkService,CarService,WorkgroupService){function getById(){return $q(function(resolve,reject){ShopService.getById($scope.params.id).then(function(data){$scope.model=angular.copy(data),initModel($scope.model),resolve()}).catch(function(){reject()})})}function initModel(model){model.services&&(model.service_list=model.services.split(","))}function createProvinces(){angular.forEach(areas,function(area){angular.forEach(area.areas,function(p){$scope.provinces.push(p)})}),$scope.provinces.sort(function(a,b){return a.th>b.th?1:b.th>a.th?-1:0})}function initWork(model,works){angular.forEach(model.service_list,function(w){angular.forEach(works,function(_w){w==_w.name&&(_w.checked=!0)})})}function loadResource(){createProvinces(),$q.all([getById(),CarService.get().then(function(res){$scope.cars=angular.copy(res.data)}),WorkgroupService.get().then(function(res){$scope.works=angular.copy(res.data)})]).then(function(){$timeout(function(){$scope.model.create_by==$scope.user.id||$scope.isCanEdit?(initWork($scope.model,$scope.works),$scope.displayView()):$scope.navigateTo("#!/shop?id="+$scope.params.id),checkSize()},100)})}function isValid(){return $scope.user&&$scope.user.id}function checkSize(){$(window).width()<=750?$scope.imageTop=!0:$scope.imageTop=!1,$scope.$apply()}$scope.status={},$scope.dates=Helper.dateArray(),$scope.months=Helper.monthArray(),$scope.params=$location.search(),$scope.carId=$scope.params.car,$scope.repairId=$scope.params.repair,$scope.from_car=!!$scope.params.car,$scope.from_repair=!!$scope.params.repair,$scope.isCanEdit="true"==$scope.params.cd,$scope.isFromShops="true"==$scope.params.fs,$scope.provinces=[],$scope.editShopPage=function(){$scope.user_ready?isValid()?loadResource():$scope.navigateTo("#!/shop?id="+$scope.params.id):$timeout(function(){$scope.editShopPage()},200),$rootScope.$broadcast(Event.File.SetType,3)},$scope.update=function(notReload){$scope.form_submit=!0,$scope.status={},angular.forEach($scope.form.$error.required,function(field){field.$setDirty()}),$scope.form.$valid?($rootScope.$broadcast(Event.Load.Display),ShopService.update($scope.model).then(function(){notReload?$rootScope.$broadcast(Event.Load.Dismiss):$scope.from_repair?$scope.navigateTo("#!/repair?id="+$scope.repairId+($scope.carId?"&car="+$scope.carId:"")):window.location.href="/#!/shop?id="+$scope.model.id+"&cd=true"}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),$scope.status.error=!0})):$scope.status.invalid=!0},$scope.setForm=function(form){$scope.form=form},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.setImage=function(event,file){$scope.model&&($scope.model.image=file,$scope.update(!0))},$scope.workChecked=function(work){work.checked=!work.checked,$scope.setServices()},$scope.checkedAll=function(){angular.forEach($scope.works,function(w){w.checked=!0}),$scope.setServices()},$scope.removeAllChecked=function(){angular.forEach($scope.works,function(w){w.checked=!1}),$scope.setServices()},$scope.setServices=function(){$scope.model.services="";var count=0;angular.forEach($scope.works,function(w){w.checked&&(count++,$scope.model.services+=w.name+",")}),count||($scope.model.services="")},$scope.$on(Event.File.Success,$scope.setImage),$scope.editShopPage(),$(window).resize(function(){checkSize()})}]),$(document).on("keydown",function(e){8!==e.which||$(e.target).is("input, textarea")||e.preventDefault()}),module.controller("ShopController",["$scope","$rootScope","$timeout","$q","$location","Event","Helper","ShopService","WorkService","CarService","WorkgroupService","RepairService",function($scope,$rootScope,$timeout,$q,$location,Event,Helper,ShopService,WorkService,CarService,WorkgroupService,RepairService){function getById(){ShopService.getById($scope.params.id).then(function(data){$scope.model=angular.copy(data),initModel($scope.model)}).catch(function(){alert("Load resource error")}),$scope.repairQuery.shop=$scope.params.id,$scope.repairQuery.limit=20,$scope.isRepairLoad=!0,RepairService.getByShop($scope.repairPage,$scope.repairQuery).then(function(res){$scope.repairs=res.data,$scope.isRepairLoad=!1,setMetaRepair(res.meta)}).catch(function(){alert("Load resource error")})}function setMetaRepair(meta){meta.limits*$scope.repairPage<meta.count?$scope.hasMore=!0:$scope.hasMore=!1}function initModel(model){if(model.update_str=Helper.readableDateTime(model.updatedAt),model.services){model.service_list=model.services.split(",");var index=0;angular.forEach(model.service_list,function(s){s&&"null"!=s||(model.service_list.splice(index,1),index--),index++})}angular.forEach($scope.provinces,function(p){p.key==model.province&&(model.province_str=p.th)}),$scope.params.car&&($scope.from_car=!0),model.map&&$timeout(function(){$(".map").append(model.map)},500),$scope.user&&model.create_by==$scope.user.id&&($scope.isCreator=!0),"true"==$scope.params.cd?$scope.isCanEdit=!0:$scope.user&&1===$scope.user.role.id&&($scope.isCanEdit=!0),"true"==$scope.params.fs&&($scope.isFromShops=!0)}function createProvinces(){angular.forEach(areas,function(area){angular.forEach(area.areas,function(p){$scope.provinces.push(p)})}),$scope.provinces.sort(function(a,b){return a.th>b.th?1:b.th>a.th?-1:0})}function loadResource(){createProvinces(),$scope.user&&$scope.user.id?$q.all([getById(),CarService.get().then(function(res){$scope.cars=angular.copy(res.data)})]).then(function(){$scope.displayView()}):$q.all([getById()]).then(function(){$scope.displayView()})}$scope.status={},$scope.dates=Helper.dateArray(),$scope.months=Helper.monthArray(),$scope.params=$location.search(),$scope.carId=$scope.params.car,$scope.from_car=!1,$scope.provinces=[],$scope.isCreator=!1,$scope.isCanEdit=!1,$scope.isFromShops=!1,$scope.repairs=[],$scope.repairPage=1,$scope.repairQuery={},$scope.editShop=function(){$scope.user_ready?loadResource():$timeout(function(){$scope.editShop()},200)},$scope.update=function(){$scope.form_submit=!0,$scope.status={},angular.forEach($scope.form.$error.required,function(field){field.$setDirty()}),$scope.form.$valid?($rootScope.$broadcast(Event.Load.Display),ShopService.update($scope.model).then(function(){$rootScope.$broadcast(Event.Load.Dismiss)}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),$scope.status.error=!0})):$scope.status.invalid=!0},$scope.setForm=function(form){$scope.form=form},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},$scope.setImage=function(event,file){$scope.model&&($scope.model.image=file)};var lightbox=lity();$scope.simpleLightbox=function(url){lightbox(url)},$scope.loadMoreRepair=function(){$scope.repairPage+=1,$scope.isRepairLoad=!0,RepairService.getByShop($scope.repairPage,$scope.repairQuery).then(function(res){$scope.repairs=Helper.mergeArray($scope.repairs,res.data),$scope.isRepairLoad=!1,setMetaRepair(res.meta)}).catch(function(){alert("Load resource error")})},$scope.$on(Event.File.Success,$scope.setImage),$scope.editShop()}]),$(document).on("keydown",function(e){8!==e.which||$(e.target).is("input, textarea")||e.preventDefault()}),module.controller("NavController",["$scope","PageService",function($scope,PageService){$scope.nav=function(){$scope.menu=[],PageService.getAll().then(function(res){$scope.items=res.data,angular.forEach($scope.items,function(m){m.isMenu&&!m.isSys&&$scope.menu.push(m);var url=decodeURIComponent(location.href).replace("http://127.0.0.1:8000","");url=url.replace("http://localhost:8000",""),url=url.replace("http://www.carcarenote.com",""),url=url.replace("http://carcarenote.com",""),url=url.split("?")[0],(url=url.replace("#!/",""))==m.url&&(m.isActive=!0)})})},$scope.nav()}]);var shareWorkSlide;module.controller("ShopsController",["$scope","$rootScope","$timeout","$q","$location","ShopService","WorkgroupService","CarService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,ShopService,WorkgroupService,CarService,Event,Helper){function loadModel(notify,isLoadMore){notify&&$rootScope.$broadcast(Event.Load.Display),ShopService.get($scope.query.page,$scope.query.limits,$scope.query.key,$scope.query.services,$scope.query.province,$scope.query.rating).then(function(res){var objects=initModel(res.data);$scope.shops=isLoadMore?Helper.mergeArray($scope.shops,objects):objects,setMeta(res.meta),$scope.isLoadMore=!1,notify&&$rootScope.$broadcast(Event.Load.Dismiss)}).catch(function(){isLoadMore&&--$scope.query.page<0&&($scope.query.page=1),$scope.isLoadMore=!1,$rootScope.$broadcast(Event.Load.Dismiss),$rootScope.$broadcast(Event.Message.Display,"มีบางอย่างผิดพลาดกรุณาลองใหม่")})}function initModel(model){return angular.forEach(model,function(item){angular.forEach($scope.provinces,function(_province){item.province==_province.key&&(item.province_str=_province.th)})}),model}function setMeta(meta){meta.limits*$scope.query.page<meta.count?$scope.hasMore=!0:$scope.hasMore=!1}function loadDataForNotLoginUser(){$q.all([loadModel(),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)})]).then(onFinishLoadData)}function loadDataForLoginUser(){$q.all([loadModel(),WorkgroupService.get().then(function(res){$scope.workgroup=angular.copy(res.data)}),CarService.get().then(function(res){$scope.cars=angular.copy(res.data)})]).then(onFinishLoadData)}function onFinishLoadData(){$timeout(function(){shareWorkSlide=new ShareWorkSlide},500),$scope.displayView()}function ShopsPage(){$scope.user_ready?$scope.user&&$scope.user.id?(1===$scope.user.role.id&&($scope.isCanCreateShop=!0),loadDataForLoginUser()):loadDataForNotLoginUser():$timeout(function(){ShopsPage()},200)}$scope.provinces=_provinces,$scope.query={page:1,key:"",services:"",rating:"",limits:24},$scope.search=function(){$scope.query.page=1,loadModel()},$scope.loadMore=function(){$scope.query.page++,$scope.isLoadMore=!0,loadModel(!0,!0)},$scope.openCreateShopPopup=function(){$rootScope.$broadcast(Event.Shop.DisplayCreatePopup)},$scope.pickCar=function(car){$scope.navigateTo("#!/car?id="+car.id)},ShopsPage()}]),module.controller("ForgotPasswordController",["$scope","$rootScope","$timeout","$location","AccountService","Event",function($scope,$rootScope,$timeout,$location,AccountService,Event){function isValid(){return!$scope.user||!$scope.user.id}$scope.params=$location.search(),$scope.status={},$scope.model={},$scope.recover=!!$scope.params.token,$scope.setForm=function(form){$scope.form=form},$scope.forgotPasswordPage=function(){$scope.user_ready?isValid()?$scope.recover?AccountService.validateForgotPasswordToken({token:$scope.params.token}).then(function(res){$scope.model={id:res.data.id,token:$scope.params.token},console.log($scope.model),$scope.displayView()}).catch(function(){$scope.recover=!1,$scope.displayView()}):$scope.displayView():window.location.hash="#!/":$timeout(function(){$scope.forgotPasswordPage()},200)},$scope.edit=function(){window.location.href="#!/account"},$scope.submit=function(form){angular.forEach(form.$error.required,function(field){field.$setDirty()}),form.$valid?($scope.status={},$rootScope.$broadcast(Event.Load.Display),AccountService.forgotPassword($scope.model).then(function(res){console.log(res),$scope.status.success=!0,$rootScope.$broadcast(Event.Load.Dismiss)}).catch(function(res){$rootScope.$broadcast(Event.Load.Dismiss),$scope.status.error=!0})):$scope.status.invalid=!0},$scope.changePassword=function(form){angular.forEach(form.$error.required,function(field){field.$setDirty()}),form.$valid&&$scope.model.password==$scope.model.confirm_password?($scope.status={},$rootScope.$broadcast(Event.Load.Display),AccountService.changePasswordByToken($scope.model).then(function(res){$scope.status.success=!0,$rootScope.$broadcast(Event.Load.Dismiss)}).catch(function(res){$rootScope.$broadcast(Event.Load.Dismiss),$scope.status.error=!0})):$scope.status.invalid=!0},$scope.forgotPasswordPage()}]),module.directive("message",["$timeout","Event",function($timeout,Event){return{restrict:"E",templateUrl:"/partials/message.html",scope:{},link:function(scope,element,attrs){function close(){$timeout(function(){scope.animation="fadeOut"},150),$timeout(function(){scope.display=!1},1e3)}scope.display=!1,scope.$on(Event.Message.Dismiss,function(){close()}),scope.$on(Event.Message.Display,function(event,message,callback){scope.animation="fadeIn",scope.display=!0,scope.callback=callback,scope.message=message||"[NO MESSAGE]",scope.accept=function(){scope.callback&&scope.callback(),close()}})}}}]),module.directive("reportPopup",["$rootScope","$timeout","Event","ReportService",function($rootScope,$timeout,Event,ReportService){return{restrict:"E",templateUrl:"/partials/report-popup.html",scope:{},link:function(scope,element,attrs){function close(){$timeout(function(){scope.animation="fadeOut"},150),$timeout(function(){scope.display=!1},1e3),$("body,html").css("overflow","")}scope.display=!1,scope.close=function(){close()},scope.$on(Event.Report.Display,function(event,id,url){scope.model={file_id:id},ReportService.captcha().then(function(res){scope.captcha=res.data,scope.model.key=scope.captcha.key}),scope.animation="fadeIn",scope.display=!0,scope.login=!1,scope.is_submit=!1,scope.url=url,window.carcare.user&&window.carcare.user.id&&(scope.login=!0,scope.model.name=window.carcare.user.name,scope.model.email=window.carcare.user.email),$("body,html").css("overflow","hidden"),scope.setHeight()}),scope.setHeight=function(){if($(window).height()<$(".report-popup").height()+150){var height=$(window).height()-150;height>600&&(height=600);var half_height=height/2;$(".report-popup").height(height),$(".report-popup").css("margin-top",-(half_height+20)+"px")}else $(".report-popup").height(600)},scope.submit=function(form){scope.is_submit=!0,form.$valid&&scope.captcha&&scope.model.captcha===scope.captcha.captcha&&($rootScope.$broadcast(Event.Load.Display),ReportService.send(scope.model).then(function(){close(),$rootScope.$broadcast(Event.Load.Dismiss),$rootScope.$broadcast(Event.Message.Display,"ทางเราได้รับการแจ้งรูปภาพไม่เหมาะสมของท่านแล้วและจะรีบดำเนินการตรวจสอบให้เร็วที่สุด")}).catch(function(){close(),$rootScope.$broadcast(Event.Load.Dismiss),$rootScope.$broadcast(Event.Message.Display,"ส่งข้อความล้มเหลวกรุณาลองใหม่อีกครั้งหรือติดต่อผู้ดูแลระบบ")}))},$(window).resize(scope.setHeight)}}}]),module.factory("ReportService",["$rootScope","$http","$q","URLS",function($rootScope,$http,$q,URLS){var cache={};return{get:function(query){var key=URLS.model("reports").all+"?p="+query.p+(query.q?"&q="+query.q:"")+(query.months?"&months="+query.months:"")+(query.year?"&year="+query.year:"");return $q(function(resolve,reject){$http.get(key).then(function(res){cache[key]=res.data,resolve(res.data)}).catch(function(res){reject(res)})})},send:function(model){var key=URLS.model("reports").all;return $q(function(resolve,reject){$http.post(key,model).then(function(res){cache[key]=res.data.data,resolve(res.data.data)}).catch(function(res){reject(res)})})},delete:function(model){var key=URLS.model("reports").one.replace("{id}",model.id);return $q(function(resolve,reject){$http.delete(key).then(function(res){resolve(res.data.data)}).catch(function(res){reject(res)})})},deleteImage:function(id){var key=URLS.model("reports").image_id.replace("{id}",id);return $q(function(resolve,reject){$http.delete(key).then(function(res){resolve(res.data.data)}).catch(function(res){reject(res)})})},recoverImage:function(id){var key=URLS.model("reports").image_id.replace("{id}",id);return $q(function(resolve,reject){$http.patch(key).then(function(res){resolve(res.data.data)}).catch(function(res){reject(res)})})},captcha:function(){return $q(function(resolve,reject){$http.get(URLS.model("reports").captcha).then(function(res){resolve(res.data)}).catch(reject)})}}}]);for(var areas=[{key:"north",th:"ภาคเหนือ",en:"North",areas:[{key:"chiang_rai",th:"เชียงราย",en:"Chiang Rai"},{key:"chiang_mai",th:"เชียงใหม่",en:"Chiang Mai"},{key:"nan",th:"น่าน",en:"Nan"},{key:"phayao",th:"พะเยา",en:"Phayao"},{key:"phrae",th:"แพร่",en:"Phrae"},{key:"mae_hong_son",th:"แม่ฮ่องสอน",en:"Mae Hong Son"},{key:"lampang",th:"ลำปาง",en:"Lampang"},{key:"lamphun",th:"ลำพูน",en:"Lamphun"},{key:"uttaradit",th:"อุตรดิตถ์",en:"Uttaradit"}]},{key:"north_east",th:"ภาคตะวันออกเฉียงเหนือ",en:"Northeast",areas:[{key:"kalasin",th:"กาฬสินธุ์",en:"Kalasin"},{key:"khon_kaen",th:"ขอนแก่น",en:"Kalasin"},{key:"chaiyaphum",th:"ชัยภูมิ",en:"Chaiyaphum"},{key:"nakhon_phanom",th:"นครพนม",en:"Nakhon Phanom"},{key:"nakhon_ratchasima",th:"นครราชสีมา",en:"Nakhon Ratchasima"},{key:"bueng_kan",th:"บึงกาฬ",en:"Bueng Kan"},{key:"buri_ram",th:"บุรีรัมย์",en:"Buri Ram"},{key:"maha_sarakham",th:"มหาสารคาม",en:"Maha Sarakham"},{
key:"mukdahan",th:"มุกดาหาร",en:"Mukdahan"},{key:"yasothon",th:"ยโสธร",en:"Yasothon"},{key:"roi_et",th:"ร้อยเอ็ด",en:"Roi Et"},{key:"loei",th:"เลย",en:"Loei"},{key:"si_sa_ket",th:"ศรีสะเกษ",en:"Si Sa Ket"},{key:"sakon_nakhon",th:"สกลนคร",en:"Sakon Nakhon"},{key:"surin",th:"สุรินทร์",en:"Surin"},{key:"nong_khai",th:"หนองคาย",en:"Nong Khai"},{key:"nong_bua_lam_phu",th:"หนองบัวลำภู",en:"Nong Bua Lam Phu"},{key:"amnat_charoen",th:"อำนาจเจริญ",en:"Amnat Charoen"},{key:"udon_thani",th:"อุดรธานี",en:"Udon Thani"},{key:"ubon_ratchathani",th:"อุบลราชธานี",en:"Ubon Ratchathani"}]},{key:"central_region",th:"ภาคกลาง",en:"Central Region",areas:[{key:"krung_thep_maha_nakhon",th:"กรุงเทพมหานคร",en:"Krung Thep Maha Nakhon"},{key:"kamphaeng_phet",th:"กำแพงเพชร",en:"Kamphaeng Phet"},{key:"chai_nat",th:"ชัยนาท",en:"Chai Nat"},{key:"nakhon_nayok",th:"นครนายก",en:"Nakhon Nayok"},{key:"nakhon_pathom",th:"นครปฐม",en:"Nakhon Pathom"},{key:"nakhon_sawan",th:"นครสวรรค์",en:"Nakhon Sawan"},{key:"nonthaburi",th:"นนทบุรี",en:"Nonthaburi"},{key:"pathum_thani",th:"ปทุมธานี",en:"Pathum Thani"},{key:"phra_nakhon_si_ayutthaya",th:"พระนครศรีอยุธยา",en:"Phra Nakhon Si Ayutthaya"},{key:"phichit",th:"พิจิตร",en:"Phichit"},{key:"phitsanulok",th:"พิษณุโลก",en:"Phitsanulok"},{key:"phetchabun",th:"เพชรบูรณ์",en:"Phetchabun"},{key:"lop_buri",th:"ลพบุรี",en:"Lop Buri"},{key:"samut_prakan",th:"สมุทรปราการ",en:"Samut Prakan"},{key:"samut_songkhram",th:"สมุทรสงคราม",en:"Samut Songkhram"},{key:"samut_sakhon",th:"สมุทรสาคร",en:"Samut Sakhon"},{key:"sing_buri",th:"สิงห์บุรี",en:"Sing Buri"},{key:"sukhothai",th:"สุโขทัย",en:"Sukhothai"},{key:"suphan_buri",th:"สุพรรณบุรี",en:"Suphan Buri"},{key:"saraburi",th:"สระบุรี",en:"Saraburi"},{key:"ang_thong",th:"อ่างทอง",en:"Ang Thong"},{key:"uthai_thani",th:"อุทัยธานี",en:"Uthai Thani"}]},{key:"east",th:"ภาคตะวันออก",en:"East",areas:[{key:"chanthaburi",th:"จันทบุรี",en:"Chanthaburi"},{key:"chachoengsao",th:"ฉะเชิงเทรา",en:"Chachoengsao"},{key:"chon_buri",th:"ชลบุรี",en:"Chon Buri"},{key:"trat",th:"ตราด",en:"Trat"},{key:"prachin_buri",th:"ปราจีนบุรี",en:"Prachin Buri"},{key:"rayong",th:"ระยอง",en:"Rayong"},{key:"sa_kaeo",th:"สระแก้ว",en:"Sa Kaeo"}]},{key:"west",th:"ภาคตะวันตก",en:"West",areas:[{key:"kanchanaburi",th:"กาญจนบุรี",en:"Kanchanaburi"},{key:"tak",th:"ตาก",en:"Tak"},{key:"prachuap_khiri_khan",th:"ประจวบคีรีขันธ์",en:"Prachuap Khiri Khan"},{key:"phetchaburi",th:"เพชรบุรี",en:"Phetchaburi"},{key:"ratchaburi",th:"ราชบุรี",en:"Ratchaburi"}]},{key:"south",th:"ภาคใต้",en:"South",areas:[{key:"krabi",th:"กระบี่",en:"Krabi"},{key:"chumphon",th:"ชุมพร",en:"Chumphon"},{key:"trang",th:"ตรัง",en:"Trang"},{key:"nakhon_si_thammarat",th:"นครศรีธรรมราช",en:"Nakhon Si Thammarat"},{key:"narathiwat",th:"นราธิวาส",en:"Narathiwat"},{key:"pattani",th:"ปัตตานี",en:"Pattani"},{key:"phangnga",th:"พังงา",en:"Phangnga"},{key:"phatthalung",th:"พัทลุง",en:"Phatthalung"},{key:"phuket",th:"ภูเก็ต",en:"Phuket"},{key:"yala",th:"ยะลา",en:"Yala"},{key:"ranong",th:"ระนอง",en:"Ranong"},{key:"songkhla",th:"สงขลา",en:"Songkhla"},{key:"satun",th:"สตูล",en:"Satun"},{key:"surat_thani",th:"สุราษฎร์ธานี",en:"Surat Thani"}]}],_provinces=[],i=0;i<areas.length;i++)for(var j=0;j<areas[i].areas.length;j++)_provinces.push(areas[i].areas[j]);_provinces.sort(function(a,b){return a.th>b.th?1:b.th>a.th?-1:0}),module.controller("ProblemReportController",["$scope","$rootScope","$timeout","$q","$location","ProblemService","Event","Helper",function($scope,$rootScope,$timeout,$q,$location,ProblemService,Event,Helper){function ProblemReportPage(){$scope.user_ready?loadResources():$timeout(function(){ProblemReportPage()},200)}function loadResources(){$q.all([ProblemService.captcha().then(function(res){$scope.captcha=res.data,$scope.model.key=$scope.captcha.key,$scope.model.type="การใช้งานระบบ"}).catch(function(){})]).then(function(){$scope.displayView()}),window.carcare.user&&(window.carcare.user.name&&($scope.model.name=window.carcare.user.name),window.carcare.user.email&&($scope.model.email=window.carcare.user.email),window.carcare.user.telephone&&($scope.model.telephone=window.carcare.user.telephone))}function resetForm(form){angular.forEach(form.$$controls,function(field){field.$setPristine()}),$scope.is_submit=!1,$scope.model={},loadResources()}$scope.model={captcha:"",key:"",name:"",email:"",telephone:""},$scope.submit=function(form){$scope.is_submit=!0,angular.forEach(form.$error.required,function(field){field.$setDirty()}),form.$valid&&$scope.model.captcha===$scope.captcha.captcha&&($rootScope.$broadcast(Event.Load.Display),ProblemService.sendReport($scope.model).then(function(){$rootScope.$broadcast(Event.Load.Dismiss),$rootScope.$broadcast(Event.Message.Display,"ทางเราได้รับการแจ้งปัญหาของท่านแล้วและจะรีบดำเนินการตรวจสอบให้เร็วที่สุด"),resetForm(form)}).catch(function(){$rootScope.$broadcast(Event.Load.Dismiss),$rootScope.$broadcast(Event.Message.Display,"การแจ้งล้มเหลวกรุณาลองใหม่อีกครั้งหรือติดต่อผู้ดูแลระบบ")}))},ProblemReportPage()}]),module.factory("ProblemService",["$rootScope","$http","$q","URLS",function($rootScope,$http,$q,URLS){return{sendReport:function(data){var key=URLS.model("problems").all;return $q(function(resolve,reject){$http.post(key,data).then(function(res){resolve(res.data)}).catch(function(res){reject(res.data)})})},captcha:function(){return $q(function(resolve,reject){$http.get(URLS.model("problems").captcha).then(function(res){resolve(res.data)}).catch(function(res){reject(res.data)})})}}}]);
