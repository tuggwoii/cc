'use strict';
module.controller('EditShopController', ['$scope', '$rootScope', '$timeout', '$q', '$location', 'RepairService', 'Event', 'Helper', 'ShopService', 'WorkService', 'CarService', 'WorkgroupService',
